...
private const val RECONCILIATION_SESSION_BYTES = 16

/**
 * HTTP shell over [InitiateProviderAuthenticationCommand] for the reconciliation (IDV) entry
 * point. Requires `oid4vp_session` and `provider`, generates a reconciliation-scoped session id,
...
@ContributesBinding(SessionScope::class, binding = binding<ReconciliationAuthorizeHttpEndpointCommand>())
