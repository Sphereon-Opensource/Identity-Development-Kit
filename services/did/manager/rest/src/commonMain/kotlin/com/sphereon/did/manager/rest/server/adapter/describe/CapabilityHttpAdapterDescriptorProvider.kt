...
import com.sphereon.did.manager.rest.server.adapter.CapabilityHttpAdapter
...
/**
 * AppScope descriptor provider for [CapabilityHttpAdapter]. Provides metadata-only
...
class CapabilityHttpAdapterDescriptorProvider(
    config: DidManagerRestConfig,
) : StaticPublicApiDescriptor(
        adapterId = CapabilityHttpAdapter.ID,
