...
import com.sphereon.did.manager.rest.server.adapter.ControllerHttpAdapter
...
/**
 * AppScope descriptor provider for [ControllerHttpAdapter]. Provides metadata-only
...
class ControllerHttpAdapterDescriptorProvider(
    config: DidManagerRestConfig,
) : StaticPublicApiDescriptor(
        adapterId = ControllerHttpAdapter.ID,
