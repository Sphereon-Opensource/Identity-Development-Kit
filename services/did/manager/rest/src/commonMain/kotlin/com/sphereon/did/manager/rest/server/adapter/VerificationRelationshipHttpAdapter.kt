...
/**
 * HTTP adapter for the Verification relationships sub-surface of the IDK-21 DID Manager REST API.
...
class VerificationRelationshipHttpAdapter(
    execution: SessionExecution,
    config: DidManagerRestConfig,
    private val listVerificationRelationships: ListVerificationRelationshipsEndpointCommand,
    private val addVerificationRelationship: AddVerificationRelationshipEndpointCommand,
    private val removeVerificationRelationship: RemoveVerificationRelationshipEndpointCommand,
