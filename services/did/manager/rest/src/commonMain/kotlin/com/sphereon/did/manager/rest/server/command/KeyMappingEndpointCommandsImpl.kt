...
@StringKey(ListKeyMappingsEndpointCommand.COMMAND_ID)
...
@SingleIn(SessionScope::class)
@ContributesIntoMap(SessionScope::class, binding = binding<HttpEndpointCommand>())
@StringKey(AddKeyMappingEndpointCommand.COMMAND_ID)
...
@SingleIn(SessionScope::class)
@ContributesIntoMap(SessionScope::class, binding = binding<HttpEndpointCommand>())
@StringKey(RemoveKeyMappingEndpointCommand.COMMAND_ID)
