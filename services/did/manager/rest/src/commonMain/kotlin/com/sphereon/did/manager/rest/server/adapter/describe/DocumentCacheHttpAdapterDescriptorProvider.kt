...
import com.sphereon.did.manager.rest.server.adapter.DocumentCacheHttpAdapter
...
/**
 * AppScope descriptor provider for [DocumentCacheHttpAdapter]. Provides metadata-only
...
class DocumentCacheHttpAdapterDescriptorProvider(
    config: DidManagerRestConfig,
) : StaticPublicApiDescriptor(
        adapterId = DocumentCacheHttpAdapter.ID,
