...
/**
 * HTTP adapter for the DID lifecycle sub-surface of the IDK-21 DID Manager REST API.
...
class DidLifecycleHttpAdapter(
    execution: SessionExecution,
    config: DidManagerRestConfig,
    private val createDid: CreateDidEndpointCommand,
    private val listDids: ListDidsEndpointCommand,
    private val trackExternalDid: TrackExternalDidEndpointCommand,
    private val getDid: GetDidEndpointCommand,
    private val updateDid: UpdateDidEndpointCommand,
    private val replaceDid: ReplaceDidEndpointCommand,
    private val deleteDid: DeleteDidEndpointCommand,
    private val deactivateDid: DeactivateDidEndpointCommand,
    private val resolveDid: ResolveDidEndpointCommand,
