...
import com.sphereon.did.manager.rest.server.adapter.EquivalentIdHttpAdapter
...
/**
 * AppScope descriptor provider for [EquivalentIdHttpAdapter]. Provides metadata-only
...
class EquivalentIdHttpAdapterDescriptorProvider(
    config: DidManagerRestConfig,
) : StaticPublicApiDescriptor(
        adapterId = EquivalentIdHttpAdapter.ID,
