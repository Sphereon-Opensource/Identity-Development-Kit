...
import com.sphereon.did.manager.rest.server.adapter.AlsoKnownAsHttpAdapter
...
/**
 * AppScope descriptor provider for [AlsoKnownAsHttpAdapter]. Provides metadata-only
...
class AlsoKnownAsHttpAdapterDescriptorProvider(
    config: DidManagerRestConfig,
) : StaticPublicApiDescriptor(
        adapterId = AlsoKnownAsHttpAdapter.ID,
