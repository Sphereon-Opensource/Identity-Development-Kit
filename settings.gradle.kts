...
includeProject("lib-cbor", "lib/cbor")
includeProject("lib-core-compat", "lib/core/compat")
...
includeProject("lib-crypto-kms-rest-server", "lib/crypto/kms/rest/server")
...
// Temporary test module for Metro Scoped multibinding
includeProject("lib-test-metro-scoped", "lib/test-metro-scoped")
//includeProject("lib-trust-hosting", "lib/trust/hosting")
...
// Ktor support
includeProject("ktor-server-kotlin-inject", "ktor/server/plugins/ktor-server-kotlin-inject")
