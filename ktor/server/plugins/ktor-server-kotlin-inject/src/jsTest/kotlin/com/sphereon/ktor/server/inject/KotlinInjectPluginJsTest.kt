...
class KotlinInjectPluginJsTest {
        ...
        fun initializeKtorTestFramework() {
            if (!initialized) {
                try {
                    ...
                    console.log("Ktor test framework initialization triggered Node.js 'os' module error (expected): ${e.message}")
                    initialized = true
                }
            }
        }
    ...
    @Test
    fun testPluginInstallationJS() = testApplication {
    ...
    @Test
    fun testRequestContextResolutionJS() = testApplication {
        // Create a test app component
        val appComponent = createTestAppComponent(
            application = Unit,
            appId = "test-app-js",
    ...
    @Test
    fun testAppComponentAccessJS() = testApplication {
        // Create a test app component
        val appComponent = createTestAppComponent(
            application = Unit,
    ...
    @Test
    fun testGetAppScopedServiceJS() = testApplication {
        // Create a test app component
        val appComponent = createTestAppComponent(
            application = Unit,
    ...
    @Test
    fun testGetUserScopedServiceJS() = testApplication {
        // Create a test app component
        val appComponent = createTestAppComponent(
            application = Unit,
            appId = "test-app-js",
    ...
    @Test
    fun testGetSessionScopedServiceJS() = testApplication {
        // Create a test app component
        val appComponent = createTestAppComponent(
            application = Unit,
            appId = "test-app-js",
