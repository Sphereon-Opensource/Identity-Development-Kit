 ...
 *         val userService = context.userInstance.component.someService
 *         val sessionService = context.sessionInstance.component.someOtherService
 *     }
 * }
 * ```
 */
data class RequestScopedContext(
     ...
     * Contains the tenant/principal-scoped component and scope.
     */
    val userInstance: UserContextInstance,

    /**
     * Session instance for the current request.
     * Contains the session-scoped component and scope.
     */
