...
class BlePeripheralServerTransport(
    ...
    override suspend fun open(
        ...
        mutex.withLock {
            ...
            try {
                ...
                mutableEngagementState.value = MdocEngagementState.BLE_ADVERTISING
     ...
     */
    suspend fun readDeviceEngagement(): IdkResult<ByteArray, BleError> = blePeripheralService.readDeviceEngagement()
            ...
            val shouldCloseGattServer =
                when {
                    ...
                    mutableEngagementState.value == MdocEngagementState.ERROR -> {
                        ...
                        log.info(
                            "Holder (MDOC) close() called but reader hasn't disconnected yet. " +
