...
class BleHandoverMapperImpl : BleHandoverMapper {
    ...
    override fun disambiguate(
        ...
        role: MdocRole,
    ): List<ConnectionMethod> = BleConnectionMethod.disambiguate(connectionMethods, role)

    override fun combine(connectionMethods: List<ConnectionMethod>): List<ConnectionMethod> = BleConnectionMethod.combine(connectionMethods)
    ...
    interface Graph : BleHandoverMapperProvider
