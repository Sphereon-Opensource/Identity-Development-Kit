...
class CentralCharacteristicWriter(
    ...
    override suspend fun writeCharacteristic(
        ...
        return blePlatformClient.writeCharacteristic(service, characteristic, value)
    }
}
...
class PeripheralCharacteristicWriter(
    ...
    override suspend fun writeCharacteristic(
        ...
        return blePlatformPeripheral.notifyCharacteristicChanged(service, characteristic, value)
