...
/**
 * JVM-specific implementation of HKDF provider using javax.crypto APIs.
 */
class JvmHkdfProvider : HkdfProvider {
    ...
    override suspend fun hkdfSha256(
        ...
        // HKDF-SHA256 implementation for JVM
...
/**
 * Platform-specific factory for creating HKDF providers on JVM.
 */
actual fun createPlatformHkdfProvider(): HkdfProvider = JvmHkdfProvider()
