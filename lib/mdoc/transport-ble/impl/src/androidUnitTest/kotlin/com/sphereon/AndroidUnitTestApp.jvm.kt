...
abstract class AndroidUnitTestAppComponent : AbstractAppComponent(), AndroidUnitAppComponent {
    init {
        require(application is Context) { "The application provided must be of type ${Context::class.java.simpleName}" }

        // NOTE: KMS provider configuration should be done BEFORE creating the component
    ...
    fun interface Factory {
        ...
        ): AndroidUnitTestAppComponent
    }
}


interface AndroidUnitAppComponent: AppComponent {
    fun getContext(): Context
}

fun createAndroidUnitTestAppComponent(
    application: Any,
    appId: String = application.javaClass.name ?: "<unknown>",
    profile: String = "console-log-profile",
    version: String = "version-example",
): AndroidUnitTestAppComponent {
    val component = createGraphFactory<AndroidUnitTestAppComponent.Factory>().create(
