...
//            Manifest.permission.BLUETOOTH_ADMIN,
    ...
    fun testScan() = runTest(timeout = 45.seconds) {
        ...
        val app = createAndroidTestAppGraph(application = context, appId = "mdoc-ble-test", profile = "profile", version = "0.1.0")
        val contextGraph = app.userContextManager.initAnonymous()
