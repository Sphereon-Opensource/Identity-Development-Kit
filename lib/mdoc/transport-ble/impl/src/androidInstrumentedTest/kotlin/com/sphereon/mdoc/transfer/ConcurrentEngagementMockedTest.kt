...
class ConcurrentEngagementMockedTest {
    ...
    fun testSharedEphemeralKeyAcrossEngagements() = runTest(timeout = 30.seconds) {
        ...
        val appComponent = createAndroidUnitTestAppComponent(
            application = context,
        ...
        val contextComponent = appComponent.userContextManager.getAnonymous()
        val sessionComponent = contextComponent.sessionContextManager.createOrGetFromId("test")
        ...
        sessionComponent as CertificateServiceImpl.Component
        sessionComponent as MdocValidationsImpl.Component
