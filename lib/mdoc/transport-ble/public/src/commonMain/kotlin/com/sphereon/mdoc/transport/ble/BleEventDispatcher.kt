...
interface BleEventDispatcher {
     ...
     */
    fun dispatchSessionEstablishmentReceived(instanceId: Uuid, data: ByteArray)
     ...
     */
    fun dispatchSessionDataReceived(instanceId: Uuid, data: ByteArray)
     ...
     */
    fun dispatchTerminationReceived(instanceId: Uuid, data: ByteArray)
     ...
     */
    fun dispatchSessionDataSent(instanceId: Uuid, data: ByteArray)
}
