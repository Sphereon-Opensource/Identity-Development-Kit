...
class SessionEstablishmentTest {
    ...
    fun testSessionEstablishmentCreation() {
        ...
        val encodedReaderKey = CborEncodedItem.fromData(coseKey)
    ...
    @Test
    fun testSessionEstablishmentEncodeCbor() {
        val coseKey = createTestCoseKey()
        val encodedReaderKey = CborEncodedItem.fromData(coseKey)
        val data = byteArrayOf(0x01, 0x02, 0x03).toCborByteString()
        ...
        val encoded = establishment.encodeCbor()
    ...
    @Test
    fun testSessionEstablishmentDecodeCbor() {
        val coseKey = createTestCoseKey()
        val encodedReaderKey = CborEncodedItem.fromData(coseKey)
        val data = byteArrayOf(0x01, 0x02, 0x03).toCborByteString()
        ...
        val encoded = establishment.encodeCbor()
        val decoded = SessionEstablishment.decodeCbor(encoded)
    ...
    @Test
    fun testSessionEstablishmentCborBuilder() {
        val coseKey = createTestCoseKey()
        val encodedReaderKey = CborEncodedItem.fromData(coseKey)
        val data = byteArrayOf(0x01, 0x02, 0x03).toCborByteString()
        ...
        val builder = establishment.cborBuilder()
