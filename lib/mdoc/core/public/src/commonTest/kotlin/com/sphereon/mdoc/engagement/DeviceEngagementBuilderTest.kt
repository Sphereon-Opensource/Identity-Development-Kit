...
class DeviceEngagementBuilderTest {
    ...
    private fun createTestEDeviceKeyBytes(): CborEncodedItem<CoseKeyType> {
        return CborEncodedItem.fromData(createTestCoseKey())
    }
    ...
    fun testBuildVersion11WithSecurityAndOriginInfo() {
        ...
        builder.security {}
        builder.originInfo {
            cat = com.sphereon.mdoc.transfer.OriginInfoCategory(0u)
            type = com.sphereon.mdoc.transfer.OriginInfoType(1u)
        }
    ...
    fun testBuildWithMultipleOriginInfos() {
        ...
        builder.version = "1.1"
        builder.security {}
        builder.originInfos(arrayOf(
            {
                cat = com.sphereon.mdoc.transfer.OriginInfoCategory(0u)
                type = com.sphereon.mdoc.transfer.OriginInfoType(1u)
            },
            {
                cat = com.sphereon.mdoc.transfer.OriginInfoCategory(1u)
                type = com.sphereon.mdoc.transfer.OriginInfoType(0u)
            }
        ))
    ...
    fun testEncodeCbor() {
        ...
        val encoded = builder.encodeCbor()
    ...
    fun testOriginInfoBuilderWithDetails() {
        ...
        builder.cat = com.sphereon.mdoc.transfer.OriginInfoCategory(0u)
        builder.type = com.sphereon.mdoc.transfer.OriginInfoType(1u)
        builder.details["url"] = "https://example.com"

        val originInfo = builder.build()

        assertNotNull(originInfo)
        assertEquals(com.sphereon.mdoc.transfer.OriginInfoCategory(0u), originInfo.cat)
        assertEquals(com.sphereon.mdoc.transfer.OriginInfoType(1u), originInfo.type)
    ...
    fun testOriginInfoBuilderWithoutDetails() {
        val builder = OriginInfoBuilder()
        builder.cat = com.sphereon.mdoc.transfer.OriginInfoCategory(0u)
        builder.type = com.sphereon.mdoc.transfer.OriginInfoType(0u)
    ...
    fun testBleOptionsBuilderFromOptions() {
        val uuid = Uuid.random()
        val originalOptions = BleOptions(
            peripheralServerMode = true,
