...
class DeviceAuthTest {
    ...
    fun testDeviceMacFromCborStructure() {
        ...
        val mac = DeviceMac.fromCborStructure(cbor)
    ...
    fun testDeviceAuthCborBuilder() {
        ...
        val builder = deviceAuth.cborBuilder()
    ...
    fun testDeviceMacRoundTrip() {
        ...
        val decoded = DeviceMac.fromCborStructure(cbor)
    ...
    fun testDeviceAuthenticationFromOid4vp() {
        ...
        val deviceAuth = DeviceAuthentication.fromOid4vp(
    ...
    @Test
    fun testDeviceAuthenticationCborBuilder() {
        val docType = DocType("org.iso.18013.5.1.mDL")
        val deviceNamespaces = DeviceNameSpaces()
