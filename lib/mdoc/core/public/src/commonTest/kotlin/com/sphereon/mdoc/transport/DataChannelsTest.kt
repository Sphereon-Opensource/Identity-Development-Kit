...
class DataChannelsTest {
    ...
    @Test
    fun testIncomingDataChannelReceiveRaw() = runTest {
    ...
    @Test
    fun testIncomingDataChannelClose() = runTest {
        val channel = TestIncomingDataChannel()
        channel.close()
    ...
    fun testIncomingDataChannelSetEventDispatcher() {
        val channel = TestIncomingDataChannel()
        val dispatcher = object : DataChannelEventDispatcher {
    ...
    @Test
    fun testOutgoingDataChannelSendRaw() = runTest {
    ...
    @Test
    fun testOutgoingDataChannelDefaultSendEndMessage() = runTest {
    ...
    @Test
    fun testOutgoingDataChannelClose() = runTest {
        val channel = TestOutgoingDataChannel()
        channel.close()
        kotlin.test.assertTrue(channel.closeCalled)
    }
