...
class DocumentTest {
    ...
    fun testDocumentMSO() {
        ...
        assertNotNull(document.issuerSigned.issuerAuth.payload)
    }
    ...
    @Test
    fun testDocumentOriginalBytesRetained() {
        val issuerSigned = createTestIssuerSigned()
        ...
        assertEquals(originalBytes.toList(), document.original?.toList())
    }

    @Test
    fun testDocumentWithDeviceSignedAndErrors() {
        val issuerSigned = createTestIssuerSigned()
        val deviceSigned = createTestDeviceSigned()
        val errors =
            mapOf(
        ...
        assertEquals(deviceSigned, document.deviceSigned)
        assertEquals(errors, document.errors)
    }
