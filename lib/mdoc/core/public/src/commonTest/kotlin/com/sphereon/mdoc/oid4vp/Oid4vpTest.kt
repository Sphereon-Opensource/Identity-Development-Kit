...
class Oid4vpTest {
    ...
    fun testOid4vpConstraintFieldFromElementIdentifiers() {
        val field = Oid4VPConstraintField.fromElementIdentifiers(
    ...
    fun testOid4vpInputDescriptorCreation() {
        ...
        val descriptor = Oid4VPInputDescriptor(
    ...
    fun testOid4vpPresentationDefinitionCreation() {
        ...
        val definition = Oid4VPPresentationDefinition(
            id = "test-definition",
    ...
    fun testOid4vpPresentationDefinitionEquality() {
        ...
        val definition1 = Oid4VPPresentationDefinition(
            id = "test-definition",
            input_descriptors = arrayOf(descriptor)
        )
        val definition2 = Oid4VPPresentationDefinition(
            id = "test-definition",
            input_descriptors = arrayOf(descriptor)
        )
    ...
    fun testOid4vpSubmissionDescriptorCreation() {
        val descriptor = Oid4vpSubmissionDescriptor(
            id = "test-id",
            format = "mso_mdoc",
            path = "$"
        )
    ...
    fun testOid4vpPresentationSubmissionCreation() {
        ...
        val submission = Oid4VPPresentationSubmission(
            definition_id = "def-1",
            id = "sub-1",
    ...
    fun testOid4vpConstraintsInequalityDifferentFields() {
        val field1 = Oid4VPConstraintField(
            path = arrayOf("$['org.iso.18013.5.1']['family_name']"),
            intent_to_retain = true
        )
        val field2 = Oid4VPConstraintField(
    ...
    fun testOid4vpPresentationDefinitionInequalityDifferentDescriptors() {
        ...
        val constraints1 = Oid4VPConstraints(fields = arrayOf(field1))
        val constraints2 = Oid4VPConstraints(fields = arrayOf(field2))
        val descriptor1 = Oid4VPInputDescriptor(
            id = DocType("org.iso.18013.5.1.mDL"),
            format = format,
            constraints = constraints1
        )
        val descriptor2 = Oid4VPInputDescriptor(
            id = DocType("org.iso.18013.5.1.mDL"),
            format = format,
    ...
    fun testOid4vpPresentationSubmissionAssertValidSuccess() {
        ...
        val submissionDescriptor = Oid4vpSubmissionDescriptor(
    ...
    fun testOid4vpSubmissionDescriptorEqualitySameValues() {
        val descriptor1 = Oid4vpSubmissionDescriptor(
            id = "test-id",
            format = "mso_mdoc",
            path = "$"
        )
        val descriptor2 = Oid4vpSubmissionDescriptor(
            id = "test-id",
            format = "mso_mdoc",
            path = "$"
        )
    ...
    fun testOid4vpPresentationSubmissionInequalityDifferentDefinitionId() {
        ...
        val submission1 = Oid4VPPresentationSubmission(
            definition_id = "def-1",
            id = "sub-1",
            descriptor_map = arrayOf(descriptor)
        )
        val submission2 = Oid4VPPresentationSubmission(
            definition_id = "def-2",
            id = "sub-1",
            descriptor_map = arrayOf(descriptor)
        )
    ...
    fun testDocumentDescriptorMatchResultCreation() {
        ...
        val result = DocumentDescriptorMatchResult(
    ...
    fun testDocumentDescriptorMatchResultWithDeviceNamespaces() {
        ...
        val result = DocumentDescriptorMatchResult(
            ...
            documentError = null,
            deviceKeyInfo = null,
            deviceNamespaces = com.sphereon.mdoc.data.device.DeviceNameSpaces(),
    ...
    fun testDocumentDescriptorMatchResultDeviceNamespacesAssignment() {
        ...
        result.deviceNamespaces = com.sphereon.mdoc.data.device.DeviceNameSpaces()
        assertNotNull(result.deviceNamespaces)
    }
}
