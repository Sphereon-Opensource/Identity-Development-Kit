...
class DeviceSignedTest {
    ...
    @Test
    fun testDeviceNameSpacesToCborStructure() {
        val items = DeviceSignedItems(mapOf(DataElementIdentifier("key") to "value"))
        val nameSpaces = DeviceNameSpaces(mapOf(NameSpace("ns1") to items))

        val cbor = nameSpaces.toCborStructure()
        assertNotNull(cbor)
    }
    ...
    fun testDeviceSignedItemsWithValue() {
        val items = DeviceSignedItems(mapOf(
    ...
    @Test
    fun testDeviceSignedItemsToCborStructure() {
        val items = DeviceSignedItems(mapOf(DataElementIdentifier("key") to "value"))
        val cbor = items.toCborStructure()
        assertNotNull(cbor)
    }
    ...
    @Test
    fun testDeviceSignedCborBuilder() {
        val deviceAuth = createDeviceAuth()
        ...
        val builder = deviceSigned.cborBuilder()
    ...
    fun testDeviceSignedWithNameSpaces() {
        ...
        val nameSpaces = DeviceNameSpaces(mapOf(
