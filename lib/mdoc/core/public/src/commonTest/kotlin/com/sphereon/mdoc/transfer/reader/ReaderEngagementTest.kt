...
class ReaderEngagementTest {
    ...
    fun testReaderEngagementV10EncodeDecode() {
        ...
        val encoded = readerEngagementCborCodec.encode(engagement).getOrThrow()
        val decoded = readerEngagementCborCodec.decode(encoded).getOrThrow().value
    ...
    fun testHasBleRetrievalMethod() {
        ...
        val engagementWithBle =
            ReaderEngagement.V1_0(
                security = security,
                deviceRetrievalMethods = arrayOf(bleMethod),
                original = null,
            )
        val engagementWithoutBle =
            ReaderEngagement.V1_0(
                security = security,
                original = null,
            )
    ...
    fun testHasNfcRetrievalMethod() {
        ...
        val engagementWithNfc =
            ReaderEngagement.V1_0(
                security = security,
                deviceRetrievalMethods = arrayOf(nfcMethod),
                original = null,
            )
        val engagementWithoutNfc =
            ReaderEngagement.V1_0(
                security = security,
                original = null,
            )
    ...
    fun testHasWifiAwareRetrievalMethod() {
        ...
        val engagementWithWifi =
            ReaderEngagement.V1_0(
                security = security,
                deviceRetrievalMethods = arrayOf(wifiMethod),
                original = null,
            )
        val engagementWithoutWifi =
            ReaderEngagement.V1_0(
                security = security,
                original = null,
            )
    ...
    fun testHasWebsiteRetrievalMethod() {
        ...
        val engagementWithWebsite =
            ReaderEngagement.V1_0(
                security = security,
                deviceRetrievalMethods = arrayOf(websiteMethod),
                original = null,
            )
        val engagementWithoutWebsite =
            ReaderEngagement.V1_0(
                security = security,
                original = null,
            )
    ...
    fun testToEngagementUriDefaultScheme() {
        ...
        val uri = readerEngagementCborCodec.encodeUri(engagement).getOrThrow()
    ...
    fun testToEngagementUriCustomScheme() {
        ...
        val classicUri = readerEngagementCborCodec.encodeUri(engagement, "mdoc:").getOrThrow()
        assertTrue(classicUri.startsWith("mdoc:"))

        val oid4vpUri = readerEngagementCborCodec.encodeUri(engagement, "mdoc-openid4vp://").getOrThrow()
    ...
    fun testFromEngagementUriClassicScheme() {
        ...
        val uri = readerEngagementCborCodec.encodeUri(engagement, "mdoc:").getOrThrow()
    ...
    fun testFromEngagementUriOid4vpScheme() {
        ...
        val uri = readerEngagementCborCodec.encodeUri(engagement, "mdoc-openid4vp://").getOrThrow()
        val decoded = readerEngagementCborCodec.decodeUri(uri).getOrThrow().value
    ...
    fun testFromEngagementUriInvalidScheme() {
        val result = readerEngagementCborCodec.decodeUri("invalid://test")
