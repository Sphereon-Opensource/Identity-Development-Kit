...
class MdlDefinitionsTest {
    ...
    fun testMdlDefFamilyName() {
        ...
        assertEquals("family_name", Mdl.Def.family_name.identifier.toString())
    }

    @Test
    fun testMdlDefGivenName() {
        assertNotNull(Mdl.Def.given_name)
        assertEquals("given_name", Mdl.Def.given_name.identifier.toString())
    }

    @Test
    fun testMdlDefBirthDate() {
        assertNotNull(Mdl.Def.birth_date)
        assertEquals("birth_date", Mdl.Def.birth_date.identifier.toString())
    }

    @Test
    fun testMdlDefIssueDate() {
        assertNotNull(Mdl.Def.issue_date)
        assertEquals("issue_date", Mdl.Def.issue_date.identifier.toString())
    }

    @Test
    fun testMdlDefExpiryDate() {
        assertNotNull(Mdl.Def.expiry_date)
        assertEquals("expiry_date", Mdl.Def.expiry_date.identifier.toString())
    }

    @Test
    fun testMdlDefIssuingCountry() {
        assertNotNull(Mdl.Def.issuing_country)
        assertEquals("issuing_country", Mdl.Def.issuing_country.identifier.toString())
    }

    @Test
    fun testMdlDefIssuingAuthority() {
        assertNotNull(Mdl.Def.issuing_authority)
        assertEquals("issuing_authority", Mdl.Def.issuing_authority.identifier.toString())
    }

    @Test
    fun testMdlDefDocumentNumber() {
        assertNotNull(Mdl.Def.document_number)
        assertEquals("document_number", Mdl.Def.document_number.identifier.toString())
    }

    @Test
    fun testMdlDefPortrait() {
        assertNotNull(Mdl.Def.portrait)
        assertEquals("portrait", Mdl.Def.portrait.identifier.toString())
    }
