...
class DeviceItemsRequestTest {
    ...
    fun testDeviceRequestNameSpaceBuilder() {
        val builder =
            DeviceRequestNameSpace.Builder(
    ...
    fun testCborEncodeDecode() {
        ...
        val encoded = encodeDeviceItemsRequestWithCodec(original)
        val decoded = decodeDeviceItemsRequestWithCodec(encoded)
