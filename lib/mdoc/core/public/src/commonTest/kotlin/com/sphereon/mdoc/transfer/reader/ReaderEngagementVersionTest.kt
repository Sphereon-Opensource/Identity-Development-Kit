...
class ReaderEngagementVersionTest {
    ...
    fun testFromCborStructure10() {
        ...
        val version = ReaderEngagementVersion.fromCborStructure(cbor)
        assertEquals("1.0", version.toString())
    }
    ...
    fun testFromCborStructureInvalidThrows() {
        ...
        assertFailsWith<IllegalArgumentException> {
            ReaderEngagementVersion.fromCborStructure(cbor)
        }
    }
    ...
    fun testRoundTripConversion10() {
        ...
        val converted = ReaderEngagementVersion.fromCborStructure(cbor)
