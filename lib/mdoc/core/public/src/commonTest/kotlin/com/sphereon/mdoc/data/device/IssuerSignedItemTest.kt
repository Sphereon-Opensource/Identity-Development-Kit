...
class IssuerSignedItemTest {
    ...
    fun testRandomValueToCborStructure() {
        val randomValue = RandomValue()
        val cborStructure = randomValue.toCborStructure()
    ...
    fun testRandomValueFromCborStructure() {
        ...
        val cborStructure = originalValue.toCborStructure()
        val decoded = RandomValue.Decoder.fromCborStructure(cborStructure)
