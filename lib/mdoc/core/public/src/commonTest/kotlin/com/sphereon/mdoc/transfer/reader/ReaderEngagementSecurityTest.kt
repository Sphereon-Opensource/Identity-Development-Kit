...
class ReaderEngagementSecurityTest {
    ...
    @Test
    fun testReaderEngagementSecurityCborBuilder() {
        val testKey = createTestCoseKey()
        val eReaderKeyBytes = CborEncodedItem.fromData<CoseKeyType>(testKey)
    ...
    fun testReaderEngagementSecurityEncodeDecode() {
        ...
        val decoded = ReaderEngagementSecurity.decodeCbor(encoded)
    ...
    fun testReaderEngagementSecurityEquality() {
        val testKey = createTestCoseKey()
        val eReaderKeyBytes1 = CborEncodedItem.fromData<CoseKeyType>(testKey)
        val eReaderKeyBytes2 = CborEncodedItem.fromData<CoseKeyType>(testKey)
