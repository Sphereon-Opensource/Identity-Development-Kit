...
class DocRequestTest {
    ...
    fun testDocRequestCreation() {
        val itemsRequest = DeviceItemsRequest.Builder()
    ...
    fun testDocRequestCborBuilder() {
        ...
        val docRequest = DocRequest(itemsRequest)
        val builder = docRequest.cborBuilder()
    ...
    fun testDocRequestLimitDisclosures() {
        ...
        val coseKey = com.sphereon.crypto.core.cose.CoseKeyJson.Builder()
        ...
        val deviceKeyInfo = com.sphereon.mdoc.data.mso.DeviceKeyInfoCbor(
            deviceKey = coseKey,
        ...
        val validityInfo = com.sphereon.mdoc.data.mso.ValidityInfo(
            signed = now,
            validFrom = now,
            validUntil = now,
            expectedUpdate = null
        ...
        val mso = com.sphereon.mdoc.data.mso.MobileSecurityObject(
            digestAlgorithm = com.sphereon.mdoc.data.mso.DigestAlgorithm("SHA-256"),
        ...
        val encodedMso = com.sphereon.cbor.CborEncodedItem.fromData(mso).encodeCbor()
        val issuerAuth = com.sphereon.crypto.core.cose.CoseSign1<com.sphereon.mdoc.data.mso.MobileSecurityObject>(
            protectedHeader = com.sphereon.crypto.core.cose.CoseHeaderCbor(alg = com.sphereon.crypto.core.cose.CoseAlgorithm.ES256),
            unprotectedHeader = null,
            payload = com.sphereon.cbor.CborByteString(encodedMso),
            signature = com.sphereon.cbor.CborByteString(ByteArray(64) { it.toByte() })
        )
