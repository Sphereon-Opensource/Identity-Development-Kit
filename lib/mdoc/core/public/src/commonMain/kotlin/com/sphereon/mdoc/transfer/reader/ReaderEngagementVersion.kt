...
value class ReaderEngagementVersion(
    ...
    fun toCborItem(): CborString = CborString(version)

    override fun toString(): String = version

    companion object Decoder {
        fun fromCborItem(structure: CborString): ReaderEngagementVersion = ReaderEngagementVersion(structure.value)
    }
}
