...
object Pid {
    ...
    val asDefs: List<IEuPidDef> = listOf<IEuPidDef>(
        Def.family_name,
        Def.given_name,
        Def.birth_date,
        Def.age_over_18,
    ...
    class asDef(val definition: IEuPidDef) : IEuPidDef by definition {
...
@JsExportCompat
class FamilyNamePidDef() : AbstractDataElementDef(), IEuPidDef {
...
class GivenNamePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class BirthDatePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
open class AgeOverDef(val age: Int) : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class AgeInYearsPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class AgeBirthYearPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class FamilyNameBirthPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class GivenNameBirthPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class BirthPlacePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class BirthCountryPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class BirthStatePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class BirthCityPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class ResidentAddressPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class ResidentCountryPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class ResidentStatePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class ResidentCityPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class ResidentPostalCodePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class ResidentStreetPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class ResidentHouseNumberPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class GenderPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class NationalityPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class IssuanceDatePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
@JsExportCompat
class ExpiryDatePidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class IssuingAuthorityPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
    override val identifier: DataElementIdentifier = DataElementIdentifier("issuing_authority")
    override val details: String = "Name of the administrative authority that has issued this PID instance, or the ISO 3166 Alpha-2 country code of the respective Member State if there is no separate authority authorized to issue PIDs. "
    override val presence: Presence = Presence.MANDATORY
    override val cddls: Array<CDDL> = arrayOf(CDDL.tstr)
}

@JsExportCompat
class DocumentNumberPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class AdministrativeNumberPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
    override val identifier: DataElementIdentifier = DataElementIdentifier("document_number")
...
class IssuingCountryPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
...
class IssuingJurisdictionPidDef() : AbstractDataElementDef(), IEuPidDef {
    override val nameSpace: NameSpace = Pid.NAMESPACE
    override val identifier: DataElementIdentifier = DataElementIdentifier("document_number")
    override val details: String = "Country subdivision code of the jurisdiction that issued the PID, as defined in ISO 3166-2:2020, Clause 8. The first part of the code SHALL be the same as the value for issuing_country. "
    override val presence: Presence = Presence.OPTIONAL
    override val cddls: Array<CDDL> = arrayOf(CDDL.tstr)
}
