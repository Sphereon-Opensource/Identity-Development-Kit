...
sealed class RestApiError(
    ...
    data class InsecureUri(val uri: String) : RestApiError(
    ...
    data class ConnectionFailed(val uri: String, val throwable: Throwable) : RestApiError(
    ...
    data class NetworkError(val uri: String, val throwable: Throwable) : RestApiError(
    ...
    data class MissingEngagementData(val errorMsg: String) : RestApiError(errorMsg) {
        override fun toIdkError() = IdkError(
