...
class DeviceEngagementBuilder(
    ...
    fun build(): DeviceEngagement {
        if (version == null) {
            version =
                if (originInfoDslObjects.isEmpty() && capabilitiesDsl == null) {
                    "1.0"
                } else {
                    "1.1"
                }
        ...
        if (version == "1.0") {
            ...
            return DeviceEngagement.V1_1(
                ...
                deviceRetrievalMethods = deviceRetrievalMethodsDsl,
                originInfos =
                    if (originInfoDslObjects.isNotEmpty()) {
                        originInfoDslObjects.toTypedArray()
                    } else {
                        null
                    },
...
class BleOptionsBuilder {
    ...
    fun fromOptions(config: BleOptions) =
        apply {
