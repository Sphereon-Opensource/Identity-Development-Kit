...
data class DataElement(
    ...
    val intentToRetain: IntentToRetain,
    val definition: DataElementDef? = null,
) {
    fun toPair(): Pair<DataElementIdentifier, IntentToRetain> = Pair(identifier, intentToRetain)
...
abstract class AbstractDataElementDef : DataElementDef {
    ...
    @JsName("toElement")
    fun toElement(intentToRetain: IntentToRetain = IntentToRetain(false)): DataElement = DataElement(identifier, intentToRetain)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is AbstractDataElementDef) {
            return false
        }
        ...
        if (!cddls.contentEquals(other.cddls)) {
            return false
        }
    ...
    override fun toString(): String = "DataElementDef(nameSpace='$nameSpace', identifier='$identifier', presence=$presence, cddl=$cddl, cddls=${cddls.contentToString()})"
}
