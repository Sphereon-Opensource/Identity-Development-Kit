...
object Mdl {
    ...
    class asDef(val definition: IMdlDef) : IMdlDef by definition {
...
@JsExportCompat
class FamilyNameMdlDef() : AbstractDataElementDef(), IMdlDef {
...
class GivenNameMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
@JsExportCompat
class BirthDateMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
class IssueDateMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
@JsExportCompat
class ExpiryDateMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
class IssuingCountryMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
@JsExportCompat
class IssuingAuthorityMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
class DocumentNumberMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
...
@JsExportCompat
class PortraitMdlDef() : AbstractDataElementDef(), IMdlDef {
    override val nameSpace: NameSpace = Mdl.MDL_NAMESPACE
