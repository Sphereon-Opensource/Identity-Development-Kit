...
class MdocTransportRegistry {
     ...
     */
    fun getFactory(transportType: TransportType): MdocTransportFactory? {
        return factories[transportType]
    }
     ...
     */
    fun getFactory(connectionMethod: ConnectionMethod): MdocTransportFactory? {
        return factories.values.firstOrNull { it.supports(connectionMethod) }
    }
    ...
    fun getConnectionMethodFactory(deviceRetrievalMethod: DeviceRetrievalMethod): ConnectionMethodBase.Factory? {
        return connectionMethodFactories.values.firstOrNull {
     ...
     */
    fun isSupported(transportType: TransportType): Boolean {
        return transportType in factories
    }
     ...
     */
    fun getAllFactories(): Collection<MdocTransportFactory> {
