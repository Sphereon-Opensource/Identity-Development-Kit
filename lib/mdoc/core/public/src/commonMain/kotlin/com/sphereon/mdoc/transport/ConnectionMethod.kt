 ...
 */
fun Array<DeviceRetrievalMethod>.toConnectionMethods(
    registry: MdocTransportRegistry
): Set<ConnectionMethod> {
    return mapNotNull { retrievalMethod ->
 ...
 */
fun Collection<DeviceRetrievalMethod>.toConnectionMethods(
    registry: MdocTransportRegistry
): Set<ConnectionMethod> {
    return mapNotNull { retrievalMethod ->
        registry.getConnectionMethodFactory(retrievalMethod)?.create(retrievalMethod)
 ...
 */
fun Collection<ConnectionMethod>.toDeviceRetrievalMethods(): Set<DeviceRetrievalMethod> {
    return map { it.toDeviceRetrievalMethod() }.toSet()
}
