...
data class Oid4vpConnectionMethod(
    ...
    override fun toString(): String =
        "Oid4vpConnectionMethod(clientId='${options.clientId}', requestUri='${options.requestUri}', responseUri='${options.responseUri}', nonce=${if (options.nonce != null) {
            "'***'"
        } else {
            "null"
        }})"
    ...
    companion object : Factory {
        ...
        override fun supports(deviceRetrievalMethod: DeviceRetrievalMethod): Boolean =
            deviceRetrievalMethod.type == DeviceRetrievalMethodType.OID4VP &&
