...
class RestApiE2ETest {
     ...
     */
    @Test
    fun holder_successfully_sends_DeviceResponse_to_reader_endpoint() = runTest {
     ...
     */
    @Test
    fun holder_handles_reader_server_errors_gracefully() = runTest {
     ...
     */
    @Test
    fun holder_handles_network_errors_gracefully() = runTest {
    ...
    fun holder_can_parse_ReaderEngagement_with_website_retrieval_method() {
        ...
        val readerEngagement = ReaderEngagement.V1_0(
            security = ReaderEngagementSecurity(eReaderKeyBytes = CborEncodedItem.fromData(readerKey)),
    ...
    fun SessionEstablishment_CBOR_round_trip_encoding() {
        ...
        val original = SessionEstablishment(
        ...
        val decoded = SessionEstablishment.Decoder.decodeCbor(encoded)
    ...
    fun SessionData_CBOR_round_trip_encoding() {
        ...
        // When - Encode to CBOR and decode back
        val encoded = original.encodeCbor()
        val decoded = SessionData.Decoder.decodeCbor(encoded)
     ...
     */
    @Test
    fun reader_role_cannot_call_messageReceiveBlocking() = runTest {
        // Given - Transfer in reader role
        val mockClient = createMockHttpClient { request ->
            respond(content = ByteReadChannel("OK"), status = HttpStatusCode.OK)
        }

        val connectionMethod = RestApiConnectionMethod(
     ...
     */
    @Test
    fun holder_role_can_receive_cached_DeviceRequest() = runTest {
     ...
     */
    @Test
    fun holder_fails_to_receive_if_DeviceRequest_not_set() = runTest {
    ...
    private fun createMockEncodedKey(): CborEncodedItem<CoseKey> {
        ...
        return CborEncodedItem.fromData(key)
    }
    ...
    private fun createSessionExecution(): SessionExecution {
        ...
        val sessionContextManager = object : SessionContextManager {
        ...
        val contextConfig = object : ContextConfig {
