        ...
        runTest {
            ...
            val holderKey =
                CoseKey(
                    ...
                    crv = coseCurveAsCborUInt(Curve.P_256.cose), // COSE curve 1 = P-256
            ...
            assertNotNull(holderKey.d, "Holder key should have private graph")
