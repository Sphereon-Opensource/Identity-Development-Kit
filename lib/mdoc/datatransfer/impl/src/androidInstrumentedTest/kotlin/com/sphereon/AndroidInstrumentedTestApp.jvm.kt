...
//abstract class AndroidInstrumentedTestAppGraph : AbstractAppGraph() {
...
//        ): AndroidInstrumentedTestAppGraph
//    }
//}
//
//fun createAndroidInstrumentedTestAppGraph(
//    application: Any,
//    appId: String = application.javaClass.name ?: "<unknown>",
//    profile: String = "console-log-profile",
//    version: String = "version-example",
//): AndroidInstrumentedTestAppGraph {
//    val graph = createGraphFactory<AndroidInstrumentedTestAppGraph.Factory>().create(
