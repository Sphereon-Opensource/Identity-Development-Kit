...
//abstract class AndroidInstrumentedTestAppComponent : AbstractAppComponent() {
...
//        ): AndroidInstrumentedTestAppComponent
//    }
//}
//
//fun createAndroidInstrumentedTestAppComponent(
//    application: Any,
//    appId: String = application.javaClass.name ?: "<unknown>",
//    profile: String = "console-log-profile",
//    version: String = "version-example",
//): AndroidInstrumentedTestAppComponent {
//    val component = createGraphFactory<AndroidInstrumentedTestAppComponent.Factory>().create(
