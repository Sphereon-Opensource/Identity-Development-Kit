...
interface TransferManager :
    ...
    suspend fun validateReaderAuthentication(
        docRequest: DocRequest,
        requireReaderAuthentication: Boolean = false,
     ...
     * @throws Exception on signing failure
     */
    suspend fun signDocuments(signingRequests: List<DocumentSigningRequest>): List<Document>
