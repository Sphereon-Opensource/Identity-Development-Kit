...
abstract class MdocEngagementEventAdapter : MdocEngagementEvent.Listener {
    ...
    override suspend fun onStart(event: MdocEngagementEvent.Start) {}
    override suspend fun onQrShow(event: MdocEngagementEvent.QrShow) {}
    override suspend fun onQrHide(event: MdocEngagementEvent.QrHide) {}
    override suspend fun onNfcEngagement(event: MdocEngagementEvent.NfcEngagement) {}
    override suspend fun onRestApiEngagement(event: MdocEngagementEvent.RestApiEngagement) {}
    override suspend fun onDebug(event: MdocEngagementEvent.Debug) {}
    override suspend fun onData(event: MdocEngagementEvent.Data, direction: MdocEngagementEvent.Data.Direction) {}
    override suspend fun onTransfer(event: MdocEngagementEvent.Transfer) {}
    override suspend fun onConnecting(event: MdocEngagementEvent.Connecting) {}
    override suspend fun onConnected(event: MdocEngagementEvent.Connected) {}
    override suspend fun onCanceled(event: MdocEngagementEvent.Canceled) {}
    override suspend fun onDisconnected(event: MdocEngagementEvent.Disconnected) {}
    override suspend fun onError(event: MdocEngagementEvent.Error) {}
}
