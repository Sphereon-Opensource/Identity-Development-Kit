...
interface IMdocTransfer<OpenResult : Any> : AutoCloseable {
     ...
     */
    suspend fun open(transfer: TransferInstance, senderKey: CoseKeyType = transfer.engagement.data.getEphemeralKey().key): IdkResult<OpenResult, IdkErrorType>
    ...
    fun getContext(key: String): Any? {
        return getUnderlyingTransport().getContext(key)
    }
}
