...
data class EngagementConfigValidationResult(
    ...
    companion object {
        fun valid(warnings: List<String> = emptyList()): EngagementConfigValidationResult = EngagementConfigValidationResult(isValid = true, errors = emptyList(), warnings = warnings)

        fun invalid(
            errors: List<String>,
            warnings: List<String> = emptyList(),
        ): EngagementConfigValidationResult = EngagementConfigValidationResult(isValid = false, errors = errors, warnings = warnings)
    }
 ...
 */
fun EngagementConfiguration.validate(): EngagementConfigValidationResult = EngagementConfigurationValidator.validate(this)
