...
fun disambiguateConnectionMethods(
    ...
    role: MdocRole,
    bleHandoverMapper: BleHandoverMapper? = null,
): List<ConnectionMethod> = bleHandoverMapper?.disambiguate(connectionMethods, role) ?: connectionMethods
...
fun combineConnectionMethods(
    connectionMethods: List<ConnectionMethod>,
    bleHandoverMapper: BleHandoverMapper? = null,
): List<ConnectionMethod> = bleHandoverMapper?.combine(connectionMethods) ?: connectionMethods
