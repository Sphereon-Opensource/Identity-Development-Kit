    ...
    private fun handleLengthConfirmation(declaredLength: Int): UpdateBinaryResult {
        ...
        val message =
            try {
                ...
                return UpdateBinaryResult.Error("Failed to parse NDEF message: ${expected.message}")
            }
    ...
    private fun handleSingleChunk(data: ByteString): UpdateBinaryResult {
        ...
        val message =
            try {
                ...
                return UpdateBinaryResult.Error("Failed to parse single-chunk NDEF message: ${expected.message}")
            }
 ...
 */
internal fun updateBinarySuccessResponse(): ResponseApdu = ResponseApdu(NfcConst.RESPONSE_STATUS_SUCCESS)

/**
 * Creates an error ResponseApdu for UPDATE BINARY.
 */
internal fun updateBinaryErrorResponse(): ResponseApdu = ResponseApdu(NfcConst.RESPONSE_STATUS_ERROR_FILE_OR_APPLICATION_NOT_FOUND)
