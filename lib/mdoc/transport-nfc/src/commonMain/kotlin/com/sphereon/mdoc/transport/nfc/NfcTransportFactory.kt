...
class NfcTransportFactory(
    ...
    override fun supports(connectionMethod: ConnectionMethod): Boolean {
        return connectionMethod is NfcConnectionMethod
    }

    override fun getConnectionMethodFactory(): ConnectionMethodBase.Factory {
        return NfcConnectionMethod.Companion
    }
    ...
    override fun createTransfer(
        ...
        // the execution context or session component, since it's session-scoped
