...
interface MdocReaderEngagementManager : AutoCloseable {
     ...
     *
     * @see DeviceEngagement.fromEngagementUri for URI parsing details
     */
    ...
    suspend fun createReaderEngagement(
        ...
        throw NotImplementedError("Reverse engagement (reader shows QR) is not yet implemented. Use parseEngagementUri() + connect() for forward engagement.")
    }
