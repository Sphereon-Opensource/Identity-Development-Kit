...
abstract class Oid4vpRpJvmTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): Oid4vpRpJvmTestAppComponent
    }
}

fun createOid4vpRpJvmTestAppComponent(
    application: Any,
    appId: String = application.javaClass.name ?: "<unknown>",
    profile: String = "test",
    version: String = "0.0.1-TEST",
): Oid4vpRpJvmTestAppComponent {
    val component = createGraphFactory<Oid4vpRpJvmTestAppComponent.Factory>().create(
