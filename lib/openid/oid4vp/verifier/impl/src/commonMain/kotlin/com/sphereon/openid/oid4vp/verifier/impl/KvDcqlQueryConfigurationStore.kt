...
class KvDcqlQueryConfigurationStore(
    ...
    internal data class DcqlQueryConfigEntry(
        ...
        fun toPublic(): DcqlQueryConfiguration = DcqlQueryConfiguration(
            queryId = queryId,
            name = name,
    ...
    override suspend fun putPersistent(key: String, value: DcqlQueryConfiguration): IdkResult<StoreMetadata, IdkError> {
        val now = clock.now().toEpochMilliseconds()
        val entry = DcqlQueryConfigEntry(
    ...
    override suspend fun put(key: String, value: DcqlQueryConfiguration, ttlSeconds: Long): IdkResult<StoreMetadata, IdkError> {
        val now = clock.now().toEpochMilliseconds()
