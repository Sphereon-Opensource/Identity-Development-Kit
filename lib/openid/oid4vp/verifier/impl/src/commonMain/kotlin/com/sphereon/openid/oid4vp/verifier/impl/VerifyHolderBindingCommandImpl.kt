...
class VerifyHolderBindingCommandImpl(
    ...
    private suspend fun verifySdJwtHolderBinding(
        ...
        val verifyArgs = VerifySdJwtArgs(
            sdJwt = presentation,
    ...
    private suspend fun verifyJwtVpHolderBinding(
        ...
        val signatureValid = if (verifyResult.isErr) {
    ...
    private fun decodeBase64Url(input: String): String {
        return input.decodeFromBase64Url().decodeToString()
    }
}
