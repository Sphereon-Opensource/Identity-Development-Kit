...
class HandleDirectPostResponseCommandImpl(
...
), HandleDirectPostResponseCommand, HandleDirectPostResponseCommandService {
    ...
    override suspend fun doExecute(
        ...
        val parseArgs = ParseAuthorizationResponseArgs(
        ...
        val parsedResponse = parseAuthorizationResponseCommand.execute(parseArgs)
            .getOrElse { error ->
        ...
        val validateArgs = ValidateAuthorizationResponseArgs(
        ...
        val validationResult = validateAuthorizationResponseCommand.execute(validateArgs)
            .getOrElse { error ->
        ...
        val storeResult = responseCodeStore.createResponseCode(
            parsedResponse = parsedResponse,
        ...
        return Ok(DirectPostHandledResponse(
     ...
     */
    private fun buildRedirectUri(baseUri: String, responseCode: String): String {
