...
class Oid4VpVerifierServiceImpl(
    ...
    override suspend fun createAuthorizationRequest(args: CreateAuthorizationRequestArgs): IdkResult<CreatedAuthorizationRequest, IdkError> {
        return createAuthorizationRequestCommand.execute(args)
    }

    override suspend fun parseAuthorizationResponse(args: ParseAuthorizationResponseArgs): IdkResult<ParsedAuthorizationResponse, IdkError> {
        return parseAuthorizationResponseCommand.execute(args)
    }

    override suspend fun validateAuthorizationResponse(args: ValidateAuthorizationResponseArgs): IdkResult<ValidationResult, IdkError> {
        return validateAuthorizationResponseCommand.execute(args)
    }

    override suspend fun verifyHolderBinding(args: VerifyHolderBindingArgs): IdkResult<HolderBindingResult, IdkError> {
        return verifyHolderBindingCommand.execute(args)
    }

    override suspend fun buildAuthorizationRequestUri(args: BuildAuthorizationRequestUriArgs): IdkResult<StringResult, IdkError> {
        return buildAuthorizationRequestUriCommand.execute(args)
    }
    ...
    override suspend fun createSignedAuthorizationRequest(args: CreateSignedAuthorizationRequestArgs): IdkResult<SignedAuthorizationRequestResult, IdkError> {
        return createSignedAuthorizationRequestCommand.execute(args)
    }
    ...
    override suspend fun handleDirectPostResponse(args: HandleDirectPostResponseArgs): IdkResult<DirectPostHandledResponse, IdkError> {
        return handleDirectPostResponseCommand.execute(args)
    }
    ...
    override suspend fun retrieveAuthorizationResponse(args: RetrieveAuthorizationResponseArgs): IdkResult<RetrievedAuthorizationResponse, IdkError> {
        return retrieveAuthorizationResponseCommand.execute(args)
    }

    /**
     * DI component interface for accessing the OID4VP Verifier Service from session components.
     */
