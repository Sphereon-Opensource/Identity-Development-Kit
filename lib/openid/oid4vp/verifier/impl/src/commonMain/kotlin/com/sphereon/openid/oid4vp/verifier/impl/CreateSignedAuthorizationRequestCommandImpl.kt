...
class CreateSignedAuthorizationRequestCommandImpl(
...
), CreateSignedAuthorizationRequestCommand, CreateSignedAuthorizationRequestCommandService {
    ...
    override suspend fun createSignedAuthorizationRequest(
    ...
    override suspend fun doExecute(
        ...
        val createdRequest = createAuthorizationRequestCommand
        ...
        val signedJar = createSignedJarCommand.execute(jarArgs).getOrElse { error ->
        ...
        return Ok(SignedAuthorizationRequestResult(
