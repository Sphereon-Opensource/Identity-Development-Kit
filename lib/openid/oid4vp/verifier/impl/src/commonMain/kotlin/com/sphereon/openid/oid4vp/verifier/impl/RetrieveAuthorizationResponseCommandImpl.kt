...
class RetrieveAuthorizationResponseCommandImpl(
    ...
    RetrieveAuthorizationResponseCommand,
    ...
    override suspend fun retrieveAuthorizationResponse(args: RetrieveAuthorizationResponseArgs): IdkResult<RetrievedAuthorizationResponse, IdkError> = execute(args)
    ...
    override suspend fun doExecute(
        ...
        log.info(
            "Retrieved authorization response: vpToken queries=${storedResponse.parsedResponse.vpToken.queryIds.size}, " +
                "marked as used=${processedArgs.markAsUsed}",
        )

        return Ok(
            RetrievedAuthorizationResponse(
