...
class BuildAuthorizationRequestUriCommandImplTest {
    ...
    @Test
    fun `test build basic URI with openid4vp scheme`() = runTest {
        // Given: Basic authorization request
        val dcqlJson = Json.encodeToJsonElement(
        ...
        val args = BuildAuthorizationRequestUriArgs(
            request = request,
    ...
    @Test
    fun `test build URI with openid scheme`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
            redirectUri = "https://verifier.example.com/callback"
        ) {
    ...
    @Test
    fun `test build URI with haip scheme`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
            redirectUri = "https://verifier.example.com/callback"
        ) {
    ...
    @Test
    fun `test URI includes DCQL query`() = runTest {
        val dcqlJson = Json.encodeToJsonElement(
            DcqlQuery.serializer(),
            DcqlQuery(credentials = listOf(
    ...
    @Test
    fun `test URI includes response_uri for direct_post`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
            redirectUri = "https://verifier.example.com/callback"
        ) {
    ...
    @Test
    fun `test build URI with request_uri mode (PAR)`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
            redirectUri = "https://verifier.example.com/callback"
        ) {
    ...
    @Test
    fun `test request_uri mode without requestUri fails`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
            redirectUri = "https://verifier.example.com/callback"
        ) {
        ...
        assertIs<Err<*>>(result)
        assertTrue(result.error.message.defaultMessage.contains("requestUri"))
    }
    ...
    @Test
    fun `test special characters are URL encoded`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
    ...
    @Test
    fun `test client_id_scheme is included`() = runTest {
        val request = buildOid4vpAuthorizationRequest(
            clientId = "https://verifier.example.com",
            redirectUri = "https://verifier.example.com/callback"
        ) {
    ...
    private fun createTestCommand(): BuildAuthorizationRequestUriCommandImpl {
        return BuildAuthorizationRequestUriCommandImpl(
