...
expect fun createOid4vpVerifierTestAppComponent(testInstance: Any): AppComponent

class Oid4vpVerifierTestContext(sessionId: String, testInstance: Any) {
    val app: AppComponent = createOid4vpVerifierTestAppComponent(testInstance)
