...
class ParseClientIdCommandImpl(
...
), ParseClientIdCommand, ParseClientIdCommandService {
    ...
    override suspend fun parseClientId(clientId: String): IdkResult<ParsedClientId, IdkError> {
        return execute(ParseClientIdArgs(clientId))
    }
