 ...
 */
val validateVpFormatSupport =
    Validation<VpFormatSupport> {
 ...
 */
private val validClientIdSchemes =
    setOf(
        "pre-registered",
        "redirect_uri",
        "x509_san_dns",
 ...
 */
val validateWalletMetadata =
    Validation<WalletMetadata> {
 ...
 */
val validateWalletRequestUriPostBody =
    Validation<WalletRequestUriPostBody> {
...
class WalletMetadataBuilder {
     ...
     */
    fun clientIdSchemes(vararg schemes: ClientIdScheme) =
        apply {
     ...
     */
    fun requestObjectSigningAlgs(vararg algs: String) =
        apply {
     ...
     */
    fun authorizationEncryptionAlgs(vararg algs: String) =
        apply {
     ...
     */
    fun authorizationEncryptionEncs(vararg encs: String) =
        apply {
    ...
    fun build(): WalletMetadata {
        ...
        return WalletMetadata(
            ...
            clientIdSchemesSupported =
                clientIdSchemesSupported?.mapNotNull { scheme ->
 ...
 * ```
 */
fun buildWalletMetadata(block: WalletMetadataBuilder.() -> Unit): WalletMetadata = WalletMetadataBuilder().apply(block).build()
