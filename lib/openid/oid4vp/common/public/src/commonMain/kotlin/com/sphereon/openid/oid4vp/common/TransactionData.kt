...
data class TransactionDataEntry(
     ...
     */
    fun getAllowedHashAlgorithms(): List<String> {
        return transactionDataHashesAlg ?: listOf(DEFAULT_HASH_ALGORITHM)
    }
...
@Serializable
@JsExportCompat
enum class TransactionDataHashAlgorithm(val value: String) {
    @SerialName("sha-256")
    SHA_256("sha-256"),
    ...
    companion object {
        fun fromValue(value: String): TransactionDataHashAlgorithm? {
 ...
 */
val validateTransactionDataEntry: Validation<TransactionDataEntry> = Validation {
 ...
 */
val validateTransactionDataHashes: Validation<TransactionDataHashes> = Validation {
