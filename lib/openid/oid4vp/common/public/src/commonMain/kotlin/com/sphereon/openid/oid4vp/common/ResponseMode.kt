...
enum class ResponseMode(val value: String) {
     ...
     *
     * Authorization response parameters are encoded in the fragment component of the redirect URI.
     */
    @SerialName("fragment")
    FRAGMENT("fragment"),
     ...
     *
     * Authorization response parameters are encoded in the query component of the redirect URI.
    ...
    companion object {
         ...
         */
        fun fromValueOrDefault(value: String, default: ResponseMode = FRAGMENT): ResponseMode =
