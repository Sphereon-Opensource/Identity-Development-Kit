...
internal object ClientMetadataSerializer : KSerializer<ClientMetadata> {
    ...
    private val oid4vpSpecificKeys = setOf(
        "vp_formats", "client_purpose",
    ...
    override fun deserialize(decoder: Decoder): ClientMetadata {
        ...
        val vpFormats = oid4vpFields["vp_formats"]?.let {
        ...
        return ClientMetadata(
            ...
            authorizationSignedResponseAlg = oid4vpFields["authorization_signed_response_alg"]?.let {
                decoder.json.decodeFromJsonElement(it)
            },
            authorizationEncryptedResponseAlg = oid4vpFields["authorization_encrypted_response_alg"]?.let {
                decoder.json.decodeFromJsonElement(it)
            },
            authorizationEncryptedResponseEnc = oid4vpFields["authorization_encrypted_response_enc"]?.let {
                decoder.json.decodeFromJsonElement(it)
            }
        )
    }
 ...
 */
val validateVpFormatInfo = Validation<VpFormatInfo> {
 ...
 */
val validateClientMetadata = Validation<ClientMetadata> {
...
class VpFormatInfoBuilder {
     ...
     */
    fun sdJwtAlgValues(vararg algs: String) = apply {
     ...
     */
    fun kbJwtAlgValues(vararg algs: String) = apply {
     ...
     */
    fun algValues(vararg algs: String) = apply {
     ...
     */
    fun proofTypes(vararg types: String) = apply {
     ...
     */
    fun issuerAuthAlgValues(vararg algs: Int) = apply {
     ...
     */
    fun deviceAuthAlgValues(vararg algs: Int) = apply {
        deviceAuthAlgValues = algs.toMutableList()
    }

    fun build(): VpFormatInfo = VpFormatInfo(
 ...
 */
fun buildVpFormatInfo(block: VpFormatInfoBuilder.() -> Unit): VpFormatInfo {
    return VpFormatInfoBuilder().apply(block).build()
}
...
fun mdocVpFormatInfo(
    issuerAuthAlgValues: List<Int> = listOf(-7, -35, -36),
 ...
 */
fun ldpVpFormatInfo(
    proofTypes: List<String> = listOf("Ed25519Signature2018", "JsonWebSignature2020")
): VpFormatInfo = VpFormatInfo(
...
class VpFormatsBuilder {
     ...
     */
    fun jwtVpJson(algValues: List<String> = listOf("ES256", "ES384", "RS256")) = apply {
     ...
     */
    fun jwtVcJson(algValues: List<String> = listOf("ES256", "ES384", "RS256")) = apply {
     ...
     */
    fun ldpVp(proofTypes: List<String> = listOf("Ed25519Signature2018", "JsonWebSignature2020")) = apply {
     ...
     */
    fun ldpVc(proofTypes: List<String> = listOf("Ed25519Signature2018", "JsonWebSignature2020")) = apply {
     ...
     */
    fun format(name: String, info: VpFormatInfo) = apply {
        formats[name] = info
    }
     ...
     */
    fun format(name: String, block: VpFormatInfoBuilder.() -> Unit) = apply {
 ...
 * ```
 */
fun buildVpFormats(block: VpFormatsBuilder.() -> Unit): Map<String, VpFormatInfo> {
    return VpFormatsBuilder().apply(block).build()
}
