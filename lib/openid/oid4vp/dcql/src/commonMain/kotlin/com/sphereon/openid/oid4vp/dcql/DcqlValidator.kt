 ...
 */
val validateDcqlQuery = Validation<DcqlQuery> {
 ...
 */
val validateDcqlCredentialQuery = Validation<DcqlCredentialQuery> {
 ...
 */
val validateDcqlClaimQuery = Validation<DcqlClaimQuery> {
    DcqlClaimQuery::path {
 ...
 */
val validateDcqlClaimSet = Validation<DcqlClaimSet> {
    DcqlClaimSet::id {
 ...
 */
val validateDcqlCredentialSetQuery = Validation<DcqlCredentialSetQuery> {
 ...
 */
val validateDcqlCredentialSetOption = Validation<DcqlCredentialSetOption> {
 ...
 * - If present, arrays MUST be non-empty
 */
val validateDcqlResponse = Validation<DcqlResponse> {
 ...
 */
val validateDcqlCredentialMatch = Validation<DcqlCredentialMatch> {
 ...
 * - `credential_id` MUST be a non-empty string
 */
val validateDcqlCredentialSetMatch = Validation<DcqlCredentialSetMatch> {
 ...
 */
val validateSdJwtVcMeta = Validation<SdJwtVcMeta> {
 ...
 */
val validateMdocMeta = Validation<MdocMeta> {
 ...
 */
val validateDcqlTrustedAuthority = Validation<DcqlTrustedAuthority> {
...
fun <T> validate(
    ...
    value: T
): IdkResult<T, DcqlError.ValidationError> {
    return validator(value).toIdkResult()
}
