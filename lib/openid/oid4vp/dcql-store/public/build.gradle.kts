    ...
    sourceSets {
        ...
        val commonMain by getting {
            dependencies {
                ...
                // ConfigurationStore<K,V>, Oid4vpStore, StoreMetadata: generic OID4VP store
                // primitives shared by the verifier stores and this DCQL store.
                api(projects.libOpenidOid4vpCommonPublic)

                // Serialization (REST DTOs)
