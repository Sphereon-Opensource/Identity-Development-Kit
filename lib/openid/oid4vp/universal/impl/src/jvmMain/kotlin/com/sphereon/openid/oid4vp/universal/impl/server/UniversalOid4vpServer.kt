 ...
 * - [GetAuthRequestStatusServiceCommand]: GET /oid4vp/backend/auth/requests/{correlationId}
 * - [DeleteAuthRequestServiceCommand]: DELETE /oid4vp/backend/auth/requests/{correlationId}
 *
 ...
 * abstract class UniversalOid4vpServerComponent {
 ...
 *     val component = createGraph<UniversalOid4vpServerComponent>()
 *     runServer(component.dualTransportServer)
 * }
 * ```
 *
 * ## Request Flow
