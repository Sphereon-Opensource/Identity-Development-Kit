...
class Oid4vpAuthSessionStatusSerializationTest {
    ...
    fun `IdvInitiateResponse serializes correctly`() {
        val response = com.sphereon.openid.oid4vp.auth.http.model.IdvInitiateResponse(
            sessionId = "sess-1",
        ...
        val serialized = json.encodeToString(
            com.sphereon.openid.oid4vp.auth.http.model.IdvInitiateResponse.serializer(),
            response
        )
    ...
    fun `IdvStatusResponse serializes correctly`() {
        val response = com.sphereon.openid.oid4vp.auth.http.model.IdvStatusResponse(
            sessionId = "sess-1",
            status = "CREATED",
        ...
        val serialized = json.encodeToString(
            com.sphereon.openid.oid4vp.auth.http.model.IdvStatusResponse.serializer(),
            response
        )
