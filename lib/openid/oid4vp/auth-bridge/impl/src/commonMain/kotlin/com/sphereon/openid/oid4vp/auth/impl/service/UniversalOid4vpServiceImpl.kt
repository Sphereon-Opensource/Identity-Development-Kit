 ...
 * - GET /backend/auth/requests/{correlationId} - Get status
 * - DELETE /backend/auth/requests/{correlationId} - Delete request
 *
 * ## Configuration
 *
...
class UniversalOid4vpServiceImpl(
    ...
    override suspend fun getAuthorizationRequestStatus(
    ...
    override suspend fun deleteAuthorizationRequest(
        correlationId: String
    ...
    private suspend fun <T> handleErrorResponse(
        ...
        val errorMessage = errorBody?.message ?: response.bodyAsText().take(500)
