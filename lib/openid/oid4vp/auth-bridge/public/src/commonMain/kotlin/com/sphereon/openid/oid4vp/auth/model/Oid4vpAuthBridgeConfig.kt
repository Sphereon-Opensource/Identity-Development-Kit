...
data class Oid4vpAuthBridgeConfig(
    ...
    /**
     * Frontend URL for browser redirects after IDV callback completion.
     * The auth-bridge redirects to {frontendUrl}/login?wallet_session={id}&idv=complete.
     */
    val frontendUrl: String? = null,
    /**
     * Base URL of the STS (Security Token Service) for reconciliation redirects.
     * The auth-bridge redirects to {stsBaseUrl}/reconciliation/authorize?oid4vp_session={id}&provider={pid}
     * to initiate identity verification through the STS.
     */
    val stsBaseUrl: String? = null,
) {
    companion object {
