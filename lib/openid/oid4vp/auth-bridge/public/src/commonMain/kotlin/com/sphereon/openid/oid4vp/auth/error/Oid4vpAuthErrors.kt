...
object Oid4vpAuthErrors {
    ...
    fun sessionNotFound(sessionId: String) = IdkError(
    ...
    fun sessionAlreadyCompleted(sessionId: String) = IdkError(
    ...
    fun sessionNotVerified(sessionId: String) = IdkError(
    ...
    fun verifiedDataMissing(sessionId: String) = IdkError(
    ...
    fun userIdentifierNotFound(claimPath: String) = IdkError(
    ...
    fun userNotFound(reason: String) = IdkError(
    ...
    fun claimsMappingFailed(reason: String, cause: Throwable? = null) = IdkError(
    ...
    fun sessionStoreFailed(reason: String, cause: Throwable? = null) = IdkError(
    ...
    fun idvRequired(sessionId: String) = IdkError(
    ...
    fun sessionNotIdvRequired(sessionId: String) = IdkError(
    ...
    fun noReconciliationMapping(credentialType: String) = IdkError(
    ...
    fun reconciliationFailed(reason: String, cause: Throwable? = null) = IdkError(
    ...
    fun holderKeyExtractionFailed(reason: String) = IdkError(
        ...
        message = IdkError.Message(
            ...
            i18nParams = mapOf("reason" to reason),
            defaultMessage = "Failed to extract cryptographic holder key from VP token: $reason. " +
                "When reconciliation is required, the VP must contain a holder binding via jwk, did, or x5c."
        ),
        severity = IdkError.Severity.ERROR
    )

    fun noReconciliationSession(sessionId: String) = IdkError(
