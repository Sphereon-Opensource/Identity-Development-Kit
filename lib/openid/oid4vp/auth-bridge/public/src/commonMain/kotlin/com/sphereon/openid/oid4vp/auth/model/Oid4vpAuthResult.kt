...
data class Oid4vpAuthResult(
    ...
    companion object {
         ...
         * used when fresh IDV happened during this session.
         */
        const val RECONCILED_ACR = "urn:sphereon:oid4vp:vp+idv"

        /**
         * Authentication Methods References for reconciled (IDV) sessions.
         */
        val RECONCILED_AMR = listOf("vp", "idv")

        /**
         * Authentication Context Class Reference for existing binding —
         * wallet login with a pre-existing reconciliation (no fresh IDV this session).
         */
        const val BINDING_ACR = "urn:sphereon:oid4vp:vp+binding"

        /**
         * Authentication Methods References for existing binding.
         */
        val BINDING_AMR = listOf("vp", "binding")
    }
}
