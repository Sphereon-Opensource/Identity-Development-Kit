 ...
 * - DELETE /oid4vp/backend/auth/requests/{correlationId} - Delete request
 *
 * ## Implementations
 *
...
interface UniversalOid4vpService {
     ...
     *
     * Corresponds to: GET /oid4vp/backend/auth/requests/{correlationId}
     *
     ...
     */
    suspend fun getAuthorizationRequestStatus(
     ...
     *
     * Corresponds to: DELETE /oid4vp/backend/auth/requests/{correlationId}
     *
     ...
     */
    suspend fun deleteAuthorizationRequest(
        correlationId: String
