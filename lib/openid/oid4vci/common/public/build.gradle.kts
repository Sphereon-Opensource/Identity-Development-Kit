    ...
    sourceSets {
        ...
        val commonMain by getting {
            dependencies {
                ...
                // Phase 1 shared types (CredentialFormat, DisplayProperties, CryptographicBindingMethod)
                api(projects.libOpenidOid4vcCommonPublic)

                // Crypto (for JwaAlgorithm in typed extension properties)
                api(projects.libCryptoCorePublic)

                // OAuth2 common (AuthorizationServerMetadata, GrantType, TokenResponse)
