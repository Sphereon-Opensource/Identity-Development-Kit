...
import com.sphereon.openid.oid4vci.issuer.impl.http.command.GetCredentialInvitePageEndpointCommand
...
class Oid4vciIssuerProtocolDescriptorProvider(
    ...
    override fun describe(): HttpAdapterDescription =
        HttpAdapterDescription(
            ...
            endpoints =
                listOf(
                    GetCredentialInvitePageEndpointCommand.ENDPOINT,
                    GetCredentialInvitePageEndpointCommand.INSTANCE_ENDPOINT,
