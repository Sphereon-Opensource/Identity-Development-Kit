...
@StringKey(GetCredentialOfferEndpointCommand.COMMAND_ID)
    ...
    private suspend fun mintFreshOffer(offerSession: CredentialOfferSession): IdkResult<CredentialOffer, IdkError> {
        ...
        val args =
            CreateCredentialOfferArgs(
                ...
                authorizationPolicySnapshot = offerSession.authorizationPolicySnapshot
                    ?: return Err(
                        IdkError.INVALID_STATE(
                            message = "Reusable offer ${offerSession.offerId} has no immutable authorization policy snapshot",
                        ),
                    ),
            )
