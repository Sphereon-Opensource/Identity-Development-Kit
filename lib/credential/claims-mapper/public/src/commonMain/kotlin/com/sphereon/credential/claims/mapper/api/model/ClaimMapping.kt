...
data class ClaimMapping(
    ...
    companion object {
         ...
         * @return The path as a dot-separated string (e.g., "address.street")
         */
        fun pathAsString(path: List<String>, type: ClaimPathType): String = path.joinToString(".")
         ...
         */
        fun simple(sourceClaim: String, targetClaim: String = sourceClaim): ClaimMapping {
            return ClaimMapping(
         ...
         */
        fun nested(vararg path: String, targetClaim: String): ClaimMapping {
            return ClaimMapping(
         ...
         * @param targetClaim The target claim name
         */
        fun mDoc(namespace: String, elementIdentifier: String, targetClaim: String): ClaimMapping {
            return ClaimMapping(
