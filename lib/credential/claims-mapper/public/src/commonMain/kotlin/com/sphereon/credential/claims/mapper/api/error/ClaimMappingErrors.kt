...
object ClaimMappingErrors {
     ...
     */
    fun configurationNotFound(configId: String) =
        IdkError(
     ...
     */
    fun requiredCredentialMissing(credentialId: String) =
        IdkError(
     ...
     */
    fun unsupportedCredentialFormat(format: String) =
        IdkError(
     ...
     */
    fun invalidConfiguration(reason: String) =
        IdkError(
