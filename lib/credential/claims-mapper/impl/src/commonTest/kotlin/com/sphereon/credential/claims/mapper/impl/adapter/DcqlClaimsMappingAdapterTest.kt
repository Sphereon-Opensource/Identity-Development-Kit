...
class DcqlClaimsMappingAdapterTest {
    ...
    @Test
    fun `mapClaimsByQueryId should find config by query ID and map claims`() = runTest {
    ...
    @Test
    fun `mapClaimsByQueryId should fail for non-existent query ID`() = runTest {
        val credential = createTestCredential()
    ...
    @Test
    fun `mapClaimsByQueryId should apply transformations`() = runTest {
    ...
    @Test
    fun `mapClaimsByQueryId should handle multiple credentials`() = runTest {
        val config = ClaimMappingConfiguration(
    ...
    @Test
    fun `mapClaimsByQueryId should handle optional credentials`() = runTest {
        val config = ClaimMappingConfiguration(
            id = "optional-config",
    ...
    @Test
    fun `mapClaimsByQueryId should work after query ID is updated`() = runTest {
    ...
    @Test
    fun `mapClaimsByQueryId should fail after config is deleted`() = runTest {
    ...
    @Test
    fun `withDefaults should create working instance`() = runTest {
    ...
    @Test
    fun `adapter with custom mapping service should work`() = runTest {
        val customStore = InMemoryClaimMappingConfigurationStore()
        val customMappingService = com.sphereon.credential.claims.mapper.impl.mapper.ClaimsMappingServiceImpl.withDefaults()
    ...
    @Test
    fun `should support typical OIDC login flow with DCQL`() = runTest {
        // This simulates a real-world OIDC login flow using DCQL
        val loginConfig = ClaimMappingConfiguration(
