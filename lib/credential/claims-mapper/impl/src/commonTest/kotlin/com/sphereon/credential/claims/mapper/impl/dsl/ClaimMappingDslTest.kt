...
class ClaimMappingDslTest {
    ...
    @Test
    fun `DSL should create simple identity mappings`() =
        runTest {
            // DSL usage - clean and readable
            val config =
                claimMappingConfig("simple-config", "Simple Mapping") {
                    credential("pid") {
                        map("given_name")
                        map("family_name")
                        map("email")
    ...
    @Test
    fun `DSL should create source to target mappings`() =
        runTest {
            val config =
                claimMappingConfig("rename-config", "Rename Claims") {
                    credential("pid") {
    ...
    fun `DSL should support nested target paths with target function`() {
        ...
        val config =
            claimMappingConfig("target-path-config", "Target Path Claims") {
                credential("pid") {
    ...
    @Test
    fun `DSL should support nested source paths`() =
        runTest {
            val config =
                claimMappingConfig("nested-config", "Nested Claims") {
                    credential("pid") {
    ...
    fun `DSL should support mDoc namespace paths`() {
        val config =
            claimMappingConfig("mdoc-config", "mDoc Claims") {
                credential("mdl") {
    ...
    @Test
    fun `DSL should support uppercase transformation`() =
        runTest {
            val config =
                claimMappingConfig("transform-config", "Transform Claims") {
                    credential("pid") {
    ...
    @Test
    fun `DSL should support lowercase transformation`() =
        runTest {
            val config =
                claimMappingConfig("transform-config", "Transform Claims") {
                    credential("pid") {
    ...
    @Test
    fun `DSL should support concatenate transformation`() =
        runTest {
            val config =
                claimMappingConfig("concat-config", "Concatenate Claims") {
                    credential("pid") {
                        "given_name" mappedTo "full_name" using
                            concatenate(" ") {
                                suffix("family_name")
                            }
                    }
    ...
    @Test
    fun `DSL should support concatenate with prefix and suffix`() =
        runTest {
            val config =
                claimMappingConfig("concat-full-config", "Full Concatenate") {
                    credential("pid") {
                        "given_name" mappedTo "formal_name" using
                            concatenate(" ") {
                                prefix("title")
                                suffix("family_name")
                                suffix("suffix")
    ...
    @Test
    fun `DSL should support substring transformation`() =
        runTest {
            val config =
                claimMappingConfig("substring-config", "Substring Claims") {
                    credential("pid") {
    ...
    @Test
    fun `DSL should support regex replace transformation`() =
        runTest {
            val config =
                claimMappingConfig("regex-config", "Regex Claims") {
                    credential("pid") {
    ...
    @Test
    fun `DSL should support optional credentials`() =
        runTest {
            val config =
                claimMappingConfig("optional-config", "Optional Credentials") {
                    credential("pid") {
    ...
    @Test
    fun `DSL should support priority`() =
        runTest {
            val config =
                claimMappingConfig("priority-config", "Priority Claims") {
                    credential("pid") {
    ...
    @Test
    fun `DSL should support default values`() =
        runTest {
            val config =
                claimMappingConfig("default-config", "Default Values") {
                    credential("pid") {
                        "given_name" mappedTo "given_name"
    ...
    fun `DSL should support description and queryId`() {
        val config =
            claimMappingConfig("full-config", "Full Configuration") {
    ...
    @Test
    fun `DSL should support detailed mapping builder`() =
        runTest {
            val config =
                claimMappingConfig("detailed-config", "Detailed Mapping") {
                    credential("pid") {
                        mapping {
                            from("given_name")
                            to("name")
    ...
    @Test
    fun `DSL should support complex real-world configuration`() =
        runTest {
            // This demonstrates a real-world OIDC claim mapping configuration
            val config =
                claimMappingConfig("oidc-login", "OIDC Login Claims") {
                    ...
                    credential("pid") {
                        ...
                        "given_name" mappedTo "name" using
                            concatenate(" ") {
                                suffix("family_name")
                            }
