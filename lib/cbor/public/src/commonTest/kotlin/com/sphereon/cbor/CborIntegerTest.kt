...
class CborIntegerTest {
    ...
    @Test
    fun testUIntZero() {
        val encoded = Cbor.encode(CborUInt(0))
    ...
    @Test
    fun testUIntOne() {
        val encoded = Cbor.encode(CborUInt(1))
    ...
    @Test
    fun testUIntTen() {
        val encoded = Cbor.encode(CborUInt(10))
    ...
    fun testUIntTwentyThree() {
        val encoded = Cbor.encode(CborUInt(23))
    ...
    fun testUIntTwentyFour() {
        val encoded = Cbor.encode(CborUInt(24))
    ...
    fun testUIntTwentyFive() {
        val encoded = Cbor.encode(CborUInt(25))
    ...
    @Test
    fun testUIntHundred() {
        val encoded = Cbor.encode(CborUInt(100))
    ...
    fun testUIntThousand() {
        val encoded = Cbor.encode(CborUInt(1000))
    ...
    @Test
    fun testUIntMillion() {
        val encoded = Cbor.encode(CborUInt(1000000))
    ...
    fun testUIntLargeValue() {
        val encoded = Cbor.encode(CborUInt(1000000000000))
    ...
    @Test
    fun testUInt255() {
        val encoded = Cbor.encode(CborUInt(255))
    ...
    @Test
    fun testUInt256() {
        val encoded = Cbor.encode(CborUInt(256))
    ...
    @Test
    fun testUInt65535() {
        val encoded = Cbor.encode(CborUInt(65535))
    ...
    @Test
    fun testUInt65536() {
        val encoded = Cbor.encode(CborUInt(65536))
    ...
    fun testNIntMinusOne() {
        val encoded = Cbor.encode(CborNInt(1))
    ...
    fun testNIntMinusTen() {
        val encoded = Cbor.encode(CborNInt(10))
    ...
    fun testNIntMinusHundred() {
        val encoded = Cbor.encode(CborNInt(100))
    ...
    fun testNIntMinusThousand() {
        val encoded = Cbor.encode(CborNInt(1000))
    ...
    fun testDecodeKnownVectors() {
        // 0
        assertEquals(0L, Cbor.decode<CborUInt>("00".decodeFromHex()).value)
        // 1
        assertEquals(1L, Cbor.decode<CborUInt>("01".decodeFromHex()).value)
        // 10
        assertEquals(10L, Cbor.decode<CborUInt>("0a".decodeFromHex()).value)
        // 23
        assertEquals(23L, Cbor.decode<CborUInt>("17".decodeFromHex()).value)
        // 24
        assertEquals(24L, Cbor.decode<CborUInt>("1818".decodeFromHex()).value)
        // 100
        assertEquals(100L, Cbor.decode<CborUInt>("1864".decodeFromHex()).value)
        // 1000
        assertEquals(1000L, Cbor.decode<CborUInt>("1903e8".decodeFromHex()).value)
    }

    @Test
    fun testDecodeNIntKnownVectors() {
        // -1
        assertEquals(1L, Cbor.decode<CborNInt>("20".decodeFromHex()).value)
        // -10
        assertEquals(10L, Cbor.decode<CborNInt>("29".decodeFromHex()).value)
        // -100
        assertEquals(100L, Cbor.decode<CborNInt>("3863".decodeFromHex()).value)
        // -1000
        assertEquals(1000L, Cbor.decode<CborNInt>("3903e7".decodeFromHex()).value)
    }
    ...
    fun testInvalidAdditionalInfo() {
        ...
        assertFailsWith<IllegalArgumentException> {
            Cbor.decode<CborUInt>("1f".decodeFromHex())
        }
    }
    ...
    fun testTruncatedData() {
        ...
        assertFailsWith<IllegalArgumentException> {
            Cbor.decode<CborUInt>("18".decodeFromHex())
        }
    }
