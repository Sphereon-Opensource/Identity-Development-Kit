...
class EncodedCborDataItemTest {
    ...
    fun decodeRfc7049TestVector() {
        ...
        val cborEncodedDataItem = cborSerializer.decode<CborEncodedItem<Any>>(testVector.decodeFromHex())
    ...
    fun testNestedArrayEncoding() {
        ...
        val data = cborEncodedDataItem.data()
        assertNotNull(data)
    ...
    fun testEncodedCborItemDeserialization() {
        ...
        val encodedBytes = cborSerializer.encode(encodedItem)

        val decoded = cborSerializer.decode<CborEncodedItem<String>>(encodedBytes)
