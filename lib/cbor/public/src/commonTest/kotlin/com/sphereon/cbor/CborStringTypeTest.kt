...
class CborStringTypeTest {
    ...
    @Test
    fun testEmptyString() {
        val encoded = Cbor.encode(CborString(""))
    ...
    fun testSingleCharString() {
        val encoded = Cbor.encode(CborString("a"))
    ...
    @Test
    fun testIETF() {
        val encoded = Cbor.encode(CborString("IETF"))
    ...
    fun testUnicodeU00FC() {
        val encoded = Cbor.encode(CborString("\u00fc"))
    ...
    fun testUnicodeU6C34() {
        val encoded = Cbor.encode(CborString("\u6c34"))
    ...
    fun testLongerString() {
        ...
        val encoded = Cbor.encode(CborString(longString))
        val decoded = Cbor.decode<CborString>(encoded)
    ...
    fun testStringWith256Characters() {
        ...
        val encoded = Cbor.encode(CborString(string256))
        val decoded = Cbor.decode<CborString>(encoded)
    ...
    fun testEmptyByteString() {
        val encoded = Cbor.encode(CborByteString(byteArrayOf()))
    ...
    fun testByteString01020304() {
        ...
        val encoded = Cbor.encode(CborByteString(bytes))
    ...
    fun testIndefiniteLengthByteString() {
        ...
        val decoded = Cbor.decode<CborByteStringIndefLength>(hex.decodeFromHex())
    ...
    fun testCborByteStringFromCborItem() {
        ...
        val decoded = Cbor.decode<CborUInt>(byteString.value)
    ...
    fun testCborDecodeValue() {
        val uint = CborUInt(42)
        val byteString = CborByteString(Cbor.encode(uint))
        val decoded = Cbor.decode<CborUInt>(byteString.value)
        assertEquals(42L, decoded.value)
    }
    ...
    fun testToBstr() {
        ...
        val decoded = Cbor.decode<CborString>(bstr.value)
