...
class CborLabelTest {
    private fun decodeNumberLabeledMap(bytes: ByteArray): NumberLabeledMap = NumberLabeledMap(Cbor.decode(bytes))
    ...
    fun testNumberLabelFromCborStructure() {
        ...
        val label = NumberLabel.fromCborItem(uint)
        assertEquals(42L, label.value)

        val nint = CborNInt(42)
        val negLabel = NumberLabel.fromCborItem(nint)
    ...
    fun testStringLabelFromCborStructure() {
        val str = CborString("test")
        val label = StringLabel.fromCborItem(str)
    ...
    fun testCoseLabelFromCoseLabel() {
        ...
        val label = CoseLabel.fromCborItem(original)
    ...
    fun testLabelRequiredFromMap() {
        val map =
            CborMap(
                mutableMapOf<CoseLabel<*>, CborItem<*>>(
    ...
    fun testNumberLabeledMapBasic() {
        ...
        val labeledMap = decodeNumberLabeledMap(bytes)
    ...
    fun testNumberLabeledMapEncode() {
        ...
        val decoded = Cbor.decode<CborMap<NumberLabel, CborItem<*>>>(reEncoded)
    ...
    fun testNumberLabeledMapEquality() {
        ...
        val map1 = decodeNumberLabeledMap(bytes)
        val map2 = decodeNumberLabeledMap(bytes)
