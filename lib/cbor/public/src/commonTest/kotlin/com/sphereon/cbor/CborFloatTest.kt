...
class CborFloatTest {
    ...
    fun testFloat16SmallValue() {
        ...
        val decoded = Cbor.decode<CborFloat16>("f90001".decodeFromHex())
    ...
    @Test
    fun testFloat32Zero() {
        val encoded = Cbor.encode(CborFloat32(0.0f))
        assertEquals("fa00000000", encoded.encodeToHex())
        val decoded = Cbor.decode<CborFloat>(encoded)
        assertEquals(0.0f, decoded.value)
    }

    @Test
    fun testFloat32One() {
        val encoded = Cbor.encode(CborFloat32(1.0f))
    ...
    fun testFloat32OnePointFive() {
        val encoded = Cbor.encode(CborFloat32(1.5f))
    ...
    fun testFloat32Pi() {
        val pi = 3.14159265f
        val encoded = Cbor.encode(CborFloat32(pi))
        val decoded = Cbor.decode<CborFloat>(encoded)
    ...
    fun testFloat32Negative() {
        val encoded = Cbor.encode(CborFloat32(-4.0f))
        val decoded = Cbor.decode<CborFloat>(encoded)
    ...
    fun testFloat32LargeNumber() {
        val large = 100000.0f
        val encoded = Cbor.encode(CborFloat32(large))
        val decoded = Cbor.decode<CborFloat>(encoded)
    ...
    fun testFloat32SmallNumber() {
        val small = 0.00001f
        val encoded = Cbor.encode(CborFloat32(small))
        val decoded = Cbor.decode<CborFloat>(encoded)
    ...
    fun testFloat32PositiveInfinity() {
        val encoded = Cbor.encode(CborFloat32(Float.POSITIVE_INFINITY))
        val decoded = Cbor.decode<CborFloat>(encoded)
        assertEquals(Float.POSITIVE_INFINITY, decoded.value)
    }
    ...
    fun testFloat32NegativeInfinity() {
        val encoded = Cbor.encode(CborFloat32(Float.NEGATIVE_INFINITY))
        val decoded = Cbor.decode<CborFloat>(encoded)
        assertEquals(Float.NEGATIVE_INFINITY, decoded.value)
    }
    ...
    @Test
    fun testFloat32NaN() {
        val encoded = Cbor.encode(CborFloat32(Float.NaN))
        val decoded = Cbor.decode<CborFloat>(encoded)
        assertTrue(decoded.value.isNaN())
    }
    ...
    @Test
    fun testDoubleZero() {
        val encoded = Cbor.encode(CborDouble(0.0))
        assertEquals("fb0000000000000000", encoded.encodeToHex())
        val decoded = Cbor.decode<CborDouble>(encoded)
        assertEquals(0.0, decoded.value)
    }

    @Test
    fun testDoubleOne() {
        val encoded = Cbor.encode(CborDouble(1.0))
    ...
    fun testDoubleOnePointOne() {
        val encoded = Cbor.encode(CborDouble(1.1))
    ...
    fun testDoublePi() {
        ...
        val encoded = Cbor.encode(CborDouble(pi))
        val decoded = Cbor.decode<CborDouble>(encoded)
    ...
    fun testDoubleNegative() {
        val encoded = Cbor.encode(CborDouble(-4.1))
        val decoded = Cbor.decode<CborDouble>(encoded)
    ...
    fun testDoubleLargeNumber() {
        val large = 1.0e+300
        val encoded = Cbor.encode(CborDouble(large))
        val decoded = Cbor.decode<CborDouble>(encoded)
        assertEquals(large, decoded.value)
    }
    ...
    fun testDoubleSmallNumber() {
        ...
        val encoded = Cbor.encode(CborDouble(small))
        val decoded = Cbor.decode<CborDouble>(encoded)
    ...
    fun testDoublePositiveInfinity() {
        val encoded = Cbor.encode(CborDouble(Double.POSITIVE_INFINITY))
        val decoded = Cbor.decode<CborDouble>(encoded)
    ...
    fun testDoubleNegativeInfinity() {
        val encoded = Cbor.encode(CborDouble(Double.NEGATIVE_INFINITY))
        val decoded = Cbor.decode<CborDouble>(encoded)
    ...
    @Test
    fun testDoubleNaN() {
        val encoded = Cbor.encode(CborDouble(Double.NaN))
        val decoded = Cbor.decode<CborDouble>(encoded)
        assertTrue(decoded.value.isNaN())
    }
    ...
    fun testDecodeNegativeFloat32() {
        // -4.0f
        val decoded = Cbor.decode<CborFloat>("fac0800000".decodeFromHex())
        assertEquals(-4.0f, decoded.value)
    }
}
