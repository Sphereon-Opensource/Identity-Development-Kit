...
class CborRfc8949TestVectorTest {
    ...
    fun testVector_UInt_0() {
        ...
        val decoded = Cbor.decode<CborUInt>("00".decodeFromHex())
    ...
    fun testVector_UInt_1() {
        ...
        val decoded = Cbor.decode<CborUInt>("01".decodeFromHex())
    ...
    fun testVector_UInt_10() {
        ...
        val decoded = Cbor.decode<CborUInt>("0a".decodeFromHex())
    ...
    fun testVector_UInt_23() {
        ...
        val decoded = Cbor.decode<CborUInt>("17".decodeFromHex())
    ...
    fun testVector_UInt_24() {
        ...
        val decoded = Cbor.decode<CborUInt>("1818".decodeFromHex())
    ...
    fun testVector_UInt_25() {
        ...
        val decoded = Cbor.decode<CborUInt>("1819".decodeFromHex())
    ...
    fun testVector_UInt_100() {
        ...
        val decoded = Cbor.decode<CborUInt>("1864".decodeFromHex())
    ...
    fun testVector_UInt_1000() {
        ...
        val decoded = Cbor.decode<CborUInt>("1903e8".decodeFromHex())
    ...
    fun testVector_UInt_1000000() {
        ...
        val decoded = Cbor.decode<CborUInt>("1a000f4240".decodeFromHex())
    ...
    fun testVector_UInt_1000000000000() {
        ...
        val decoded = Cbor.decode<CborUInt>("1b000000e8d4a51000".decodeFromHex())
    ...
    fun testVector_NInt_Minus1() {
        // -1 -> 0x20
        val decoded = Cbor.decode<CborNInt>("20".decodeFromHex())
    ...
    fun testVector_NInt_Minus10() {
        // -10 -> 0x29
        val decoded = Cbor.decode<CborNInt>("29".decodeFromHex())
        assertEquals(10L, decoded.value)
    }
    ...
    fun testVector_NInt_Minus100() {
        // -100 -> 0x3863
        val decoded = Cbor.decode<CborNInt>("3863".decodeFromHex())
        assertEquals(100L, decoded.value)
    }
    ...
    fun testVector_NInt_Minus1000() {
        // -1000 -> 0x3903e7
        val decoded = Cbor.decode<CborNInt>("3903e7".decodeFromHex())
        assertEquals(1000L, decoded.value)
    }
    ...
    fun testVector_Bstr_Empty() {
        ...
        val decoded = Cbor.decode<CborByteString>("40".decodeFromHex())
    ...
    fun testVector_Bstr_01020304() {
        ...
        val decoded = Cbor.decode<CborByteString>("4401020304".decodeFromHex())
    ...
    fun testVector_Tstr_Empty() {
        ...
        val decoded = Cbor.decode<CborString>("60".decodeFromHex())
    ...
    fun testVector_Tstr_a() {
        ...
        val decoded = Cbor.decode<CborString>("6161".decodeFromHex())
    ...
    fun testVector_Tstr_IETF() {
        ...
        val decoded = Cbor.decode<CborString>("6449455446".decodeFromHex())
    ...
    fun testVector_Tstr_QuoteBackslash() {
        ...
        val decoded = Cbor.decode<CborString>("62225c".decodeFromHex())
        assertEquals("\"\\", decoded.value)
    }
    ...
    fun testVector_Tstr_Unicode_u00fc() {
        ...
        val decoded = Cbor.decode<CborString>("62c3bc".decodeFromHex())
    ...
    fun testVector_Tstr_Unicode_u6c34() {
        ...
        val decoded = Cbor.decode<CborString>("63e6b0b4".decodeFromHex())
    ...
    fun testVector_Array_Empty() {
        ...
        val decoded = Cbor.decode<CborArray<CborItem<*>>>("80".decodeFromHex())
    ...
    fun testVector_Array_123() {
        ...
        val decoded = Cbor.decode<CborArray<CborItem<*>>>("83010203".decodeFromHex())
    ...
    fun testVector_Array_Nested() {
        ...
        val decoded = Cbor.decode<CborArray<CborItem<*>>>("8301820203820405".decodeFromHex())
        assertEquals(3, decoded.value.size)
    }
    ...
    fun testVector_Array_25Elements() {
        ...
        val decoded = Cbor.decode<CborArray<CborItem<*>>>(encoded)
    ...
    fun testVector_Map_Empty() {
        ...
        val decoded = Cbor.decode<CborMap<CborItem<*>, CborItem<*>>>("a0".decodeFromHex())
        assertEquals(0, decoded.value.size)
    }
    ...
    fun testVector_Map_StringKeys() {
        ...
        val decoded = Cbor.decode<CborMap<CborItem<*>, CborItem<*>>>("a26161016162820203".decodeFromHex())
        assertEquals(2, decoded.value.size)
    }
    ...
    fun testVector_False() {
        ...
        val decoded = Cbor.decode<CborBool>("f4".decodeFromHex())
    ...
    fun testVector_True() {
        ...
        val decoded = Cbor.decode<CborBool>("f5".decodeFromHex())
    ...
    fun testVector_Null() {
        ...
        val decoded = Cbor.decode<CborSimple<*>>("f6".decodeFromHex())
    ...
    fun testVector_Undefined() {
        ...
        val decoded = Cbor.decode<CborSimple<*>>("f7".decodeFromHex())
    ...
    fun testVector_Float16_Zero() {
        // 0.0 (half) -> 0xf90000
        val decoded = Cbor.decode<CborFloat16>("f90000".decodeFromHex())
    ...
    fun testVector_Float16_NegativeZero() {
        // -0.0 (half) -> 0xf98000
        val decoded = Cbor.decode<CborFloat16>("f98000".decodeFromHex())
        assertEquals(-0.0f, decoded.value)
    }
    ...
    fun testVector_Float16_One() {
        // 1.0 (half) -> 0xf93c00
        val decoded = Cbor.decode<CborFloat16>("f93c00".decodeFromHex())
    ...
    fun testVector_Float16_OnePointFive() {
        // 1.5 (half) -> 0xf93e00
        val decoded = Cbor.decode<CborFloat16>("f93e00".decodeFromHex())
    ...
    fun testVector_Float16_65504() {
        ...
        val decoded = Cbor.decode<CborFloat16>("f97bff".decodeFromHex())
    ...
    fun testVector_Float16_PositiveInfinity() {
        ...
        val decoded = Cbor.decode<CborFloat16>("f97c00".decodeFromHex())
    ...
    fun testVector_Float16_NaN() {
        // NaN (half) -> 0xf97e00
        val decoded = Cbor.decode<CborFloat16>("f97e00".decodeFromHex())
    ...
    fun testVector_Float16_NegativeInfinity() {
        ...
        val decoded = Cbor.decode<CborFloat16>("f9fc00".decodeFromHex())
    ...
    fun testVector_Float32_100000() {
        ...
        val decoded = Cbor.decode<CborFloat>("fa47c35000".decodeFromHex())
    ...
    fun testVector_Float64_1e300() {
        ...
        val decoded = Cbor.decode<CborDouble>("fb7e37e43c8800759c".decodeFromHex())
    ...
    fun testVector_Float64_1Point1() {
        ...
        val decoded = Cbor.decode<CborDouble>("fb3ff199999999999a".decodeFromHex())
    ...
    fun testVector_Tag0_DateTimeString() {
        ...
        val decoded = Cbor.decode<CborItem<*>>("c074323031332d30332d32315432303a30343a30305a".decodeFromHex())
        assertIs<CborTagged<*>>(decoded)
        assertEquals(CborTagged.DATE_TIME_STRING, decoded.tagNumber)
        assertEquals("2013-03-21T20:04:00Z", (decoded.taggedItem as CborString).value)
    }

    @Test
    fun testVector_Tag1_EpochTime() {
        // 1(1363896240) -> c11a514b67b0
        val decoded = Cbor.decode<CborItem<*>>("c11a514b67b0".decodeFromHex())
        assertIs<CborTagged<*>>(decoded)
        assertEquals(CborTagged.DATE_TIME_NUMBER, decoded.tagNumber)
        assertEquals(1363896240L, (decoded.taggedItem as CborUInt).value)
    }

    @Test
    fun testVector_Tag24_EncodedCbor() {
        // 24(h'6449455446') -> d818456449455446
        val decoded = Cbor.decode<CborEncodedItem<*>>("d818456449455446".decodeFromHex())
    ...
    fun testVector_IndefiniteByteString() {
        ...
        val decoded = Cbor.decode<CborByteStringIndefLength>("5f42010243030405ff".decodeFromHex())
        assertEquals(2, decoded.value.size)
    ...
    fun testVector_IndefiniteTextString() {
        ...
        val decoded = Cbor.decode<CborStringIndefLength>("7f657374726561646d696e67ff".decodeFromHex())
        assertEquals(2, decoded.value.size)
    ...
    fun testVector_IndefiniteArray() {
        ...
        val decoded = Cbor.decode<CborArray<CborItem<*>>>("9f010203ff".decodeFromHex())
    ...
    fun testVector_IndefiniteMap() {
        ...
        val decoded = Cbor.decode<CborMap<CborItem<*>, CborItem<*>>>("bf61610161629f0203ffff".decodeFromHex())
        assertTrue(decoded.indefiniteLength)
        assertEquals(2, decoded.value.size)
    }
    ...
    fun testVector_IndefiniteArrayEmpty() {
        // [_ ] -> 0x9fff
        val decoded = Cbor.decode<CborArray<CborItem<*>>>("9fff".decodeFromHex())
        assertTrue(decoded.indefiniteLength)
        assertEquals(0, decoded.value.size)
    }
    ...
    fun testVector_NestedMixed() {
        ...
        val decoded = Cbor.decode<CborArray<CborItem<*>>>("826161a161626163".decodeFromHex())
        assertEquals(2, decoded.value.size)
