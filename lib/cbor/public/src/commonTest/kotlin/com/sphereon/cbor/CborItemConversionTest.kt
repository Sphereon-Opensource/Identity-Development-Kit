...
class CborItemConversionTest {
    ...
    @Test
    fun testToCborItemFromHasToCbor() {
    ...
    fun testCborSupportItemToValue() {
        val item = CborUInt(42)
        val value = CborSupport.itemToValue(item)
    ...
    fun testCborSupportItemFromByteArray() {
        val original = CborUInt(42)
        val bytes = CborSupport.itemToByteArray(original)
        val decoded = CborSupport.itemFromByteArray<Long>(bytes)
    ...
    fun testCborSupportDataItemFromValue() {
        val bytes = cborSerializer.encode(CborString("test"))
        val dataItem = CborSupport.dataItemFromValue<String>(bytes)
    ...
    fun testCborSupportDataItemToByteArray() {
        val bytes = cborSerializer.encode(CborString("test"))
        val dataItem = CborSupport.dataItemFromValue<String>(bytes)
        val encoded = CborSupport.dataItemToByteArray(dataItem)
        assertNotNull(encoded)
    }
    ...
    fun testRawCborEncode() {
        ...
        val reEncoded = cborSerializer.encode(raw)
    ...
    // cborSerializer global tests

    @Test
    fun testCborSerializerGlobal() {
        assertNotNull(cborSerializer)
        assertEquals(Cbor, cborSerializer)
    }
    ...
    // HasToCbor interface test

    @Test
    fun testHasToCborInterface() {
