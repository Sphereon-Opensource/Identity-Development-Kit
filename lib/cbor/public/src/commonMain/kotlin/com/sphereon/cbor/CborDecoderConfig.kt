...
data class CborDecoderConfig(
    ...
    companion object {
         ...
         */
        @JsStatic
        val PERMISSIVE = CborDecoderConfig(
 ...
 */
internal class CborDecodeState(val config: CborDecoderConfig) {
     ...
     */
    fun checkStringLength(length: Int): Boolean {
        return length <= config.maxStringLength
    }
