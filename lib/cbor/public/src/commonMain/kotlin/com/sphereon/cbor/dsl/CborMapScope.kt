...
class CborMapScope {
     ...
     * Adds a key-value pair only if the value is non-null.
     */
    fun optional(key: Int, value: Any?) {
        if (value != null) {
     ...
     * Adds a key-value pair only if the value is non-null.
     */
    fun optional(key: CoseLabel<*>, value: Any?) {
        if (value != null) {
    ...
    /**
     * Adds a key-value pair where the value is a HasToCbor object.
     */
    infix fun String.toCbor(value: HasToCbor<*>?) {
        if (value != null) {
            entries[StringLabel(this)] = value.toCborStructure()
        }
    }
     ...
     * Adds a key-value pair where the value is a HasToCbor object.
     */
    infix fun Int.toCbor(value: HasToCbor<*>?) {
        if (value != null) {
            entries[NumberLabel(this)] = value.toCborStructure()
        }
    }
     ...
     * Adds a key-value pair where the value is a HasToCbor object.
     */
    infix fun CoseLabel<*>.toCbor(value: HasToCbor<*>?) {
        if (value != null) {
            entries[this] = value.toCborStructure()
        }
    }
     ...
     */
    fun <T> nonEmptyArray(key: String, items: Collection<T>?) {
     ...
     */
    fun <T> nonEmptyArray(key: String, items: Collection<T>?, mapper: (T) -> Any?) {
        if (!items.isNullOrEmpty()) {
     ...
     * Adds an array only if the collection is non-null and non-empty.
     */
    fun <T> nonEmptyArray(key: Int, items: Collection<T>?) {
        if (!items.isNullOrEmpty()) {
     ...
     * with a mapper function to transform items.
     */
    fun <T> nonEmptyArray(key: Int, items: Collection<T>?, mapper: (T) -> Any?) {
        if (!items.isNullOrEmpty()) {
     ...
     * Adds an array only if the collection is non-null and non-empty.
     */
    fun <T> nonEmptyArray(key: CoseLabel<*>, items: Collection<T>?) {
        if (!items.isNullOrEmpty()) {
     ...
     * with a mapper function to transform items.
     */
    fun <T> nonEmptyArray(key: CoseLabel<*>, items: Collection<T>?, mapper: (T) -> Any?) {
        if (!items.isNullOrEmpty()) {
     ...
     */
    fun putTagged(key: String, tagNumber: Int, value: CborItem<*>?) {
        if (value != null) {
     ...
     */
    fun putTagged(key: CoseLabel<*>, tagNumber: Int, value: CborItem<*>?) {
        if (value != null) {
