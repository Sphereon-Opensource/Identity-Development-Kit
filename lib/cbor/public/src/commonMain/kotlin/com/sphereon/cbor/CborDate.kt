...
class CborTDate(
    value: cddl_tdate,
) : CborTagged<cddl_tdate>(CDDL.tdate.info!!, CborString(LocalDateTimeKMP.fromString(value).toMdocTdateString())) {
...
value class TDate(
    ...
    override fun toString(): String = LocalDateTimeKMP.fromString(value).toMdocTdateString()

    fun toCborItem(): CborTDate = CborTDate(toString())

    fun encodeCbor(): ByteArray = toCborItem().encodeCbor()
}

@JsExportCompat
fun CborTDate.cborTDateToEpochSeconds(
...
fun LocalDate.localDateToDateStringISO(
    ...
    epochSeconds =
        this
            .atTime(0, 0)
            .toInstant(TimeZone.of(timeZoneId ?: utils.timeZoneId))
            .epochSeconds
            .toInt(),
)
