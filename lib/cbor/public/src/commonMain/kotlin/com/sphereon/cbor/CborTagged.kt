...
open class CborTagged<T>(val tagNumber: Int, val taggedItem: CborItem<T>) :
    ...
    // Override majorType to return TAG since this is a tagged item
    // The parent class would inherit from taggedItem.cddl which is incorrect
    override val majorType: MajorType = MajorType.TAG
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (taggedItem != other.taggedItem) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + taggedItem.hashCode()
        return result
    }
    ...
    companion object {
        ...
        internal fun decode(encodedCbor: ByteArray, offset: Int): Pair<Int, CborItem<*>> {
            ...
            return when (val tag = tagNumber.toInt()) {
                ...
                DATE_TIME_NUMBER -> {
                    Pair(newItemOffset, CborTime(taggedItem.value as Long))
                }
