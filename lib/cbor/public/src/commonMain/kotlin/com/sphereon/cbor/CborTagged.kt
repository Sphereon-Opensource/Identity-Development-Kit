...
@JsExportCompat
open class CborTagged<T>(
    val tagNumber: Int,
    val taggedItem: CborItem<T>,
    ...
    override fun encode(builder: ByteStringBuilder) {
        cborEncodeLength(builder, MajorType.TAG, tagNumber)
        taggedItem.encode(builder)
    }

    override fun toJsonSimple(): JsonElement = taggedItem.toJsonSimple()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (taggedItem != other.taggedItem) {
            return false
        }
