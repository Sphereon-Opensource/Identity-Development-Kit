...
abstract class NativeCryptoTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeCryptoTestAppComponent
    }
}

fun createNativeCryptoTestAppComponent(
    application: Any,
    appId: String = "test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): NativeCryptoTestAppComponent {
    val component = createGraphFactory<NativeCryptoTestAppComponent.Factory>().create(
