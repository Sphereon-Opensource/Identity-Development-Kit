...
abstract class WasmJsCryptoTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): WasmJsCryptoTestAppComponent
    }
}

fun createWasmJsCryptoTestAppComponent(
    application: Any,
    appId: String = "test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): WasmJsCryptoTestAppComponent {
    val component = createGraphFactory<WasmJsCryptoTestAppComponent.Factory>().create(
