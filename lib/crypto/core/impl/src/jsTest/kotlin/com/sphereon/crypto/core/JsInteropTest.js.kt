 ...
 * - Component initialization works in JS
 */
class JsInteropTest {

    val app = createJsCryptoTestAppComponent(this)
    val context = app.userContextManager.getAnonymous()
    val session = context.sessionContextManager.createOrGetFromId("js-interop-test")

    @Test
    fun testJwkCreationAndSerialization(): TestResult = runTest {
    ...
    @Test
    fun testJwkDeserialization(): TestResult = runTest {
        val jwkJson = """
        {
            "kty": "EC",
            "crv": "P-256",
    ...
    @Test
    fun testCoseCurveValues(): TestResult = runTest {
    ...
    @Test
    fun testSignatureAlgorithmMapping(): TestResult = runTest {
    ...
    @Test
    fun testCryptoServicesAccessible(): TestResult = runTest {
        // Verify crypto services are accessible from the session component
        val cryptoServices = (session.component as CryptoServicesImpl.Component).cryptoServices
    ...
    @Test
    fun testKeyInfoSerialization(): TestResult = runTest {
    ...
    @Test
    fun testResolvedKeyInfoCreation(): TestResult = runTest {
    ...
    @Test
    fun testCoseJoseMappingService(): TestResult = runTest {
        // Test key type mapping via extension functions
        val joseKeyType = com.sphereon.crypto.core.cose.CoseKeyTypeEnum.EC2.toJoseKeyType()
    ...
    @Test
    fun testOkpJwkCreation(): TestResult = runTest {
    ...
    @Test
    fun testRsaJwkSerialization(): TestResult = runTest {
