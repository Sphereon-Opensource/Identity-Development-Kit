...
class JwkExternalIdentifierResolutionServiceImpl(execution: SessionExecution) :
    ...
    ), JwkExternalIdentifierResolutionService, Scoped {
    ...
    override suspend fun doExecute(
        ...
        val x5cResult = opts.x5c?.let { x5cOpts ->
        ...
        return ExternalIdentifierResult.Jwk(
            identifierOpts = opts,
    ...
    override suspend fun supports(args: Any): Boolean {
        ...
        val methodSupported = externalArgs is ExternalIdentifierJwkOpts ||
    ...
    interface Component {
        val jwkExternalIdentifierResolutionService: JwkExternalIdentifierResolutionService
    }
