...
class CreateJweJsonGeneralCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        val encryptionResult = keyManagerService.encrypt(
            keyInfo = cekInfo,
            plaintext = plaintext,
            algorithm = encAlg,
        ...
        val firstRecipientResult = wrapKeyForRecipient(
            cek = cek,
        ...
        appliedArgs.additionalRecipients?.forEach { recipientInfo ->
            ...
            val additionalRecipient = wrapKeyForRecipient(
                cek = cek,
                recipient = recipient,
                algorithm = keyAlgStr,
    ...
    private suspend fun wrapKeyForRecipient(
        ...
        if (keyAgreementAlg != null) {
            ...
            wrapResult = performEcdhEsForRecipient(
            ...
            val encryptedKey = if (keyWrapAlg == KeyWrapAlgorithm.DIR) {
            ...
            val headerWithKid = if (recipientKeyInfo.kid != null || perRecipientHeader != null) {
            ...
            wrapResult = RecipientWrapResult(
    ...
    private suspend fun performEcdhEsForRecipient(
        ...
        val recipientJwk = recipientKeyInfo.key as? Jwk
        ...
        val sharedSecret = EcdhUtils.performKeyAgreement(
        ...
        val encryptedKey = if (keyAgreementAlg.requiresKeyWrap) {
