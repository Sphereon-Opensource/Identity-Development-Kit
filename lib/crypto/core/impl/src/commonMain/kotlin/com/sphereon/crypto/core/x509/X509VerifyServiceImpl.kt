...
class X509VerifyServiceImpl() : X509VerifyVerifyPlatformCallbackCoroutines {
    ...
    override fun setPlatform(platform: X509CoroutinesCallback): HasPlatformCallback<X509CoroutinesCallback> = apply {
    ...
    override fun setTrustedCerts(trustedCerts: Array<String>?): X509VerifyService = apply{
