...
class JweServiceImpl(
    ...
    override suspend fun prepareJwe(args: PrepareJweArgs): IdkResult<PreparedJwe, IdkError> = prepareJweCommand.execute(args)

    override suspend fun createJweCompact(args: CreateJweCompactArgs): IdkResult<JweCompact, IdkError> = createJweCompactCommand.execute(args)

    override suspend fun createJweJsonFlattened(args: CreateJweJsonArgs): IdkResult<JweJsonFlattened, IdkError> = createJweJsonFlattenedCommand.execute(args)

    override suspend fun createJweJsonGeneral(args: CreateJweJsonGeneralArgs): IdkResult<JweJsonGeneral, IdkError> = createJweJsonGeneralCommand.execute(args)

    override suspend fun decryptJwe(args: DecryptJweArgs): IdkResult<JweDecryptionResult, IdkError> = decryptJweCommand.execute(args)
}
