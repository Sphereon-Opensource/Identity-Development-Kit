...
class CoseJoseProvidedKeyResolverServiceImpl(
    val x509VerifyService: X509VerifyService,
) : AbstractKeyResolverService(
        id = "jose_cose_resolver",
        supported =
            mapOf(
    ...
    override suspend fun <KT : KeyType> resolvePublicKey(
        ...
        require(identifierMethod === null || identifierMethod == IdentifierMethod.jwk || identifierMethod == IdentifierMethod.cose_key) {
            "Cannot use an identifier method other than jwk for the jwk key resolver"
        }
