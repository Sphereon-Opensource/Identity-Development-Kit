...
class GenerateMacCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        return try {
            ...
            val multihashAlg = MultihashAlgorithm.fromDigestAlg(algorithm)
                ?: return IdkError.ILLEGAL_ARGUMENT_ERROR(
            ...
            log.warn("Failed to generate MAC: ${e.message}")
            IdkError.fromString(
                message = "Failed to generate MAC: ${e.message}",
...
class VerifyMacCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        return try {
            ...
            log.warn("Failed to verify MAC: ${e.message}")
            IdkError.fromString(
                message = "Failed to verify MAC: ${e.message}",
