...
class JweCompactTest {
    ...
    @Test
    fun testEncryptAndDecryptCompactWithRSA_OAEP_A256GCM() = runTest {
    ...
    @Test
    fun testEncryptAndDecryptCompactWithRSA_OAEP_256_A128GCM() = runTest {
    ...
    @Test
    fun testCompactSerializationAndParsing() = runTest {
    ...
    @Test
    fun testMultipleEncryptDecryptCycles() = runTest {
    ...
    @Test
    fun testEncryptAndDecryptCompactWithECDH_ES_A256GCM() = runTest {
     ...
     */
    @Test
    fun testEncryptAndDecryptCompactWithECDH_ES_A128KW() = runTest {
    ...
    @Test
    fun testECDH_ES_WithDifferentCurves() = runTest {
        ...
        val recipient384 = ManagedOptsKeyInfo(
        ...
        val decryptor384 = ManagedOptsKeyInfo(
            identifier = keyInfo384,
            context = IdentifierContext(
                clientId = "ecdh-es-p384-test",
                clientIdScheme = "jwe",
    ...
    @Test
    fun testEncryptAndDecryptCompactWithDir_A256GCM() = runTest {
    ...
    @Test
    fun testEncryptAndDecryptCompactWithDir_A128GCM() = runTest {
    ...
    @Test
    fun testEncryptAndDecryptCompactWithDir_A192GCM() = runTest {
    ...
    @Test
    fun testDir_WrongKeySizeForAlgorithm() = runTest {
    ...
    @Test
    fun testMultipleDir_EncryptDecryptCycles() = runTest {
    ...
    @Test
    fun testDir_DecryptWithWrongKey() = runTest {
