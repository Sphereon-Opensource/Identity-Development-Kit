...
class KeyResolverServiceTest {
    ...
    @Test
    fun joseResolverShouldResolveJwkKey() =
        runTest {
    ...
    @Test
    fun joseResolverShouldResolveP384Key() =
        runTest {
    ...
    @Test
    fun joseResolverShouldResolveP521Key() =
        runTest {
    ...
    @Test
    fun x5cResolverShouldResolveKeyFromX5cCertificateChain() =
        runTest {
    ...
    @Test
    fun x5cResolverShouldResolveKeyWithoutKid() =
        runTest {
            // Generate a key and create a self-signed certificate
            val certificateService = session.graph.asCertificateServiceGraph().certificateService
            val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
    ...
    @Test
    fun x5cResolverShouldThrowForMissingX5c() =
        runTest {
    ...
    @Test
    fun joseResolverShouldResolveWithNullIdentifierMethod() =
        runTest {
            val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun joseResolverShouldResolveWithCoseKeyMethod() =
        runTest {
            val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun joseResolverShouldThrowForInvalidIdentifierMethod() =
        runTest {
            val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun joseResolverShouldThrowForNullKey() =
        runTest {
    ...
    @Test
    fun joseResolverShouldHandleVerifyX509TrueWithCertChain() =
        runTest {
            ...
            val resolved =
                keyManagerService.resolvePublicKey<com.sphereon.crypto.core.jose.Jwk>(
    ...
    @Test
    fun joseResolverShouldHandleVerifyX509TrueWithoutCertChain() =
        runTest {
    ...
    @Test
    fun x5cResolverShouldResolveViaKeyX509CertificateChain() =
        runTest {
    ...
    @Test
    fun x5cResolverShouldResolveCoseEncodedKey() =
        runTest {
