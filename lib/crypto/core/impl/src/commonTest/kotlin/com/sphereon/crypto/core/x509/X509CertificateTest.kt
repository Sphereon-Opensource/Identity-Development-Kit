...
-----END CERTIFICATE-----
    ...
    @Test
    fun testDownloadExtraCertificates() = runTest {
        if (isBrowserEnv()) {
        ...
        val googleCert = signumX509CertificateFromPem(googleCertPem)
        ...
        val foundIssuer = downloadedCerts.any {
    ...
    @Test
    fun testCertificateChainConstruction() = runTest {
        if (isBrowserEnv()) {
