...
expect fun createCryptoTestAppComponent(testInstance: Any): AppComponent

class CryptoTestContext(sessionId: String, testInstance: Any) {
    val app: AppComponent = createCryptoTestAppComponent(testInstance)
