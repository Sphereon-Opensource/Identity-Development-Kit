...
class EncodedCborItemTest {
    ...
    fun shouldEncodeAndDecodeKid() {
        val cborKey = CoseKey(kid = "11".toCborByteString(Encoding.UTF8), kty = CoseKeyTypeEnum.EC2.toCbor())
