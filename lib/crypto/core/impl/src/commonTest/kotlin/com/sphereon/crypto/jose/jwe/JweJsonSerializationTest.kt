...
class JweJsonSerializationTest {
    ...
    @Test
    fun testCreateJweJsonFlattenedWithRSA_OAEP_A256GCM() = runTest {
    ...
    @Test
    fun testJweJsonFlattenedSerializationAndParsing() = runTest {
    ...
    @Test
    fun testCreateJweJsonFlattenedWithECDH_ES_A256GCM() = runTest {
    ...
    @Test
    fun testCreateJweJsonGeneralWithSingleRecipient() = runTest {
        // Generate RSA key pair
        val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.RSA_SHA256)
        val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testCreateJweJsonGeneralWithMultipleRecipients() = runTest {
    ...
    @Test
    fun testJweJsonGeneralSerializationAndParsing() = runTest {
        // Generate RSA key pair
        val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.RSA_SHA256)
        val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testCreateJweJsonGeneralWithECDH_ES_A128KW() = runTest {
    ...
    @Test
    fun testDecryptWithWrongKeyFails() = runTest {
        ...
        try {
            ...
            val isExpectedException = e is IllegalStateException ||
    ...
    @Test
    fun testDslBuilderIntegrationForJsonFlattened() = runTest {
        val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.RSA_SHA256)
        val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
        ...
        // Use DSL builders
        val prepareArgs = prepareJweArgs {
            plaintext(plaintext)
            recipient(recipient)
            keyEncryptionAlg("RSA-OAEP")
            contentEncryptionAlg("A256GCM")
        ...
        val createArgs = createJweJsonArgs {
            preparedJwe(prepareResult.value)
        }
    ...
    @Test
    fun testDslBuilderIntegrationForJsonGeneral() = runTest {
        val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.RSA_SHA256)
        val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
        ...
        val createArgs = createJweJsonGeneralArgs {
            preparedJwe(prepareResult.value)
        }
