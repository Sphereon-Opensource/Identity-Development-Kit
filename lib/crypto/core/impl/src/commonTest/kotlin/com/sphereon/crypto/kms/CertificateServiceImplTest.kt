...
/**
 * Extension function to access CertificateService from a session component.
 */
fun Any.asCertificateServiceComponent(): CertificateServiceImpl.Component = this as CertificateServiceImpl.Component
...
class CertificateServiceImplTest {
    ...
    fun setUp() {
        ...
        certificateService = session.component.asCertificateServiceComponent().certificateService
    }

    // =========== CSR Generation Tests ===========

    @Test
    fun generateCSRShouldSucceedWithValidP256Key() = runTest {
        ...
        val csr = certificateService.generateCSR(
    ...
    @Test
    fun generateCSRShouldSucceedWithValidP384Key() = runTest {
    ...
    @Test
    fun generateCSRShouldIncludeAllDNElements() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        assertNotNull(keyPair)
    ...
    @Test
    fun generateCSRShouldFailWithZeroSerialNumber() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        assertNotNull(keyPair)
    ...
    @Test
    fun generateCSRShouldFailWithNegativeSerialNumber() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        assertNotNull(keyPair)
    ...
    @Test
    fun createCertificateShouldSucceedWithValidKeys() = runTest {
        // Generate issuer key
        val issuerKeyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        assertNotNull(issuerKeyPair)

        // Generate subject key
        val subjectKeyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        ...
        val subjectDN = X509DistinguishedNameElements(
            commonName = "Test Subject",
    ...
    @Test
    fun createSelfSignedCertificateShouldSucceed() = runTest {
    ...
    @Test
    fun createCertificateFromCSRShouldSucceed() = runTest {
        // Generate issuer key
        val issuerKeyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        ...
        val certResult = certificateService.createCertificateFromCSR(
            issuerKeyInfo = issuerKeyInfo,
            issuer = issuerDN,
            subjectKeyInfo = subjectKeyInfo,
            csr = csr,
