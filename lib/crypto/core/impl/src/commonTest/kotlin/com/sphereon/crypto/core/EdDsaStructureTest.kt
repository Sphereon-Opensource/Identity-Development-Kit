...
class EdDsaStructureTest {
    @Test
    fun testEdDsaSignatureAlgorithmProperties(): TestResult =
        runTest {
    ...
    @Test
    fun testEdDsaCurveMapping(): TestResult =
        runTest {
    ...
    @Test
    fun testCoseEdDsaAlgorithmProperties(): TestResult =
        runTest {
    ...
    @Test
    fun testCoseEdDsaCurveProperties(): TestResult =
        runTest {
    ...
    @Test
    fun testJwaEdDsaAlgorithmProperties(): TestResult =
        runTest {
    ...
    @Test
    fun testJwaEdDsaCurveProperties(): TestResult =
        runTest {
    ...
    @Test
    fun testOkpKeyTypeMapping(): TestResult =
        runTest {
    ...
    @Test
    fun testEdDsaJwkSerialization(): TestResult =
        runTest {
    ...
    @Test
    fun testEdDsaJwkDeserialization(): TestResult =
        runTest {
            val jwkJson =
                """
                {
    ...
    @Test
    fun testEdDsaJwkWithPrivateKey(): TestResult =
        runTest {
            // Test JWK with private key graph (d)
            val jwkJson =
                """
                {
                    "kty": "OKP",
    ...
    @Test
    fun testEdDsaSignatureAlgorithmFromCose(): TestResult =
        runTest {
    ...
    @Test
    fun testEdDsaSignatureAlgorithmFromJose(): TestResult =
        runTest {
    ...
    @Test
    fun testOkpKeyTypeFromCose(): TestResult =
        runTest {
    ...
    @Test
    fun testOkpKeyTypeFromJose(): TestResult =
        runTest {
    ...
    @Test
    fun testCoseKeyTypeOkpValue(): TestResult =
        runTest {
    ...
    @Test
    fun testEdDsaInSignatureAlgorithmAll(): TestResult =
        runTest {
    ...
    @Test
    fun testEdDsaCurveInAllCurves(): TestResult =
        runTest {
    ...
    @Test
    fun testX25519CurveProperties(): TestResult =
        runTest {
