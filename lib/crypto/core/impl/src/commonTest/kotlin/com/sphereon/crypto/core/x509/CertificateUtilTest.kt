...
import com.sphereon.crypto.core.interop.signumX509CertificateChainToX5c
...
-----END CERTIFICATE-----
    ...
    fun testx509CertificateDTOFromPem() {
        val cert = signumX509CertificateFromPem(testPem)
    ...
    fun testFingerprint() {
        val certDTO = certificateFromPem(testPem)
        val x509 = signumX509CertificateFromPem(testPem)
    ...
    fun testDerConversion() {
        ...
        val fromDer = signumX509CertificateFromDer(derBytes)
