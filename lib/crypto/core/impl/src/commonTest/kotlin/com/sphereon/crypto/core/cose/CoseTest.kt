...
class CoseTest {
    @Test
    fun shouldCreateECCoseKeyJsonFromX509CertificatePem(): TestResult =
        runTest {
    ...
    @Test
    fun shouldGetCoseKeyJsonX509CertificateAsPem(): TestResult =
        runTest {
            val coseKeyJson = CoseKeyJson.fromX509CertificatePem(certificatePemEC)
            assertNotNull(coseKeyJson)
    ...
    @Test
    fun shouldConvertECCoseKeyJsonpublicKeyPem(): TestResult =
        runTest {
            val coseKeyJson = CoseKeyJson.fromX509CertificatePem(certificatePemEC)
            assertNotNull(coseKeyJson)
    ...
    @Test
    fun shouldCreateECCoseKeyTypeFromX509CertificatePem(): TestResult =
        runTest {
    ...
    @Test
    fun shouldGetCoseKeyTypeX509CertificateAsPem(): TestResult =
        runTest {
            val coseKey = CoseKey.fromX509CertificatePem(certificatePemEC)
            assertNotNull(coseKey)
    ...
    @Test
    fun shouldConvertECCoseKeyTypepublicKeyPem(): TestResult =
        runTest {
            val coseKey = CoseKey.fromX509CertificatePem(certificatePemEC)
            assertNotNull(coseKey)
