...
/**
 * Extension function to access MultiIdentifierResolutionService from a session component.
 */
fun Any.asMultiIdentifierResolutionServiceComponent(): MultiIdentifierResolutionServiceImpl.Component =
    this as MultiIdentifierResolutionServiceImpl.Component
...
class MultiIdentifierResolutionServiceTest {
    ...
    fun setUp() {
        ...
        multiIdentifierService = session.component.asMultiIdentifierResolutionServiceComponent().identifierService
    }

    // =========== MultiIdentifierResolutionService Tests ===========

    @Test
    fun multiIdentifierServiceShouldSupportKeyMethod() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportJwkMethod() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportX5cMethod() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportKidMethod() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportKeyAliasMethod() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportCoseKeyMethod() = runTest {
    ...
    @Test
    fun multiIdentifierServiceSupportedMethodsShouldIncludeMultipleMethods() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportKeyTypeIdentifier() = runTest {
    ...
    @Test
    fun multiIdentifierServiceShouldSupportManagedOptsKeyInfo() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
    ...
    @Test
    fun multiIdentifierServiceShouldSupportExternalIdentifierJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
    ...
    @Test
    fun multiIdentifierServiceShouldResolveManagedOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
    ...
    @Test
    fun multiIdentifierServiceShouldResolveExternalJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun multiIdentifierServiceAsSupportedOptsShouldSucceedForManagedOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun multiIdentifierServiceAsSupportedOptsShouldSucceedForExternalOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
