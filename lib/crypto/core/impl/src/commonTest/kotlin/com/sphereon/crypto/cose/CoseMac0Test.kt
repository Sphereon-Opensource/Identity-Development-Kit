...
class CoseMac0Test {
    ...
    @Test
    fun defaultCreateMac0WithHmacSha256ShouldSucceed() =
        runTest {
            val input =
                CoseMac0InputCbor(
    ...
    @Test
    fun defaultCreateMac0WithHmacSha384ShouldSucceed() =
        runTest {
            val input =
                CoseMac0InputCbor(
    ...
    @Test
    fun defaultCreateMac0WithHmacSha512ShouldSucceed() =
        runTest {
            val input =
                CoseMac0InputCbor(
    ...
    @Test
    fun defaultCreateMac0ShouldUseAlgorithmFromHeaderWhenNotSpecified() =
        runTest {
            val input =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
    ...
    @Test
    fun defaultCreateMac0ShouldSetAlgorithmInHeader() =
        runTest {
    ...
    @Test
    fun defaultCreateMac0ShouldPreservePayload() =
        runTest {
            val input =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
            ...
            assertTrue(
                result.coseMac0.payload!!
                    .value
                    .contentEquals(testPayload),
            )
        }

    @Test
    fun defaultCreateMac0ShouldPreserveUnprotectedHeader() =
        runTest {
    ...
    @Test
    fun defaultCreateMac0ShouldFailWithNullProvider() =
        runTest {
            val input =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
    ...
    @Test
    fun defaultCreateMac0ShouldProduceDeterministicOutput() =
        runTest {
            val input =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
            ...
            assertTrue(
                result1.coseMac0.tag.value
                    .contentEquals(result2.coseMac0.tag.value),
            )
        }

    @Test
    fun defaultCreateMac0ShouldProduceDifferentTagsForDifferentSecrets() =
        runTest {
            val input =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
    ...
    @Test
    fun defaultCreateMac0ShouldProduceDifferentTagsForDifferentPayloads() =
        runTest {
            val input1 =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
    ...
    @Test
    fun defaultCreateMac0ShouldWorkWithExternalAad() =
        runTest {
    ...
    @Test
    fun defaultCreateMac0WithDifferentAadShouldProduceDifferentTags() =
        runTest {
            val input1 =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
    ...
    @Test
    fun defaultCreateMac0WithDetachedPayloadShouldSucceed() =
        runTest {
            val input =
                CoseMac0InputCbor(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.HMAC256_256),
    ...
    @Test
    fun defaultCreateMac0UsingKeysShouldSucceedWithEcdhKeys() =
        runTest {
    ...
    @Test
    fun defaultCreateMac0UsingKeysShouldFailWithNullProvider() =
        runTest {
            // Setup DI components for key generation
            val app = createCryptoTestAppGraph(this@CoseMac0Test)
            val context = app.userContextManager.getAnonymous()
