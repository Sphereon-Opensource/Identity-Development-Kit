...
class AbstractCoseCryptoServiceTest {
    ...
    @Test
    fun sign1ShouldUseAlgorithmFromProtectedHeader() =
        runTest {
    ...
    @Test
    fun sign1ShouldUseAlgorithmFromKeyInfoWhenNotInHeader() =
        runTest {
    ...
    @Test
    fun sign1WithoutX5ChainShouldWorkWhenNotRequired() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1WithUnprotectedHeaderShouldWork() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1WithKeyInfoContainingKeyShouldWork() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1WithKeyInfoWithoutKeyShouldAttemptKeyResolution() =
        runTest {
    ...
    @Test
    fun verify1ShouldWorkWithValidSignature() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun verify1ShouldReturnErrorResultWhenServiceDisabled() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun verify1WithAlgorithmFromUnprotectedHeaderShouldWork() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun mac0ShouldDelegateToCallback() =
        runTest {
                ...
                object : CoseCryptoCallbackCoroutines {
                    ...
                    override suspend fun verify1(
                        ...
                        com.sphereon.crypto.core.generic
                            .VerifySignatureResult(keyInfo = null, name = "test", error = false, critical = false)
                    ...
                    override suspend fun mac0(
                        ...
                        return CoseMac0Result(
                            input = input,
                            coseMac0 =
                                com.sphereon.crypto.core.cose.CoseMac0Cbor(
    ...
    @Test
    fun sign1ShouldUseAlgorithmFromUnprotectedHeaderWhenNotInProtected() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1ShouldDefaultToES256ForEC2KeyTypeWhenNoAlgProvided() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun sign1ShouldThrowWhenRequireX5ChainTrueAndNoX5Chain() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1ShouldUseKidFromKeyInfo() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1ShouldUseKidFromProtectedHeaderWhenNotInKeyInfo() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun sign1ShouldThrowWhenNoKeyInfoAndNoX5chain() =
        runTest {
            val input =
                CoseSign1Input(
                    protectedHeader = CoseHeaderCbor(alg = CoseAlgorithm.ES256),
    ...
    @Test
    fun verify1ShouldDeriveAlgorithmFromKey() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun verify1ShouldConstructKeyInfoFromX5ChainWhenNoKeyInfoProvided() =
        runTest {
    ...
    @Test
    fun verify1WithAlgorithmOnlyInUnprotectedHeaderShouldWork() =
        runTest {
    ...
    @Test
    fun sign1WithX5ChainInUnprotectedHeaderOnlyShouldWork() =
        runTest {
    ...
    @Test
    fun sign1ShouldUseKidFromUnprotectedHeaderWhenNotInProtectedOrKeyInfo() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKey = CoseJoseKeyMappingService.toCoseKey(keyInfo.key!!)
    ...
    @Test
    fun sign1WithRSAKeyTypeShouldNotDefaultToES256() =
        runTest {
    ...
    @Test
    fun sign1WithX5ChainInHeaderShouldWork() =
        runTest {
    ...
    @Test
    fun verify1WithX5chainButNoKeyInfoShouldDeriveKey() =
        runTest {
    ...
    @Test
    fun sign1WithNoAlgAndNoKeyTypeShouldUseDefault() =
        runTest {
    ...
    @Test
    fun sign1ShouldPreserveAlgInProtectedHeaderWhenAlreadySet() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun verify1ShouldFallbackToKeyTypeWhenNoAlgorithm() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1ShouldCreateNewProtectedHeaderWhenNull() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1ShouldUseAlgorithmFromKeyInfoWhenNotInHeaders() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKey = CoseJoseKeyMappingService.toCoseKey(keyInfo.key!!)
    ...
    @Test
    fun sign1WithNullUnprotectedHeaderShouldCreateNew() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1ShouldDeriveAlgFromES384Key() =
        runTest {
    ...
    @Test
    fun sign1ShouldDeriveAlgFromES512Key() =
        runTest {
    ...
    @Test
    fun verify1WithOnlyUnprotectedAlgShouldDeriveKeyType() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1WithKeyInfoWithoutKeyShouldResolveViaCallback() =
        runTest {
    ...
    @Test
    fun sign1WithAlgOnlyInProtectedHeaderShouldReturnEarly() =
        runTest {
    ...
    @Test
    fun sign1WithX5ChainInProtectedHeaderOnlyShouldWork() =
        runTest {
    ...
    @Test
    fun sign1WithUnprotectedHeaderExistingShouldCopyIt() =
        runTest {
    ...
    @Test
    fun sign1WithProtectedHeaderAlreadyHavingAlgShouldNotOverwrite() =
        runTest {
    ...
    @Test
    fun sign1WithNullProtectedHeaderShouldCreateWithAlg() =
        runTest {
    ...
    @Test
    fun verify1WithX5chainInProtectedHeaderShouldExtractKey() =
        runTest {
    ...
    @Test
    fun sign1WithKeyTypeFromKeyInfoShouldBeUsedForDefault() =
        runTest {
    ...
    @Test
    fun sign1WithNullKeyInKeyInfoShouldResolveViaCallback() =
        runTest {
    ...
    @Test
    fun verify1WithKidInProtectedHeaderShouldExtract() =
        runTest {
    ...
    @Test
    fun sign1WithX5chainAndKidShouldSetKidInCoseKey() =
        runTest {
    ...
    @Test
    fun sign1WithAlgHavingNoCurveShouldFallbackToJwkCurve() =
        runTest {
    ...
    @Test
    fun sign1WithES384X5ChainShouldWork() =
        runTest {
    ...
    @Test
    fun verify1WithRSAKeyShouldWork() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1WithRSAKeyAndNoAlgShouldNotDefaultToES256() =
        runTest {
    ...
    @Test
    fun sign1WithPSSAlgorithmShouldWork() =
        runTest {
    ...
    @Test
    fun verify1WithRSAX5ChainShouldBuildKeyInfoWithRSAParams() =
        runTest {
    ...
    @Test
    fun sign1WithES512ShouldUseP521Curve() =
        runTest {
    ...
    @Test
    fun verify1WithX5ChainInUnprotectedHeaderShouldExtractKey() =
        runTest {
    ...
    @Test
    fun sign1WithNullProtectedHeaderShouldCreateNewOne() =
        runTest {
    ...
    @Test
    fun sign1WithNoKeyInfoAndNoX5ChainShouldThrowWithCorrectMessage() =
        runTest {
    ...
    @Test
    fun verify1WithNoKeyInfoAndNoX5ChainShouldThrowWithCorrectMessage() =
        runTest {
    ...
    @Test
    fun sign1WithRequireX5ChainTrueAndNoX5ChainShouldThrowWithCorrectMessage() =
        runTest {
            val managedKeyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            val coseKeyInfo = CoseJoseKeyMappingService.toCoseKeyInfo(keyInfo)
    ...
    @Test
    fun sign1DisabledServiceShouldThrowWithCorrectMessage() =
        runTest {
            val service = CoseCryptoServiceImpl()
            service.setPlatform(createMockCallback())
            service.disable()
    ...
    @Test
    fun sign1NoPlatformRegisteredShouldThrowWithCorrectMessage() =
        runTest {
            DefaultCallbacks.setCoseCryptoDefault(null)
            val service = CoseCryptoServiceImpl()
    ...
    @Test
    fun defaultAlgorithmForNonECKeyTypeShouldReturnNullAndCauseError() =
        runTest {
    ...
    @Test
    fun sign1WithRSAKeyAndExplicitAlgorithmShouldWork() =
        runTest {
    ...
    @Test
    fun buildKeyInfoFromJwkWithNullAlgShouldProduceKeyInfoWithoutAlg() =
        runTest {
            ...
            val result =
                testService.testBuildKeyInfoFromJwk(
                    jwk = jwkWithoutAlg,
                    x5chain = x5chain,
    ...
    @Test
    fun buildKeyInfoFromJwkWithCurveFallbackToJwkCrv() =
        runTest {
    ...
    @Test
    fun buildKeyInfoFromJwkWithRSAKeyShouldNotSetECParams() =
        runTest {
    ...
    private fun createMockCallback(): CoseCryptoCallbackCoroutines =
        object : CoseCryptoCallbackCoroutines {
            override suspend fun sign(
                input: com.sphereon.crypto.core.cose.ToBeSignedCbor,
                requireX5Chain: Boolean?,
