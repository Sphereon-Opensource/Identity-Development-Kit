...
class JweBuildersTest {
    ...
    @Test
    fun shouldBuildBasicJweHeader(): TestResult = runTest {
    ...
    @Test
    fun shouldBuildJweHeaderWithAllAlgorithmParams(): TestResult = runTest {
        val header = JweHeaderBuilder()
            .alg("ECDH-ES+A256KW")
            .enc("A256GCM")
            .zip("DEF")
    ...
    @Test
    fun shouldBuildJweHeaderWithKeyIdentification(): TestResult = runTest {
        val header = JweHeaderBuilder()
            .alg("RSA-OAEP")
            .enc("A128GCM")
            .kid("my-key-id")
    ...
    @Test
    fun shouldBuildJweHeaderWithX5c(): TestResult = runTest {
        val header = JweHeaderBuilder()
            .alg("RSA-OAEP")
            .enc("A256GCM")
    ...
    @Test
    fun shouldBuildJweHeaderWithContentTypes(): TestResult = runTest {
        val header = JweHeaderBuilder()
            .alg("A256KW")
            .enc("A256GCM")
            .typ("JOSE")
    ...
    @Test
    fun shouldBuildJweHeaderWithCritical(): TestResult = runTest {
        val header = JweHeaderBuilder()
            .alg("RSA-OAEP")
            .enc("A256GCM")
    ...
    @Test
    fun shouldBuildJweHeaderWithEcdhParams(): TestResult = runTest {
        val epkJwk = Jwk(
            kty = JwaKeyType.EC,
            crv = JwaCurve.P_256,
            x = "test-x-coord",
    ...
    @Test
    fun shouldBuildJweHeaderWithAesGcmKwParams(): TestResult = runTest {
        val header = JweHeaderBuilder()
            .alg("A256GCMKW")
            .enc("A256GCM")
    ...
    @Test
    fun shouldBuildJweHeaderWithPbes2Params(): TestResult = runTest {
        val header = JweHeaderBuilder()
    ...
    @Test
    fun shouldBuildJweHeaderWithJwk(): TestResult = runTest {
        val jwk = Jwk(
            kty = JwaKeyType.RSA,
            n = "modulus",
            e = "AQAB"
    ...
    @Test
    fun shouldCreateHeaderBuilderFromExisting(): TestResult = runTest {
        val original = JweHeaderBuilder()
            .alg("RSA-OAEP")
            .enc("A256GCM")
            .kid("key-123")
            .build()

        val copy = JweHeaderBuilder.from(original)
            .typ("JOSE")
            .build()
    ...
    @Test
    fun shouldUseJweHeaderDslFunction(): TestResult = runTest {
    ...
    @Test
    fun shouldBuildDefaultJweOpts(): TestResult = runTest {
    ...
    @Test
    fun shouldBuildJweOptsWithCompression(): TestResult = runTest {
    ...
    @Test
    fun shouldBuildJweOptsWithExplicitCompression(): TestResult = runTest {
        val optsEnabled = JweOptsBuilder()
            .compress(true)
            .build()
        assertTrue(optsEnabled.compress)

        val optsDisabled = JweOptsBuilder()
            .compress(false)
            .build()
    ...
    @Test
    fun shouldBuildJweOptsWithProtectedHeaderObject(): TestResult = runTest {
        val header = jweHeader {
            typ("JOSE")
            cty("JWT")
        }
    ...
    @Test
    fun shouldBuildJweOptsWithProtectedHeaderBuilder(): TestResult = runTest {
        val opts = JweOptsBuilder()
            .protectedHeader {
                typ("JOSE+JSON")
            }
    ...
    @Test
    fun shouldBuildJweOptsWithUnprotectedHeaderObject(): TestResult = runTest {
        val header = jweHeader {
            kid("unprotected-key")
        }
    ...
    @Test
    fun shouldBuildJweOptsWithUnprotectedHeaderBuilder(): TestResult = runTest {
        val opts = JweOptsBuilder()
            .unprotectedHeader {
    ...
    @Test
    fun shouldUseJweOptionsDslFunction(): TestResult = runTest {
        val opts = jweOptions {
            compress()
            protectedHeader {
                typ("JOSE")
    ...
    @Test
    fun shouldBuildPrepareJweArgsWithPlaintext(): TestResult = runTest {
    ...
    @Test
    fun shouldBuildPrepareJweArgsWithPlaintextString(): TestResult = runTest {
        val args = PrepareJweArgsBuilder()
    ...
    @Test
    fun shouldBuildPrepareJweArgsWithOptions(): TestResult = runTest {
        val args = PrepareJweArgsBuilder()
    ...
    @Test
    fun shouldBuildPrepareJweArgsWithOptionsObject(): TestResult = runTest {
    ...
    @Test
    fun shouldFailBuildPrepareJweArgsWithoutKeyEncryptionAlg(): TestResult = runTest {
        val builder = PrepareJweArgsBuilder()
            .plaintextString("test")
            .contentEncryptionAlg("A256GCM")
    ...
    @Test
    fun shouldFailBuildPrepareJweArgsWithoutContentEncryptionAlg(): TestResult = runTest {
        val builder = PrepareJweArgsBuilder()
            .plaintextString("test")
            .keyEncryptionAlg("RSA-OAEP")
    ...
    @Test
    fun shouldUsePrepareJweArgsDslFunction(): TestResult = runTest {
    ...
    @Test
    fun shouldBuildCreateJweCompactArgs(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader {
                alg("RSA-OAEP")
                enc("A256GCM")
            },
    ...
    @Test
    fun shouldBuildCreateJweCompactArgsWithAad(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader {
                alg("A256KW")
                enc("A128GCM")
    ...
    @Test
    fun shouldUseCreateJweCompactArgsDslFunction(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
    ...
    @Test
    fun shouldBuildCreateJweJsonArgs(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader {
                alg("ECDH-ES+A128KW")
                enc("A128GCM")
    ...
    @Test
    fun shouldBuildCreateJweJsonArgsWithAad(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader { alg("RSA-OAEP"); enc("A256GCM") }
        )
    ...
    @Test
    fun shouldUseCreateJweJsonArgsDslFunction(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader { alg("A256KW"); enc("A256GCM") }
        )
    ...
    @Test
    fun shouldBuildCreateJweJsonGeneralArgs(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader {
                alg("ECDH-ES+A256KW")
                enc("A256GCM")
    ...
    @Test
    fun shouldBuildCreateJweJsonGeneralArgsWithRecipientInfo(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader { alg("RSA-OAEP"); enc("A256GCM") }
        )
        val recipientInfo = JweRecipientInfo(
            recipient = null,
    ...
    @Test
    fun shouldBuildCreateJweJsonGeneralArgsWithAad(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader { alg("A256KW"); enc("A128GCM") }
        )
    ...
    @Test
    fun shouldUseCreateJweJsonGeneralArgsDslFunction(): TestResult = runTest {
        val preparedJwe = PreparedJwe(
            header = jweHeader { alg("ECDH-ES"); enc("A256GCM") }
        )
    ...
    @Test
    fun shouldBuildDecryptJweArgs(): TestResult = runTest {
    ...
    @Test
    fun shouldUseDecryptJweArgsDslFunction(): TestResult = runTest {
        val header = jweHeader {
            alg("A128KW")
            enc("A128GCM")
        }
    ...
    @Test
    fun shouldUseJweHeaderBuilderCreate(): TestResult = runTest {
    ...
    @Test
    fun shouldUseJweOptsBuilderCreate(): TestResult = runTest {
    ...
    @Test
    fun shouldUsePrepareJweArgsBuilderCreate(): TestResult = runTest {
    ...
    @Test
    fun shouldUseCreateJweCompactArgsBuilderCreate(): TestResult = runTest {
    ...
    @Test
    fun shouldUseCreateJweJsonArgsBuilderCreate(): TestResult = runTest {
    ...
    @Test
    fun shouldUseCreateJweJsonGeneralArgsBuilderCreate(): TestResult = runTest {
    ...
    @Test
    fun shouldUseDecryptJweArgsBuilderCreate(): TestResult = runTest {
