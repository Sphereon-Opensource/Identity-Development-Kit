...
class JweCommandErrorPathsTest {
    ...
    val session = context.sessionContextManager.createOrGetFromId("jwe-error-test", principalType = com.sphereon.di.context.PrincipalType.USER)
    ...
    fun testDecryptJwe_NullJwe() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("JWE") || result.error.toString().contains("required"),
    ...
    fun testDecryptJwe_NullDecryptor() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("Decryptor") || result.error.toString().contains("required"),
    ...
    @Test
    fun testDecryptJwe_MissingAlgHeader() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("alg") || result.error.toString().contains("required"),
                "Error should mention alg header is required",
            )
        }

    @Test
    fun testDecryptJwe_MissingEncHeader() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("enc") || result.error.toString().contains("required"),
                "Error should mention enc header is required",
            )
        }

    @Test
    fun testDecryptJwe_UnsupportedContentEncryptionAlgorithm() =
        runTest {
            val header = JweHeader()
            header.alg = "RSA-OAEP"
            ...
            assertTrue(
                result.error.toString().contains("Unsupported") || result.error.toString().contains("INVALID"),
                "Error should mention unsupported algorithm",
            )
        }

    @Test
    fun testDecryptJwe_UnsupportedKeyEncryptionAlgorithm() =
        runTest {
            val header = JweHeader()
    ...
    @Test
    fun testDecryptEcdhEs_MissingEpkInHeader() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("epk") || result.error.toString().contains("ephemeral"),
                "Error should mention epk is required",
            )
        }

    @Test
    fun testDecryptEcdhEs_DecryptorKeyNotEC() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("EC") || result.error.toString().contains("RSA"),
                "Error should mention key type issue: ${result.error}",
            )
        }

    @Test
    fun testDecryptEcdhEs_CurveMismatch() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("curve") ||
                    result.error
                        .toString()
                        .lowercase()
                        .contains("mismatch"),
    ...
    @Test
    fun testEncryptAndDecryptCompactWithECDH_ES_A192KW() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptAndDecryptCompactWithECDH_ES_A256KW() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testDecryptDir_KeyNotSymmetric() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("symmetric") || result.error.toString().contains("oct") || result.error.toString().contains("RSA"),
                "Error should mention key type issue: ${result.error}",
            )
        }

    @Test
    fun testDecryptDir_KeyWrongSize() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("size") || result.error.toString().contains("16") || result.error.toString().contains("32"),
    ...
    fun testPrepareJwe_NullPlaintext() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("Plaintext") || result.error.toString().contains("required"),
    ...
    fun testPrepareJwe_NullRecipient() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("Recipient") || result.error.toString().contains("required"),
                "Error should mention recipient is required",
            )
        }

    @Test
    fun testPrepareJwe_UnsupportedContentEncryptionAlgorithm() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
            ...
            val failed =
                try {
                    ...
                    assertTrue(
                        e.message?.contains("Unsupported") == true || e.message?.contains("INVALID") == true,
    ...
    fun testCreateJweCompact_NullPreparedJwe() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("PreparedJwe") || result.error.toString().contains("required"),
                "Error should mention PreparedJwe is required",
            )
        }

    @Test
    fun testCreateJweCompact_MissingAlgInPreparedHeader() =
        runTest {
    ...
    @Test
    fun testCreateJweCompact_UnsupportedKeyEncryptionAlgorithm() =
        runTest {
    ...
    @Test
    fun testCreateJweCompact_EcdhEsWithRsaKey() =
        runTest {
            ...
            assertTrue(
                createResult.error.toString().contains("EC") || createResult.error.toString().contains("RSA"),
    ...
    @Test
    fun testDecryptJweJsonFlattened_NoHeader() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("header") || result.error.toString().contains("No"),
    ...
    @Test
    fun testDecryptJweJsonGeneral_NoRecipients() =
        runTest {
            ...
            assertTrue(
                result.error.toString().contains("recipient") || result.error.toString().contains("No"),
                "Error should mention no recipients: ${result.error}",
            )
        }

    @Test
    fun testDecryptJweJsonGeneral_NoHeader() =
        runTest {
    ...
    @Test
    fun testCreateJweJsonFlattened_Success() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testDecryptJweJsonFlattened_Success() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testCreateJweJsonFlattened_WithECDHES() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testCreateJweJsonGeneral_Success() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testDecryptJweJsonGeneral_Success() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testCreateJweJsonGeneral_MultiRecipient() =
        runTest {
    ...
    @Test
    fun testCreateJweJsonGeneral_WithECDHES() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithA128GCM() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithA192GCM() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithDirAlgorithm() =
        runTest {
    ...
    @Test
    fun testEncryptDecryptWithPureECDHES() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithDirA128GCM() =
        runTest {
    ...
    @Test
    fun testEncryptDecryptWithDirA192GCM() =
        runTest {
    ...
    @Test
    fun testPrepareJweWithHeaderOverrides() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testPrepareJweHeaderOverridesCannotOverrideAlgOrEnc() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithRSA_OAEP_256() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithECDH_ES_A128KW() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithP384Curve() =
        runTest {
    ...
    @Test
    fun testCreateJweJsonGeneral_MultiRecipientWithECDH() =
        runTest {
    ...
    @Test
    fun testDecryptJweJsonGeneral_WithWrongKey() =
        runTest {
    ...
    @Test
    fun testDecryptJweJsonFlattened_WithUnprotectedHeader() =
        runTest {
            // Create a valid JWE first
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testEncryptDecryptWithP521Curve() =
        runTest {
    ...
    @Test
    fun testDecryptJweJsonGeneral_WithKidMatching() =
        runTest {
    ...
    @Test
    fun testCreateJweJsonGeneral_WithCustomAAD() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testDecryptJweJsonGeneral_ECDHESWithPerRecipientEpk() =
        runTest {
    ...
    @Test
    fun testECDHES_WithApuApvParameters() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.ECDSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testDirectEncryption_WithWrongKeyType() =
        runTest {
    ...
    @Test
    fun testDirectEncryption_WithWrongKeySize() =
        runTest {
    ...
    @Test
    fun testDirectEncryption_A128GCM_Success() =
        runTest {
    ...
    @Test
    fun testPrepareJweDir_UnsupportedContentEncryptionAlgorithm() =
        runTest {
    ...
    @Test
    fun testCreateJweJsonFlattened_WithCompressionHeader() =
        runTest {
            val managedKeyPair = keyManagerService.generateKeyAsync(alg = SignatureAlgorithm.RSA_SHA256)
            val keyInfo = managedKeyPair.joseToManagedKeyInfo(KeyVisibility.PRIVATE)
    ...
    @Test
    fun testDecryptJweJsonGeneral_AllRecipientsFailDecryption() =
        runTest {
    ...
    @Test
    fun testCreateJweJsonGeneral_MultiRecipientSameAlgorithmRSA() =
        runTest {
