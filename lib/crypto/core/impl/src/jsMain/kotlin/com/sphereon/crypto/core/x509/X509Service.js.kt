...
@JsExport
interface X509VerifyVerifyPlatformCallbackJSPromises : X509VerifyService, IX509JSCallback, X509VerifyServiceUsingCallbacks<IX509JSCallback> {
    @JsExport.Ignore
    override suspend fun verifyCertificateChain(req: X509VerificationRequestType): X509VerificationResultType =  runRethrowing {
...
class X509VerifyServiceJSAdapterImpl() : X509VerifyVerifyPlatformCallbackJSPromises {
    ...
    override fun setTrustedCerts(trustedCerts: Array<String>?) = apply {
    ...
    override fun setPlatform(platform: IX509JSCallback): HasPlatformCallback<IX509JSCallback> = apply {
    ...
    override fun verifyCertificateChainUsingPlatformCallback(verifyContext: X509ValidationContext): Promise<X509VerificationResultType> {
        return platform().verifyCertificateChainUsingPlatformCallback(verifyContext)
    }
