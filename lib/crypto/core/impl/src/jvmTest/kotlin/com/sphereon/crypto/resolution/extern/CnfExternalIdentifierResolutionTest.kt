...
/**
 * Extension function to access CnfExternalIdentifierResolutionService from a session component.
 */
fun Any.asCnfExternalIdentifierResolutionServiceComponent(): CnfExternalIdentifierResolutionServiceImpl.Component =
    this as CnfExternalIdentifierResolutionServiceImpl.Component
...
class CnfExternalIdentifierResolutionTest {
    ...
    fun setUp() {
        ...
        cnfResolutionService = session.component.asCnfExternalIdentifierResolutionServiceComponent().cnfExternalIdentifierResolutionService
    }

    // =========== CNF Resolution Service Support Tests ===========

    @Test
    fun cnfResolutionServiceShouldSupportCnfMethod() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldNotSupportOtherMethods() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldSupportMapIdentifier() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldNotSupportStringIdentifier() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldSupportCnfOpts() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldNotSupportJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun cnfResolutionServiceShouldResolveFromJwk() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun cnfResolutionServiceShouldResolveFromJwkWithKid() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun cnfResolutionServiceShouldResolveP384KeyFromJwk() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldAttemptDidResolutionForDidKid() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldAttemptDidResolutionForSimpleDid() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldFailForEmptyCnf() = runTest {
    ...
    @Test
    fun cnfResolutionServiceShouldFailForNonDidKidWithoutJwkOrJku() = runTest {
    ...
    @Test
    fun cnfResolutionServiceAsSupportedOptsShouldSucceedForCnfOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun cnfResolutionServiceAsSupportedOptsShouldFailForNonCnfOpts() = runTest {
    ...
    @Test
    fun externalIdentifierCnfResultShouldBeResolved() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
