...
class X509VerifyServiceTest {
    ...
    fun x509CallbackShouldHandleDisabledVerification() {
        ...
        val testRequest = X509VerificationRequest(
            enabled = false,
        ...
        val context = X509ValidationContext(
            request = testRequest,
    ...
    fun x509VerificationRequestFromDtoShouldPreserveFields() {
        val original = X509VerificationRequest(
            enabled = true,
    ...
    @Test
    fun x509VerifyServiceImplVerifyCertificateChainShouldReturnResultWhenDisabledNoChainData() = runTest {
        val service = X509VerifyServiceImpl()
        service.disable()
    ...
    @Test
    fun x509VerifyServiceImplVerifyCertificateChainShouldReturnParsedDataWhenDisabledWithChainData() = runTest {
        val service = X509VerifyServiceImpl()
        service.disable()

        // Valid test certificate chain
        val validPemChain = arrayOf(
            """
-----BEGIN CERTIFICATE-----
