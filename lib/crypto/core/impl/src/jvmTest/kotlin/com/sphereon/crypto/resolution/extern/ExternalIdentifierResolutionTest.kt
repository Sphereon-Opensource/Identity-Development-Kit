...
/**
 * Extension function to access JwkExternalIdentifierResolutionService from a session component.
 */
fun Any.asJwkExternalIdentifierResolutionServiceComponent(): JwkExternalIdentifierResolutionServiceImpl.Component =
    this as JwkExternalIdentifierResolutionServiceImpl.Component
...
class ExternalIdentifierResolutionTest {
    ...
    val session = context.sessionContextManager.createOrGetFromId("external-id-test")
    ...
    fun setUp() {
        ...
        jwkResolutionService = session.component.asJwkExternalIdentifierResolutionServiceComponent().jwkExternalIdentifierResolutionService
    }

    // =========== JwkExternalIdentifierResolutionService Tests ===========

    @Test
    fun jwkResolutionServiceShouldResolveValidJwk() = runTest {
    ...
    @Test
    fun jwkResolutionServiceShouldSupportJwkMethod() = runTest {
    ...
    @Test
    fun jwkResolutionServiceShouldSupportJwkIdentifier() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun jwkResolutionServiceShouldReturnJwksArray() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun jwkResolutionServiceShouldPreserveIdentifierOpts() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun jwkResolutionServiceSupportsCheckWithOpts() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun jwkResolutionServiceShouldRejectUnsupportedOpts() = runTest {
    ...
    @Test
    fun jwkResolutionServiceAsSupportedOptsShouldSucceedForJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun jwkResolutionServiceAsSupportedOptsShouldFailForNonJwkOpts() = runTest {
    ...
    @Test
    fun jwkResolutionServiceShouldResolveP384Key() = runTest {
        val keyPair = keyManagerService.generateKey(
    ...
    @Test
    fun jwkResolutionServiceShouldResolveP521Key() = runTest {
        val keyPair = keyManagerService.generateKey(
    ...
    @Test
    fun jwkResolutionServiceShouldSupportIsSupportedOpts() = runTest {
        val keyPair = keyManagerService.generateKey(
            alg = SignatureAlgorithm.ECDSA_SHA256
        )
        val keyInfo = keyPair.joseToManagedKeyInfo(KeyVisibility.PUBLIC)
    ...
    @Test
    fun jwkResolutionServiceShouldResolveJwkWithX5cOpts() = runTest {
    ...
    @Test
    fun jwkResolutionServiceSupportsShouldHandleGenericOptsWithJwkMethod() = runTest {
    ...
    @Test
    fun jwkResolutionServiceSupportsWithContextDelegatesToContextFreeSupports() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
        val jwkOpts = ExternalIdentifierJwkOpts(identifier = jwk)
        val impl = jwkResolutionService as JwkExternalIdentifierResolutionServiceImpl
    ...
    @Test
    fun jwkResolutionServiceSupportsWithContextCannotBypassUnsupportedArgs() = runTest {
        val impl = jwkResolutionService as JwkExternalIdentifierResolutionServiceImpl
    ...
    @Test
    fun jwkResolutionServiceSupportsShouldReturnFalseForNonJwkIdentifier() = runTest {
