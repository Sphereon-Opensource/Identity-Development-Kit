...
/**
 * Extension to access KeyStoreManager from app component.
 */
fun Any.asKeyStoreManagerComponent(): KeyStoreManagerImpl.Component = this as KeyStoreManagerImpl.Component
...
class KeyStoreManagerTest {
    ...
    fun setUp() {
        ...
        keyStoreManager = (app as KeyStoreManagerImpl.Component).keyStoreManager
    }

    // =========== createFromKeyStoreConfig Tests ===========

    @Test
    fun createFromKeyStoreConfigShouldCreateMemoryKeyStore() = runTest {
        ...
        val keyStore = keyStoreManager.createFromKeyStoreConfig(config, session.asCoreApiServiceComponent().serviceExecution)
    ...
    @Test
    fun createFromKeyStoreConfigWithoutExecutionShouldWork() = runTest {
        val config = MemoryKeyStoreConfig(
    ...
    fun createFromKeyStoreConfigShouldThrowForUnknownType() {
        val invalidConfig = KeyStoreConfigImpl(
            id = "invalid-keystore",
    ...
    @Test
    fun memoryKeyStoreShouldSupportKeyOperations() = runTest {
        val config = MemoryKeyStoreConfig(
    ...
    @Test
    fun memoryKeyStoreWithAppScopeShouldWork() = runTest {
        val config = MemoryKeyStoreConfig(
    ...
    @Test
    fun memoryKeyStoreWithTenantScopeShouldWork() = runTest {
        val config = MemoryKeyStoreConfig(
    ...
    @Test
    fun memoryKeyStoreWithPrincipalTenantScopeShouldWork() = runTest {
        val config = MemoryKeyStoreConfig(
    ...
    @Test
    fun memoryKeyStorePublicVisibilityShouldWork() = runTest {
        val config = MemoryKeyStoreConfig(
