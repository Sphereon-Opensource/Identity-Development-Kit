...
class JweMockedErrorPathsTest {
    ...
    @Test
    fun testPrepareJwe_IdentifierResolutionFails() = runTest {
        ...
        val command = PrepareJweCommandImpl(
    ...
    fun testCreateJweJsonGeneral_NullPreparedJwe() = runTest {
        ...
        val command = CreateJweJsonGeneralCommandImpl(
            execution = mockExecution,
    ...
    @Test
    fun testCreateJweJsonGeneral_NullPlaintext() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_NullCek() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_NullRecipient() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_NullAlgHeader() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_NullEncHeader() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_UnsupportedContentEncAlg() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_IdentifierResolutionFails() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testCreateJweJsonGeneral_UnsupportedKeyEncAlg() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
        ...
        val resolvedRecipient = ManagedIdentifierJwkResult(
        ...
        val mockResult = IdkResult.ok<ManagedIdentifierResult<KeyType>, IdkErrorType>(
    ...
    @Test
    fun testCreateJweJsonGeneral_ECDHWithNonECKey() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    fun testCreateJweCompact_NullPreparedJwe() = runTest {
        ...
        val command = CreateJweCompactCommandImpl(
            execution = mockExecution,
            keyManagerService = mockKeyManagerService
        )
    ...
    fun testCreateJweJsonFlattened_NullPreparedJwe() = runTest {
        ...
        val command = CreateJweJsonFlattenedCommandImpl(
            execution = mockExecution,
            keyManagerService = mockKeyManagerService
        )
    ...
    fun testDecryptJwe_NullJwe() = runTest {
        ...
        val command = DecryptJweCommandImpl(
            execution = mockExecution,
            identifierService = mockIdentifierService,
            keyManagerService = mockKeyManagerService
        )
    ...
    @Test
    fun testDecryptJwe_IdentifierResolutionFails() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
    ...
    @Test
    fun testDecryptJwe_UnsupportedAlgorithm() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        val mockKeyManagerService = mockk<KeyManagerService>()
        val mockIdentifierService = mockk<MultiManagedIdentifierService>()
        ...
        // Create a concrete result instance instead of mocking abstract class
        val resolvedDecryptor = ManagedIdentifierJwkResult(
            context = IdentifierContext(),
            keyInfo = managedKeyInfo,
            identifier = rsaJwk
        )
