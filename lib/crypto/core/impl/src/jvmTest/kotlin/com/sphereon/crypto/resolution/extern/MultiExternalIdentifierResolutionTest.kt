 ...
 */
fun Any.asMultiExternalServiceComponent(): MultiExternalIdentifierResolutionServiceImpl.Component =
...
class MultiExternalIdentifierResolutionTest {
    ...
    fun setUp() {
        ...
        multiExternalService = session.component.asMultiExternalServiceComponent().multiExternalIdentifierService
    }

    // =========== Method Support Tests ===========

    @Test
    fun multiExternalServiceShouldSupportJwkMethod() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldSupportX5cMethod() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldSupportJwksUrlMethod() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldHaveMultipleSupportedMethods() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldSupportJwkIdentifier() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldSupportHttpsUrlIdentifier() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldSupportJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun multiExternalServiceShouldSupportX5cOpts() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldSupportJwksUrlOpts() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldResolveJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun multiExternalServiceShouldFailForUnsupportedOpts() = runTest {
    ...
    @Test
    fun multiExternalServiceShouldResolveJwkWithDifferentCurves() = runTest {
    ...
    @Test
    fun multiExternalServiceAsSupportedOptsShouldSucceedForJwkOpts() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun multiExternalServiceAsSupportedOptsShouldSucceedForX5cOpts() = runTest {
    ...
    @Test
    fun multiExternalServiceAsSupportedOptsShouldSucceedForJwksUrlOpts() = runTest {
        val opts = ExternalIdentifierJwksUrlOpts(identifier = "https://example.com/jwks")
        val result = multiExternalService.asSupportedOpts(opts)
    ...
    @Test
    fun multiExternalServiceShouldDelegateToCorrectService() = runTest {
        val keyPair = keyManagerService.generateKey(alg = SignatureAlgorithm.ECDSA_SHA256)
        val jwk = keyPair.jose.publicJwk!!
    ...
    @Test
    fun multiExternalServiceShouldIncludeAllDelegatedMethods() = runTest {
        val methods = multiExternalService.supportedIdentifierMethods
