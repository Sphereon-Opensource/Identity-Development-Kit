...
class MultiIdentifierResolutionMockedTest {
    ...
    @Test
    fun testSupportsWithIdentifierMethod() = runTest {
        ...
        val service = MultiIdentifierResolutionServiceImpl(
    ...
    @Test
    fun testSupportsWithRawIdentifier() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testSupportsWithRawIdentifierReturnsFalseWhenNoServiceSupports() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testSupportsWithContextDelegatesToContextFreeSupports() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedIdentifierReturnsTrueViaManagedMulti() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedIdentifierReturnsTrueViaExternalMulti() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedIdentifierReturnsFalseWhenBothReturnFalse() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedOptsWithExternalIdentifierOptsOrResult() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedOptsWithManagedIdentifierOptsOrResult() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testAsSupportedOptsWithExternalIdentifierOptsOrResult() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testAsSupportedOptsWithManagedIdentifierOptsOrResult() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testResolveWithExternalIdentifierOptsOrResult() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testResolveWithManagedIdentifierOptsOrResult() = runTest {
        val mockExecution = mockk<SessionExecution>(relaxed = true)
        every { mockExecution.sessionContext } returns mockSessionContext
