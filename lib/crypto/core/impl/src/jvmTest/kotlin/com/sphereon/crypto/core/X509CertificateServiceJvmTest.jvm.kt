...
private val testPemChain = arrayOf(
    """
-----BEGIN CERTIFICATE-----
...
class X509CertificateServiceJvmTest {
    ...
    val session = context.sessionContextManager.createOrGetFromId("test").component
...
//    @OptIn(ExperimentalStdlibApi::class)
    ...
    fun shouldValidateCert(): TestResult {
        ...
        return runTest {
            ...
            val x509 = (session as CryptoServicesImpl.Component).cryptoServices.x509
