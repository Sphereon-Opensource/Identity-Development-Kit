...
class MultiExternalIdentifierMockedTest {
    ...
    @Test
    fun testResolveWithSpecifiedMethod() =
        runTest {
            val mockExecution = mockk<SessionExecution>(relaxed = true)
            every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedIdentifierReturnsTrueWhenAtLeastOneServiceSupports() =
        runTest {
            val mockExecution = mockk<SessionExecution>(relaxed = true)
            every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedIdentifierReturnsFalseWhenNoServiceSupports() =
        runTest {
            val mockExecution = mockk<SessionExecution>(relaxed = true)
            every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testIsSupportedIdentifierWithEmptyExternalServices() =
        runTest {
            val mockExecution = mockk<SessionExecution>(relaxed = true)
            every { mockExecution.sessionContext } returns mockSessionContext
    ...
    @Test
    fun testResolveWithMatchingServiceNullMethod() =
        runTest {
            val mockExecution = mockk<SessionExecution>(relaxed = true)
            every { mockExecution.sessionContext } returns mockSessionContext
            ...
            coEvery { mockExternalService.resolve(any()) } returns
