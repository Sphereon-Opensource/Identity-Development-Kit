...
/**
 * Extension function to access X5cExternalIdentifierResolutionService from a session component.
 */
fun Any.asX5cExternalIdentifierResolutionServiceComponent(): X5cExternalIdentifierResolutionServiceImpl.Component =
    this as X5cExternalIdentifierResolutionServiceImpl.Component

/**
 * Extension function to access MultiExternalIdentifierService from a session component.
 */
fun Any.asMultiExternalIdentifierServiceComponent(): MultiExternalIdentifierResolutionServiceImpl.Component =
    this as MultiExternalIdentifierResolutionServiceImpl.Component
...
class X5cExternalIdentifierResolutionTest {
    ...
    fun setUp() = runTest {
        ...
        x5cResolutionService = session.component.asX5cExternalIdentifierResolutionServiceComponent().x5cExternalIdentifierResolutionService
        multiResolutionService = session.component.asMultiExternalIdentifierServiceComponent().multiExternalIdentifierService
    ...
    @Test
    fun x5cResolutionServiceShouldSupportX5cMethod() = runTest {
    ...
    @Test
    fun x5cResolutionServiceShouldSupportX5cIdentifier() = runTest {
    ...
    @Test
    fun x5cResolutionServiceShouldSupportX5cOpts() = runTest {
    ...
    @Test
    fun x5cResolutionServiceAsSupportedOptsShouldSucceedForX5cOpts() = runTest {
        val x5cOpts = ExternalIdentifierX5cOpts(identifier = listOf(testCertificateBase64))
    ...
    @Test
    fun x5cResolutionServiceAsSupportedOptsShouldFailForNonX5cOpts() = runTest {
    ...
    @Test
    fun x5cResolutionServiceShouldResolveValidCertificateChain() = runTest {
        val x5cOpts = ExternalIdentifierX5cOpts(identifier = listOf(testCertificateBase64))
    ...
    @Test
    fun x5cResolutionServiceShouldPreserveIdentifierOpts() = runTest {
        val x5cOpts = ExternalIdentifierX5cOpts(identifier = listOf(testCertificateBase64))
        val result = x5cResolutionService.resolve(x5cOpts)
    ...
    @Test
    fun multiResolutionServiceShouldSupportMultipleMethods() = runTest {
    ...
    @Test
    fun multiResolutionServiceShouldSupportMultipleIdentifiers() = runTest {
    ...
    @Test
    fun multiResolutionServiceShouldResolveX5cOpts() = runTest {
        val x5cOpts = ExternalIdentifierX5cOpts(identifier = listOf(testCertificateBase64))
    ...
    @Test
    fun multiResolutionServiceShouldResolveJwkOpts() = runTest {
    ...
    @Test
    fun multiResolutionServiceShouldReturnErrorForUnsupportedOpts() = runTest {
