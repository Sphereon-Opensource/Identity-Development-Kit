...
object EcdhUtils {
    ...
    data class EphemeralKeyPair(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (publicKeyJwk != other.publicKeyJwk) return false
    ...
    suspend fun generateEphemeralKeyPair(curve: Curve): EphemeralKeyPair {
        ...
        val publicKeyJwk = convertDerECKeyBytesToJwk(
    ...
    suspend fun performKeyAgreement(
        ...
        val ecdhPrivateKey = ecdh.privateKeyDecoder(kmpCurve)
        ...
        val ecdhPublicKey = ecdh.publicKeyDecoder(kmpCurve)
     ...
     */
    fun getCurveFromJwk(jwk: JwkType): Curve {
        return jwk.crv?.let { Curve.fromJose(it) } ?: Curve.P_256
    }
     ...
     */
    fun isEcdhEsAlgorithm(algorithm: String): Boolean {
        return KeyAgreementAlgorithm.fromIdentifier(algorithm) != null
    }
}
