...
@JsExportCompat
data class KeyUsage(
    val flags: Map<KeyUsageFlag, Boolean>,
) : Map<KeyUsageFlag, Boolean> by flags {
    ...
    companion object {
        ...
        fun fromDerBitString(raw: ByteArray): KeyUsage {
            ...
            return KeyUsage(
                KeyUsageFlag.entries.associateWith { flag ->
