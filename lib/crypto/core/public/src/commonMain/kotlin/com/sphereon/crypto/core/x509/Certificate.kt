...
data class Certificate(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (!der.contentEquals(other.der)) {
            return false
        }
        ...
        if (issuerDN != other.issuerDN) {
            return false
        }
        if (subjectDN != other.subjectDN) {
            return false
        }
        if (notBefore != other.notBefore) {
            return false
        }
        if (notAfter != other.notAfter) {
            return false
        }
        if (keyUsage != other.keyUsage) {
            return false
        }
        if (subjectAlternativeNames != other.subjectAlternativeNames) {
            return false
        }
    ...
    override fun toString(): String =
        "Certificate(fingerPrint='$fingerPrint', serialNumber=$serialNumber, issuerDN='$issuerDN', subjectDN='$subjectDN', notBefore=${notBefore.instantToDateStringISO()}, notAfter=${notAfter.instantToDateStringISO()}, keyUsage=$keyUsage, san=$subjectAlternativeNames)"
