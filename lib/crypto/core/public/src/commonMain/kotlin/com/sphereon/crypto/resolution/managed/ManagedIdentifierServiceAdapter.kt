...
abstract class ManagedIdentifierServiceAdapter<ResultType : ManagedIdentifierResult<KeyType>>(
    ...
    Command<ManagedIdentifierOptsOrResult, ResultType, IdkErrorType>, ManagedIdentifierService {
    ...
    override suspend fun asSupportedOpts(opts: ManagedIdentifierOptsOrResult): IdkResult<ManagedIdentifierOpts, IdkErrorType> {
        return if (isSupportedOpts(opts)) (opts as ManagedIdentifierOpts).asOkResult() else IdkError.Companion.COMMAND_ARG_NOT_SUPPORTED_ERROR().asErrorResult()
    }
