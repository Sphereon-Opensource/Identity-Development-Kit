 ...
 * @property digestAlg The hash algorithm used by the algorithm, if applicable.
...
enum class CoseAlgorithm(
     ...
     * @param explanation A brief description of the algorithm ("ECDSA w/ SHA-256").
     ...
     * @property explanation Brief description of the algorithm, which is "ECDSA secp256k1 curve w/ SHA-256".
     ...
     * @property explanation A textual description of the algorithm ("ECDSA w/ SHA-384").
     ...
     */
    EdDSA("EdDSA", value = -8, keyType = CoseKeyTypeEnum.OKP, digestAlg = null, tagLength = null, curve = CoseCurve.Ed25519, explanation = "EdDSA", type = AlgorithmType.SIGNATURE),

    /**
     * The RS256 class represents the RSASSA-PKCS1-v1_5 signature algorithm with SHA-256.
     *
     * @property algorithmName The name of the algorithm, which is "RS256".
     * @property algorithmId The COSE algorithm identifier for RS256, which is -257.
     * @property keyType The type of key used by the algorithm, which is RSA.
     * @property hashAlgorithm The hash algorithm used, which is SHA-256.
     * @property keySize The size of the key used in this algorithm in bits (256 bits).
     * @property curve Not applicable for RSA algorithms, hence null.
     * @property algorithmDescription A brief description of the algorithm.
     * @property algorithmType The type of algorithm, which is SIGNATURE.
     */
    RS256(
        "RS256",
        -257,
    ...
    /**
     * The RS384 class represents the RSASSA-PKCS1-v1_5 signature algorithm with SHA-384.
     *
     * @property algorithmName The name of the algorithm, which is "RS384".
     * @property algorithmId The COSE algorithm identifier for RS384, which is -258.
     * @property keyType The type of key used by the algorithm, which is RSA.
     * @property hashAlgorithm The hash algorithm used, which is SHA-384.
     * @property keySize The size of the key used in this algorithm in bits (384 bits).
     * @property curve Not applicable for RSA algorithms, hence null.
     * @property algorithmDescription A brief description of the algorithm.
     * @property algorithmType The type of algorithm, which is SIGNATURE.
     */
    ...
    /**
     * The RS512 class represents the RSASSA-PKCS1-v1_5 signature algorithm with SHA-512.
     *
     * @property algorithmName The name of the algorithm, which is "RS512".
     * @property algorithmId The COSE algorithm identifier for RS512, which is -259.
     * @property keyType The type of key used by the algorithm, which is RSA.
     ...
     * @property digestAlg The hash algorithm used, which is SHA-256.
     ...
     * @property explanation A brief description of the algorithm ("HMAC w/ SHA-256").
     * @property algorithmType The type of the algorithm, which is a signature algorithm.
     */
    HS256("HS256", value = 5, keyType = CoseKeyTypeEnum.Symmetric, digestAlg = DigestAlg.SHA256, tagLength = 256, curve = null, explanation = "HMAC w/ SHA-256", type = AlgorithmType.SIGNATURE),
     ...
     * @property explanation A brief description of the algorithm, which is "HMAC w/ SHA-384".
     * @property algorithmType The category of the algorithm, which is `AlgorithmType.SIGNATURE`.
     */
    HS384("HS384", value = 6, keyType = CoseKeyTypeEnum.Symmetric, digestAlg = DigestAlg.SHA384, tagLength = 384, curve = null, explanation = "HMAC w/ SHA-384", type = AlgorithmType.SIGNATURE),
     ...
     * @property explanation A textual description of the algorithm.
     * @property algorithmType The category of the algorithm (e.g., signature, encryption).
     */
    HS512("HS512", value = 7, keyType = CoseKeyTypeEnum.Symmetric, digestAlg = DigestAlg.SHA512, tagLength = 512, curve = null, explanation = "HMAC w/ SHA-512", type = AlgorithmType.SIGNATURE),
     ...
     * @property explanation A textual description of the algorithm stating "RSASSA-PSS w/ SHA-384".
     ...
     * @property explanation A human-readable description of the algorithm.
     ...
     * @param explanation A description of the algorithm.
     ...
     * @property digestAlg The hash algorithm associated with this encryption algorithm, if any.
     ...
     * @property explanation The description of the algorithm.
     ...
     * @property digestAlg The hash algorithm used, which is null for this algorithm.
     * @property tagLength The length of the tag in bits, here it is 192 bits.
     * @property curve The elliptic curve used, which is null for this algorithm.
     * @property explanation A brief textual description of the algorithm, namely "AES-GCM mode w/ 192-bit key, 128-bit tag".
     ...
     * @property digestAlg The hash algorithm associated with this encryption algorithm. This is `null` for this algorithm.
     ...
     * @param digestAlg The hash algorithm associated with the algorithm, if any.
     * @param tagLength The length of the tag, if applicable.
     * @param curve The elliptic curve used by the algorithm, if applicable.
     * @param explanation A textual description of the algorithm.
     ...
     * @property digestAlg The hash algorithm used, if any (null in this case).
     ...
     * @property digestAlg The hash algorithm used (if any), which is null for this algorithm.
     ...
     * @property digestAlg The hash algorithm associated with this encryption, null as not applicable.
     ...
     * @property digestAlg Indicates the hash function used, which is SHA-256 for this algorithm.
     ...
     * @property explanation A textual description of the algorithm: "HMAC w/ SHA-256 truncated to 64 bits".
     ...
     * @param digestAlg The hash algorithm used, in this case SHA-256.
     ...
     * @property digestAlg The hash algorithm used, which is SHA-384.
     ...
     * @property explanation A brief description of the algorithm, stating it as HMAC with SHA-384.
     ...
     * @property digestAlg The hash algorithm used (SHA512).
     ...
     * @property explanation A brief description of the algorithm ("HMAC w/ SHA-512").
     ...
     */
    override fun toString(): String = "CoseAlgorithm(id='$id', value=$value, keyType=$keyType, hash=$digestAlg, tagLength=$tagLength, curve=$curve, description='$explanation', type=$type)"
    ...
    companion object {
        ...
        ): CoseAlgorithm? = entries.find { entry -> entry.value == value && (type === null || type === entry.type) }
...
internal object CoseAlgSerializer : KSerializer<CoseAlgorithm> {
    ...
    override fun deserialize(decoder: Decoder): CoseAlgorithm {
        ...
        return CoseAlgorithm.fromValue(value) ?: throw IllegalArgumentException("Invalid cose algorithm")
    }
}
