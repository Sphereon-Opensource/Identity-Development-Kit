...
interface KeyManagerService : SimpleSignatureService, EncryptionService, PublicKeyResolver, ManagedKeyStoreService, HasKeyStoreService, KmsProviderRegistry, KeyResolverRegistry {
     ...
     * @deprecated Use top-level [KeyManagerServiceComponent] instead for KSP compatibility
     */

    interface KmsComponent : KeyManagerServiceComponent
}
...
interface KeyManagerServiceComponent {
    val keyManagerService: KeyManagerService
}

/**
 * Extension function to get the KeyManagerServiceComponent from a SessionComponent.
 * Use this instead of casting to `KeyManagerService.KmsComponent`.
 */
fun SessionComponent.asKeyManagerServiceComponent(): KeyManagerServiceComponent = this as KeyManagerServiceComponent
