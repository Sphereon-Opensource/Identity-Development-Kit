...
class JweOptsBuilder {
     ...
     * Builds the options.
     */
    fun build(): CreateJweOpts = CreateJweOpts(
        compress = compress,
...
class CreateJweCompactArgsBuilder {
     ...
     */
    fun build(): CreateJweCompactArgs = CreateJweCompactArgs(
        preparedJwe = preparedJwe,
        aad = aad
    )
...
class CreateJweJsonArgsBuilder {
     ...
     */
    fun build(): CreateJweJsonArgs = CreateJweJsonArgs(
        preparedJwe = preparedJwe,
        aad = aad
    )
...
class CreateJweJsonGeneralArgsBuilder {
     ...
     */
    fun build(): CreateJweJsonGeneralArgs = CreateJweJsonGeneralArgs(
        preparedJwe = preparedJwe,
...
class DecryptJweArgsBuilder {
     ...
     */
    fun build(): DecryptJweArgs = DecryptJweArgs(
        jwe = jwe,
        decryptor = decryptor
    )
 ...
 * ```
 */
fun jweHeader(builder: JweHeaderBuilder.() -> Unit): JweHeader {
    return JweHeaderBuilder().apply(builder).build()
}
 ...
 * ```
 */
fun jweOptions(builder: JweOptsBuilder.() -> Unit): CreateJweOpts {
    return JweOptsBuilder().apply(builder).build()
}
 ...
 * ```
 */
fun prepareJweArgs(builder: PrepareJweArgsBuilder.() -> Unit): PrepareJweArgs {
    return PrepareJweArgsBuilder().apply(builder).build()
}
 ...
 * ```
 */
fun createJweCompactArgs(builder: CreateJweCompactArgsBuilder.() -> Unit): CreateJweCompactArgs {
    return CreateJweCompactArgsBuilder().apply(builder).build()
}
 ...
 * ```
 */
fun createJweJsonArgs(builder: CreateJweJsonArgsBuilder.() -> Unit): CreateJweJsonArgs {
    return CreateJweJsonArgsBuilder().apply(builder).build()
}
 ...
 * ```
 */
fun createJweJsonGeneralArgs(builder: CreateJweJsonGeneralArgsBuilder.() -> Unit): CreateJweJsonGeneralArgs {
    return CreateJweJsonGeneralArgsBuilder().apply(builder).build()
}
 ...
 * ```
 */
fun decryptJweArgs(builder: DecryptJweArgsBuilder.() -> Unit): DecryptJweArgs {
    return DecryptJweArgsBuilder().apply(builder).build()
}
