...
open class SignatureLevel(val value: String, val form: SignatureForm) {
...
object SignatureLevelSerializer : KSerializer<SignatureLevel> {
    ...
    override fun serialize(encoder: Encoder, value: SignatureLevel) = encoder.encodeString(value.value)
    ...
    private fun inferForm(value: String): SignatureForm = when {
