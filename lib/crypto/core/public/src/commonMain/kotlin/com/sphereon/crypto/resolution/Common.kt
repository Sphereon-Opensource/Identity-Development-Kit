...
object IdentifierTypeUtils {
    ...
    fun isJwkIdentifier(identifier: Any): Boolean {
        return identifier is JwkDTOType && identifier.kty.isNotEmpty()
    }
    ...
    fun isKeyIdentifier(identifier: Any): Boolean {
        return identifier is KeyDTOType
    }

    fun isCoseKeyIdentifier(identifier: Any): Boolean {
        return identifier is CoseKeyDTOType
    }

    fun isOIDFEntityIdIdentifier(identifier: Any): Boolean {
        return identifier is String && identifier.startsWith("https://")
    }

    fun isX5cIdentifier(identifier: Any): Boolean {
        return identifier is Collection<*> && identifier.isNotEmpty() && identifier.all { it is String }
    }
}