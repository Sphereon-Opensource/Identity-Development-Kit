...
data class KeyStoreLoaderOpts(
    ...
    sealed class Source {
         ...
         */
        data class File(val path: String, val autoCreate: Boolean = true) : Source()

        /**
         * Load keystore data from an in-memory byte array.
         * @param data the raw keystore bytes
         */
        data class Bytes(var data: ByteArray) : Source() {
         ...
         */
        data class Channel(val channel: ByteChannel) : Source()
    }
}
