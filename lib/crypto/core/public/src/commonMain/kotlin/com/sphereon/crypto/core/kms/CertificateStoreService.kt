...
interface CertificateStoreService {
    ...
    suspend fun storeCertificateChain(alias: String, certificates: Array<Certificate>, keyInfo: ResolvedKeyInfoType<*>? = null)
    ...
    suspend fun storeTrustedCertificate(alias: String, certificate: Certificate)
