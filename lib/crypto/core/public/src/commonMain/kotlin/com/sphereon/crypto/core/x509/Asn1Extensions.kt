...
fun isAccessMethodOid(element: Asn1Element, validOids: List<String>): Boolean =
    (element as? Asn1Primitive)?.oidString() in validOids

fun extractUriFromTaggedObject(element: Asn1Element): String? =
    (element as? Asn1Primitive)?.content
        ?.decodeToString()
