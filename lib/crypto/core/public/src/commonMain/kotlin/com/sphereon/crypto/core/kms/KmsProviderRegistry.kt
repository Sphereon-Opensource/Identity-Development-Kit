...
interface KmsProviderRegistry {
     ...
     */
    fun getProvider(providerId: String? = null, alg: SignatureAlgorithm? = null): KmsProvider
     ...
     */
    fun registerProvider(provider: KmsProvider, makeDefaultKms: Boolean? = false)
}
...
interface KmsProviderRegistryComponent {
