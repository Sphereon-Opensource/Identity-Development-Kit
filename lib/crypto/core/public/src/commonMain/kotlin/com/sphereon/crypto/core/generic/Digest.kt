...
enum class DigestAlg(
     ...
     *
     * @param internalName Internal name representation of the algorithm. (NIST standard)
     ...
     *
     * @param internalName Internal identifier for the algorithm. (NIST standard)
    ...
    fun toCryptoGraphicAlgorithm(): CryptographyAlgorithmId<dev.whyoleg.cryptography.algorithms.Digest> =
        if (this == SHA256) {
            ...
            dev.whyoleg.cryptography.algorithms.SHA384
        } else if (this == SHA512) {
            dev.whyoleg.cryptography.algorithms.SHA512
        } else {
            throw IllegalArgumentException("$internalName is not yet supported")
        }
