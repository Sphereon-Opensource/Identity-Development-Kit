...
DigestResponse
    ...
    constructor(
         ...
         */
        fun toCompleteSignatureRequest(signatureValue: ByteArray) =
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (other !is DigestResponse) {
                return false
            }
            if (!digestToSign.contentEquals(other.digestToSign)) {
                return false
            }
            if (!signatureDocumentBytes.contentEquals(other.signatureDocumentBytes)) {
                return false
            }
            ...
            if (signingDate != other.signingDate) {
                return false
            }
