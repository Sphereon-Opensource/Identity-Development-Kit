...
data class GenerateKeyArgs(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (keyOperations != null) {
            if (other.keyOperations == null) return false
            if (!keyOperations.contentEquals(other.keyOperations)) return false
        } else if (other.keyOperations != null) return false
 ...
 */
interface GenerateKeyCommand :
    ServiceCommand<GenerateKeyArgs, GenerateKeyResult> {
 ...
 *
 * @property keys Array of managed key info objects
 */
@OptIn(ExperimentalObjCName::class)
...
data class ListKeysResult(
    @kotlinx.serialization.Transient
    val keys: Array<ManagedKeyInfoType<*>> = emptyArray()
) {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || this::class != other::class) return false
 ...
 * providing uniform logging, auditing, authorization, and plugin capabilities.
 */
interface ListKeysCommand :
    ServiceCommand<ListKeysArgs, ListKeysResult> {
 ...
 * providing uniform logging, auditing, authorization, and plugin capabilities.
 */
interface GetKeyCommand :
    ServiceCommand<GetKeyArgs, GetKeyResult> {
...
data class StoreKeyArgs(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (alias != other.alias) return false
        if (certChain != null) {
            if (other.certChain == null) return false
            if (!certChain.contentEquals(other.certChain)) return false
        } else if (other.certChain != null) return false
 ...
 * providing uniform logging, auditing, authorization, and plugin capabilities.
 */
interface StoreKeyCommand :
    ServiceCommand<StoreKeyArgs, StoreKeyResult> {
 ...
 * providing uniform logging, auditing, authorization, and plugin capabilities.
 */
interface DeleteKeyCommand :
    ServiceCommand<DeleteKeyArgs, DeleteKeyResult> {
