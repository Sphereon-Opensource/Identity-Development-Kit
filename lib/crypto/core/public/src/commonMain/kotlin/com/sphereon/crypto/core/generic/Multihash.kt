...
enum class MultihashAlgorithm(
    ...
    SHA2_256(0x12, DigestAlg.SHA256, 32),
    SHA2_384(0x20, DigestAlg.SHA384, 48),
    SHA2_512(0x13, DigestAlg.SHA512, 64),
    SHA3_256(0x16, DigestAlg.SHA3_256, 32),
    SHA3_384(0x15, DigestAlg.SHA3_384, 48),
    SHA3_512(0x14, DigestAlg.SHA3_512, 64);
...
object MultihashCodec {
     ...
     */
    fun encode(digest: ByteArray, algorithm: MultihashAlgorithm): ByteArray {
    ...
    fun decode(multihash: ByteArray): Pair<MultihashAlgorithm, ByteArray> {
        ...
        val algorithm = MultihashAlgorithm.fromCode(code)
            ?: throw IllegalArgumentException("Unknown multihash function code: 0x${code.toString(16)}")
     ...
     */
    fun fromPlainHex(hashHex: String, algorithm: MultihashAlgorithm): ByteArray {
