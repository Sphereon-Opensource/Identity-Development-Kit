...
abstract class RestProviderTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): RestProviderTestAppComponent
    }
}

fun createRestProviderTestAppComponent(
    application: Any,
    appId: String = "rest-kms-app",
    profile: String = "profile",
    version: String = "version-example",
): RestProviderTestAppComponent {
    val component = createGraphFactory<RestProviderTestAppComponent.Factory>().create(
