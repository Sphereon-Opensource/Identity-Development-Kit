...
abstract class RestProviderTestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): RestProviderTestAppGraph
    }
}

fun createRestProviderTestAppGraph(
    application: Any,
    appId: String = "rest-kms-app",
    profile: String = "profile",
    version: String = "version-example",
): RestProviderTestAppGraph {
    val graph =
        createGraphFactory<RestProviderTestAppGraph.Factory>().create(
