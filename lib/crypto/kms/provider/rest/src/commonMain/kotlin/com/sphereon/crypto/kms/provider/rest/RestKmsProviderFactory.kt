...
class RestClientKmsProviderFactoryImpl(
    ...
    override fun create(config: KmsProviderConfigBase, execution: SessionExecution): RestClientKmsProviderImpl = realFactory.create(config, execution)
...
interface RestClientKmsProviderFactory : KmsProviderFactory {
    override fun create(config: KmsProviderConfigBase, execution: SessionExecution): RestClientKmsProvider
}
