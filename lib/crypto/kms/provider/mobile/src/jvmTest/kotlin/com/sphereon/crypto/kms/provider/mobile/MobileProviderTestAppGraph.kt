...
abstract class MobileProviderTestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): MobileProviderTestAppGraph
    }
}

fun createMobileProviderTestAppGraph(
    application: Any,
    ...
    val graph =
        createGraphFactory<MobileProviderTestAppGraph.Factory>().create(
