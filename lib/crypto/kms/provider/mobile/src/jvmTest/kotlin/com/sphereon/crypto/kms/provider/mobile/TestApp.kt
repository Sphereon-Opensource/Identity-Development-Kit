...
abstract class MobileProviderTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): MobileProviderTestAppComponent
    }
}

fun createMobileProviderTestAppComponent(
    application: Any,
    appId: String = "software-kms-app",
    profile: String = "profile",
    version: String = "version-example",
): MobileProviderTestAppComponent {
    val component = createGraphFactory<MobileProviderTestAppComponent.Factory>().create(
