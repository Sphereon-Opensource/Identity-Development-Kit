...
class MobileKmsProviderFactoryImpl(
    val realFactory: MobileKmsProviderImplFactory,
) : MobileKmsProviderFactory {
    override val kmsProviderType: String = PredefinedKmsProviderTypes.MOBILE.kmsProviderType

    override fun create(
        config: KmsProviderConfigBase,
        execution: SessionExecution,
    ): MobileKmsProviderImpl = realFactory.create(config, execution)
