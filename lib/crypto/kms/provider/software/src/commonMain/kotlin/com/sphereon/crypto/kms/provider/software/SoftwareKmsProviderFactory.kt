...
interface RealKmsProviderFactory {
    fun create(
        providerConfig: KmsProviderConfigBase,
        execution: SessionExecution,
        keyStoreManager: KeyStoreManager? = null,
    ): SoftwareKmsProviderImpl
}
...
class SoftwareKmsProviderFactoryImpl(
    ...
    override fun create(
        ...
        execution: SessionExecution,
    ): SoftwareKmsProviderImpl = kmsProviderFactory.create(providerConfig = config, execution = execution, keyStoreManager = keyStoreManager)
