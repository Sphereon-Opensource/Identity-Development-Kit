 ...
 * On iOS: Uses native keychain generation (SecKeyGeneratePair)
 * On other platforms: Returns null to use software library generation
 */
internal expect suspend fun generateKeyPairNative(
    alias: String,
