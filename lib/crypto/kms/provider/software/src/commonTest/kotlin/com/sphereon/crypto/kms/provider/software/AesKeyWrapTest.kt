...
class AesKeyWrapTest {
    ...
    @Test
    fun testA128KW_WrapUnwrap_16ByteKey() = runTest {
        ...
        val wrapped = softwareKMSProvider.wrapKey(
        ...
        val unwrapped = softwareKMSProvider.unwrapKey(
    ...
    @Test
    fun testA192KW_WrapUnwrap_24ByteKey() = runTest {
    ...
    @Test
    fun testA256KW_WrapUnwrap_32ByteKey() = runTest {
    ...
    @Test
    fun testA256KW_WrapUnwrap_VariousSizes() = runTest {
        val kek = CryptographyRandom.nextBytes(32)
        val kekInfo = createSymmetricKeyInfo(kek)
    ...
    @Test
    fun testRfc3394_TestVector_128BitKek_128BitData() = runTest {
    ...
    @Test
    fun testRfc3394_TestVector_192BitKek_128BitData() = runTest {
    ...
    @Test
    fun testRfc3394_TestVector_256BitKek_128BitData() = runTest {
    ...
    @Test
    fun testRfc3394_TestVector_256BitKek_256BitData() = runTest {
        val kek = hexToBytes("000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F")
    ...
    @Test
    fun testWrap_InvalidKekSize_TooSmall() = runTest {
    ...
    @Test
    fun testWrap_InvalidKekSize_WrongAlgorithm() = runTest {
        val kek = CryptographyRandom.nextBytes(16)
        val kekInfo = createSymmetricKeyInfo(kek)
        val keyToWrap = CryptographyRandom.nextBytes(16)
    ...
    @Test
    fun testWrap_KeyTooSmall() = runTest {
        val kek = CryptographyRandom.nextBytes(16)
        val kekInfo = createSymmetricKeyInfo(kek)
    ...
    @Test
    fun testWrap_KeyNotMultipleOf8() = runTest {
        val kek = CryptographyRandom.nextBytes(16)
        val kekInfo = createSymmetricKeyInfo(kek)
    ...
    @Test
    fun testUnwrap_IntegrityCheckFails_WrongKey() = runTest {
    ...
    @Test
    fun testUnwrap_IntegrityCheckFails_CorruptedData() = runTest {
        val kek = CryptographyRandom.nextBytes(16)
        val kekInfo = createSymmetricKeyInfo(kek)
        val keyToWrap = CryptographyRandom.nextBytes(16)
    ...
    @Test
    fun testUnwrap_WrappedKeyTooSmall() = runTest {
        val kek = CryptographyRandom.nextBytes(16)
        val kekInfo = createSymmetricKeyInfo(kek)
