...
class SoftwareKmsEncryptionTest {
    ...
    private suspend fun storeSymmetricKey(
        alias: String,
        alg: JwaAlgorithm,
        keySize: Int = 32,
    ) {
     ...
     */
    @Test
    fun testEncryptDecryptByAliasOnly() =
        runTest {
     ...
     */
    @Test
    fun testEncryptDecryptCombinedFormat() =
        runTest {
     ...
     */
    @Test
    fun testFullReconciliationCryptoFlow() =
        runTest {
