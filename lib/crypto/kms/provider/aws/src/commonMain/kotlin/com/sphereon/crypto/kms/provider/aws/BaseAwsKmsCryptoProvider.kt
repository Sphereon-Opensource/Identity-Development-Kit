...
abstract class BaseAwsKmsCryptoProvider(
    ...
    ): ManagedKeyPair = throw UnsupportedOperationException("AWS KMS key generation requires a platform-specific implementation")

    override suspend fun createRawSignature(
        keyInfo: KeyInfoType<*>,
        input: ByteArray,
        requireX5Chain: Boolean,
    ): ByteArray = throw UnsupportedOperationException("AWS KMS raw signature creation requires a platform-specific implementation")

    override suspend fun isValidRawSignature(
        keyInfo: KeyInfoType<*>,
        input: ByteArray,
        signature: ByteArray,
    ): Boolean = throw UnsupportedOperationException("AWS KMS raw signature verification requires a platform-specific implementation")

    override suspend fun createSignature(
        signInput: SignInput,
        keyInfo: KeyInfoType<*>?,
        signatureAlgorithm: SignatureAlgorithm?,
    ): SignOutput = throw UnsupportedOperationException("AWS KMS signature creation requires a platform-specific implementation")

    override suspend fun isValidSignature(
        signInput: SignInput,
        signature: Signature,
    ): Boolean = throw UnsupportedOperationException("AWS KMS signature verification requires a platform-specific implementation")
    ...
    ): EncryptionResult = throw UnsupportedOperationException("AWS KMS encryption requires a platform-specific implementation")
    ...
    override suspend fun decrypt(
        ...
        authTag: ByteArray,
        additionalAuthenticatedData: ByteArray?,
    ): ByteArray = throw UnsupportedOperationException("AWS KMS decryption requires a platform-specific implementation")

    override suspend fun wrapKey(
        wrappingKeyInfo: KeyInfoType<*>,
        keyToWrap: ByteArray,
        algorithm: KeyWrapAlgorithm,
    ): ByteArray = throw UnsupportedOperationException("AWS KMS key wrapping requires a platform-specific implementation")

    override suspend fun unwrapKey(
        unwrappingKeyInfo: KeyInfoType<*>,
        wrappedKey: ByteArray,
        algorithm: KeyWrapAlgorithm,
    ): ByteArray = throw UnsupportedOperationException("AWS KMS key unwrapping requires a platform-specific implementation")
    ...
    override suspend fun performKeyAgreement(
        ...
        keyDataLen: Int?,
    ): ByteArray = throw UnsupportedOperationException("Key agreement not supported by AWS KMS provider")
}
