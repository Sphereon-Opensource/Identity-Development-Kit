...
//    settings: KeyProviderSettings
    ...
    override suspend fun generateKeyAsync(
        ...
        if (certificateOptions != null) {
            throw IllegalArgumentException("Certificate options are not yet supported by Azure Key Vault")
        }
        ...
        val keyVaultKey = when (signatureAlgorithm.cryptoAlgorithm) {
            CryptoAlg.RSA -> {
                ...
                try {
                    ...
                    throw SignClientException("Failed to create RSA key in Azure Key Vault: ${e.message}")
                }
            }
            else -> {
                // Create EC key (ECDSA)
                ...
                try {
                    ...
                    throw SignClientException("Failed to create EC key in Azure Key Vault: ${e.message}")
                }
            }
        }
    ...
    override suspend fun createRawSignature(
        ...
        return try {
            ...
            throw SignClientException("Failed to create signature: ${e.message}")
        }
    }
    ...
    private suspend fun createRawSignatureFromDigest(
        ...
        return try {
            ...
            throw SignClientException("Failed to create signature from digest: ${e.message}")
        }
    }
    ...
    override suspend fun isValidRawSignature(
        ...
        return try {
            ...
            throw SignClientException("Failed to verify signature: ${e.message}", e)
        }
    }
    ...
    suspend fun fetchKeyAsync(keyRef: String): ManagedKeyInfoType<Jwk> {
        return try {
            ...
            throw SignClientException("Failed to fetch key '$keyRef': ${e.message}")
        }
    }
    ...
    private suspend fun isValidDigestSignature(
        ...
        return try {
            ...
            throw SignClientException("Failed to verify digest signature: ${e.message}", e)
        }
    }
    ...
    override suspend fun listKeys(): Array<ManagedKeyInfoType<*>> {
        try {
            ...
            return coroutineScope {
                ...
                deferredKeys.awaitAll().toTypedArray()
            }
        } catch (e: Exception) {
            throw SignClientException("Failed to list keys: ${e.message}")
        }
    }
    ...
    override suspend fun getKey(keyInfo: KeyInfoType<*>): ManagedKeyInfoType<*> {
        ...
        return try {
            ...
            throw SignClientException("Failed to get key: ${e.message}")
        }
    }
    ...
    override suspend fun storeKey(keyInfo: ResolvedKeyInfoType<*>, providerId: String, alias: String, certChain: Array<Certificate>?): ManagedKeyInfoType<*> {
        try {
            ...
            throw SignClientException("Failed to import key: ${e.message}")
        }
    }
    ...
    override suspend fun deleteKey(keyInfo: KeyInfoType<*>): Boolean {
        if (keyInfo.alias === null) {
            throw IllegalArgumentException("Key reference is required for deletion")
        }
    ...
    override suspend fun encrypt(
        ...
        return try {
            ...
            throw SignClientException("Failed to encrypt data: ${e.message}")
        }
    }
    ...
    override suspend fun decrypt(
        ...
        return try {
            ...
            throw SignClientException("Failed to decrypt data: ${e.message}")
        }
    }
    ...
    override suspend fun wrapKey(
        ...
        return try {
            ...
            throw SignClientException("Failed to wrap key: ${e.message}")
        }
    }
    ...
    override suspend fun unwrapKey(
        ...
        if (unwrappingKeyInfo.alias === null) {
            throw IllegalArgumentException("Key reference is required")
        }
        ...
        return try {
            ...
            throw SignClientException("Failed to unwrap key: ${e.message}")
        }
    }
