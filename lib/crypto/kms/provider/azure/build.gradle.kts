...
buildkonfig {
    ...
    defaultConfigs {
        buildConfigField(
            FieldSpec.Type.STRING, "AZURE_KEYVAULT_URL",
            System.getenv("AZURE_KEYVAULT_URL"), nullable = true
        )
        buildConfigField(
            FieldSpec.Type.STRING, "AZURE_KEYVAULT_TENANT_ID",
            System.getenv("AZURE_KEYVAULT_TENANT_ID"), nullable = true
        )
        buildConfigField(
            FieldSpec.Type.STRING, "AZURE_KEYVAULT_CLIENT_ID",
            System.getenv("AZURE_KEYVAULT_CLIENT_ID"), nullable = true
        )
        buildConfigField(
            FieldSpec.Type.STRING, "AZURE_KEYVAULT_CLIENT_SECRET",
