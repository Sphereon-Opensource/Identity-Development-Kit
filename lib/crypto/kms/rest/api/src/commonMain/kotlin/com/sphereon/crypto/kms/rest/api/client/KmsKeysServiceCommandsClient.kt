...
class GetKeyServiceCommandClient(
...
) : KmsKeysTransportCommandClient(transport), GetKeyServiceCommand {
    ...
    override suspend fun execute(args: GetKeyInput): IdkResult<GetKeyResponse, IdkError> {
        return invokeCommand(commandId = commandId, input = args, outputTypeToken = outputTypeToken)
    }
}
...
class ListKeysServiceCommandClient(
    transport: SessionBoundKmsCommandTransport
) : KmsKeysTransportCommandClient(transport), ListKeysServiceCommand {
    ...
    override suspend fun execute(args: ListKeysInput): IdkResult<ListKeysResponse, IdkError> {
        return invokeCommand(commandId = commandId, input = args, outputTypeToken = outputTypeToken)
    }
}
...
class StoreKeyServiceCommandClient(
    transport: SessionBoundKmsCommandTransport
) : KmsKeysTransportCommandClient(transport), StoreKeyServiceCommand {
    ...
    override suspend fun execute(args: StoreKeyInput): IdkResult<StoreKeyResponse, IdkError> {
        return invokeCommand(commandId = commandId, input = args, outputTypeToken = outputTypeToken)
    }
}
...
class GenerateKeyServiceCommandClient(
    transport: SessionBoundKmsCommandTransport
) : KmsKeysTransportCommandClient(transport), GenerateKeyServiceCommand {
    ...
    override suspend fun execute(args: GenerateKeyInput): IdkResult<GenerateKeyResponse, IdkError> {
        return invokeCommand(commandId = commandId, input = args, outputTypeToken = outputTypeToken)
    }
}
...
class DeleteKeyServiceCommandClient(
    transport: SessionBoundKmsCommandTransport
) : KmsKeysTransportCommandClient(transport), DeleteKeyServiceCommand {
    ...
    override suspend fun execute(args: DeleteKeyInput): IdkResult<DeleteKeyOutput, IdkError> {
        return invokeCommand(commandId = commandId, input = args, outputTypeToken = outputTypeToken)
    }
}
