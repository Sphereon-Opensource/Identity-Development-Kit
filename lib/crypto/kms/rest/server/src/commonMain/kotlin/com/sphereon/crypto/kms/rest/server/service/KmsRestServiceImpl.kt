...
class KmsRestServiceImpl(
    ...
    override suspend fun getKey(
        ...
        return runCatching {
            ...
            when (exception) {
                ...
                is NotFoundException -> throw NotFoundException(resource = aliasOrKid)
                else -> throw exception
            }
        }
    }

    override suspend fun listKeys(providerId: String?): Array<ManagedKeyInfoType<*>> {
        if (providerId != null) {
    ...
    override suspend fun deleteKey(aliasOrKid: String, providerId: String?): Boolean {
