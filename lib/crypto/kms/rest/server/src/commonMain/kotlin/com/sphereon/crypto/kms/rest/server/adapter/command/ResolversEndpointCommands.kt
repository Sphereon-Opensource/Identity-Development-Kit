...
class GetResolverEndpointCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        val resolverId = req.pathParams["resolverId"]
            ?: return Ok(errorResponse(400, "Missing path parameter: resolverId"))
