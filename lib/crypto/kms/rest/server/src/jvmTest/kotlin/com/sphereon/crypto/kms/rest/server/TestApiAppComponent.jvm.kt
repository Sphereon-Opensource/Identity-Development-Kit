...
abstract class TestApiAppComponent : AbstractAppComponent() {
...
fun createTestApiAppComponent(
    application: Any,
    appId: String = application.javaClass.name ?: "<unknown>",
    profile: String = "profile",
    version: String = "1.0.0",
): TestApiAppComponent {
    val component = createGraphFactory<TestApiAppComponent.Factory>().create(
