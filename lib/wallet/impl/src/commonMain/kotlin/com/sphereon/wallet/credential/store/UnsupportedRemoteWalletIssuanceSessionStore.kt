...
/**
 * Remote issuance-session delegate installed by the base wallet graph.
 * Vault modules replace this binding.
 */
@Inject
    ...
    private fun <T> unsupported(): IdkResult<T, IdkError> =
        Err(
            IdkError.UNSUPPORTED_OPERATION_ERROR(
                operation = "wallet.issuance.remote",
                reason = "No vault-backed RemoteWalletIssuanceSessionStore is installed",
            ),
        )
}
