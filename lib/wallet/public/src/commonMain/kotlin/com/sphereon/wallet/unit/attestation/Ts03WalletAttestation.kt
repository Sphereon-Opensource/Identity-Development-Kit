...
data class Ts03WalletAttestationValidationPolicy(
    val profile: Ts03WalletAttestationValidationProfile = Ts03WalletAttestationValidationProfile.LOCAL_TEST,
    ...
    companion object {
        fun localTest(): Ts03WalletAttestationValidationPolicy = Ts03WalletAttestationValidationPolicy()
...
class SoftwareTestWalletAttestationSigner(
    ...
    override suspend fun sign(request: WalletAttestationSigningRequest,): com.sphereon.core.api.IdkResult<WalletAttestationSigningResult, com.sphereon.core.api.error.IdkError> {
        ...
        return com.sphereon.core.api.Ok(
            WalletAttestationSigningResult(
                ...
                signerId = signerId,
                keyId = request.keyId,
                evidence = mapOf("signerProfile" to "software-test", "production" to "false"),
            ),
        )
    }
}
...
class Ts03WalletAttestationValidator(
    ...
    private suspend fun validateCommonJwt(
        ...
        if (policy.profile != Ts03WalletAttestationValidationProfile.WALLET_PROVIDER_TRUST_LIST && policy.profile != Ts03WalletAttestationValidationProfile.LOCAL_TEST) {
