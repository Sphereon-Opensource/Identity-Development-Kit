...
private data class ProtectedCredentialBodyEnvelope(
    val version: Int = 1,
    val protection: String = "wscd-a256gcm",
...
class SoftwareWscdWalletCredentialBodyProtector(
    ...
    override suspend fun open(
        ...
        if (envelope.version != 1 || envelope.protection != SUPPORTED_PROTECTION) {
            return Err(
    ...
    private suspend fun resolveOrCreateBodyKey(walletUnitId: String): IdkResult<KeyInfo<Nothing>, IdkError> {
        val alias = bodyKeyAlias(walletUnitId)
    ...
    private fun bodyKeyAlias(walletUnitId: String): String = "wallet-units/$walletUnitId/credential-body/a256gcm"

    private companion object {
        const val SUPPORTED_PROTECTION = "wscd-a256gcm"
    }
}
