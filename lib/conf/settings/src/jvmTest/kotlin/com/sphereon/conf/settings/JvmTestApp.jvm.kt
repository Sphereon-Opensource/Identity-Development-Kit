...
abstract class JvmMPSettingsAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JvmMPSettingsAppComponent
    }
}

fun createJvmMPSettingsAppComponent(
    application: Any,
    appId: String = application.javaClass.name ?: "<unknown>",
    profile: String = "mp-settings-profile",
    version: String = "version-example",
): JvmMPSettingsAppComponent {
    val component = createGraphFactory<JvmMPSettingsAppComponent.Factory>().create(
