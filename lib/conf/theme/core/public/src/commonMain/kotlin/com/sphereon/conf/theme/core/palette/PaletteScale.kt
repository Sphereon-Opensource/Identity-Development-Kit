...
data class PaletteScale(
     ...
     */
    operator fun get(stop: Int): String = when (stop) {
        50 -> s50
        100 -> s100
        200 -> s200
        300 -> s300
    ...
    companion object {
        val STOPS = listOf(50, 100, 200, 300, 400, 500, 600, 700, 800, 900)
         ...
         */
        fun fromTonalPalette(palette: TonalPalette): PaletteScale = PaletteScale(
            s50 = palette.tone(95),
            s100 = palette.tone(90),
            s200 = palette.tone(80),
            s300 = palette.tone(70),
            s400 = palette.tone(60),
            s500 = palette.tone(50),
            s600 = palette.tone(40),
            s700 = palette.tone(30),
            s800 = palette.tone(20),
            s900 = palette.tone(10),
        )
    }
}
...
data class DesignSystemPalette(
     ...
     */
    fun getScale(role: String): PaletteScale? = when (role) {
        "brand" -> brand
        "secondary" -> secondary
        "neutral" -> neutral
        "error" -> error
    ...
    val definedRoles: List<String>
        get() = buildList {
            ...
            if (neutral != null) add("neutral")
            if (error != null) add("error")
            if (success != null) add("success")
            if (warning != null) add("warning")
