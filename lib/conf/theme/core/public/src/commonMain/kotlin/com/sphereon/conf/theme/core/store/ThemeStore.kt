...
interface ThemeStore {
    ...
    suspend fun getDefinition(tenant: String, themeId: String): ThemeDefinition?

    suspend fun listDefinitions(tenant: String, scope: ThemeScope? = null): List<ThemeDefinition>

    suspend fun saveDefinition(tenant: String, definition: ThemeDefinition): ThemeDefinition

    suspend fun deleteDefinition(tenant: String, themeId: String): Boolean
     ...
     */
    suspend fun countDefinitions(tenant: String): Int =
        listDefinitions(tenant).size
