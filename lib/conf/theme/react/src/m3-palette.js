...
function tonalPaletteTone(hue, chroma, tone) {
    if (tone <= 0)
        return '#000000';
    if (tone >= 100)
        return '#FFFFFF';
...
export function toneAt(palette, tone) {
    return tonalPaletteTone(palette.hue, palette.chroma, tone);
}
function generateTonalPaletteWithParams(hue, chroma) {
    return {
 ...
 */
export function generateM3Palette(seedHex) {
 ...
 */
export function paletteToTokens(palette, variant) {
...
//# sourceMappingURL=m3-palette.js.map