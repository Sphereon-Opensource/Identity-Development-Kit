...
class LocalDateTimeKMP(
    ...
    private val delegate = LocalDateTime(
        year = year,
        month = month,
        day = day,
        hour = hour,
    ...
    override fun compareTo(other: LocalDateTimeKMP): Int {
        return fromString(this.toString()).compareTo(fromString(other.toString()))
    }
    ...
    fun toEpochSeconds(timeZoneId: String? = TimeZone.UTC.id): Long {
        return delegate.toInstant(DateTimeUtils.DEFAULTS.timeZone(timeZoneId)).epochSeconds
    }

    fun toInstant(utils: DateTimeUtils = DateTimeUtils.DEFAULTS, timeZoneId: String? = null) = delegate.toInstant(utils.timeZone(timeZoneId))
    ...
    companion object {
        ...
        @JsStatic
        fun nowWithTimezone(utils: DateTimeUtils = DateTimeUtils.DEFAULTS, timeZoneId: String? = null) = utils.dateTime(timeZoneId)
