...
class DefaultIdentityResolutionPipelineTest {
    ...
    private fun createPipeline(): DefaultIdentityResolutionPipeline {
        val tenantResolvers = setOf(
            OidcTenantResolver(),
            StaticTenantResolver(),
            EmailDomainTenantResolver()
        )
        val principalResolvers = setOf(
    ...
    @Test
    fun headerFallbackWhenTokenHasNoTenantClaim() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
    ...
    @Test
    fun principalTypeUserFromToken() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                tokenClaims = mapOf(
    ...
    @Test
    fun principalTypeWorkloadFromClientCredentials() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                tokenClaims = mapOf(
    ...
    @Test
    fun principalTypeAnonymousWhenNoData() = runTest {
        val pipeline = createPipeline()
    ...
    @Test
    fun metadataCapturesHeaderValues() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
    ...
    @Test
    fun issuerAndAudienceExtractedFromToken() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                tokenClaims = mapOf(
    ...
    @Test
    fun principalFromHeaderWhenNoToken() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                headers = mapOf(
    ...
    @Test
    fun resolvedFromIsTokenWhenTokenResolves() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
    ...
    @Test
    fun resolvedFromIsHeaderWhenOnlyHeaderPresent() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                headers = mapOf("X-Tenant-Id" to "header-tenant")
    ...
    @Test
    fun resolvedFromIsHostWhenOnlyHostPresent() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
    ...
    @Test
    fun resolvedFromIsPathWhenOnlyPathPresent() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                pathPrefix = "acme"
    ...
    @Test
    fun hostTakesPrecedenceOverPath() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
    ...
    @Test
    fun tokenTakesPrecedenceOverHost() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                tokenClaims = mapOf("tenant_id" to JsonPrimitive("token-tenant"), "sub" to JsonPrimitive("user-1")),
    ...
    @Test
    fun headerTakesPrecedenceOverHost() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(
            IdentityResolutionInput(
                headers = mapOf("X-Tenant-Id" to "header-tenant"),
    ...
    @Test
    fun allSourcesMissingReturnsAnonymous() = runTest {
        val pipeline = createPipeline()
        val result = pipeline.resolve(IdentityResolutionInput())
        assertNull(result.tenantId)
        assertNull(result.principalId)
