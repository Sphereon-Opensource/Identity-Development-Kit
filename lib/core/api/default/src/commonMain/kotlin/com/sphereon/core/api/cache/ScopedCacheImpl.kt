...
class ScopedCacheImpl<K : Any, V : Any>(
    ...
    override suspend fun getTenant(
        tenantId: String,
        key: K,
    ): V? = get(ScopedKey.tenant(namespace, tenantId, key))

    override suspend fun putTenant(
        tenantId: String,
        key: K,
        value: V,
        ttl: Duration?,
    ...
    override suspend fun removeTenant(
        tenantId: String,
        key: K,
    ): Boolean = remove(ScopedKey.tenant(namespace, tenantId, key))

    override suspend fun containsTenant(
        tenantId: String,
        key: K,
    ): Boolean = contains(ScopedKey.tenant(namespace, tenantId, key))
    ...
    override suspend fun getPrincipal(
        ...
        principalId: String,
        key: K,
    ): V? = get(ScopedKey.principal(namespace, tenantId, principalId, key))

    override suspend fun putPrincipal(
        tenantId: String,
        principalId: String,
        key: K,
        value: V,
    ...
    override suspend fun removePrincipal(
        ...
        principalId: String,
        key: K,
    ): Boolean = remove(ScopedKey.principal(namespace, tenantId, principalId, key))

    override suspend fun containsPrincipal(
        tenantId: String,
        principalId: String,
        key: K,
    ): Boolean = contains(ScopedKey.principal(namespace, tenantId, principalId, key))
