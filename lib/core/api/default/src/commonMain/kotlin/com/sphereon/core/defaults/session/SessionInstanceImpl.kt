...
class SessionInstanceImpl(
    ...
    override fun isCurrentlyActive(): Boolean = sessionContextManager.getActive().sessionId == sessionId

    override fun makeActive(): Boolean = sessionContextManager.activateById(sessionId)
    ...
    override fun <T : Any> getService(id: String): T {
        val service: T =
            scope.children().find { it.name == id }?.getService(id)
