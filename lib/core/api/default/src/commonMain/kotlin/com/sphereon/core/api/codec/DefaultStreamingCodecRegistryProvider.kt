...
interface DefaultStreamingCodecRegistryComponent {
    ...
    @Provides
    @SingleIn(AppScope::class)
    fun provideMediaTypeNegotiator(
        codecRegistry: StreamingCodecRegistry
    ): MediaTypeNegotiator = DefaultMediaTypeNegotiator(codecRegistry)
}
