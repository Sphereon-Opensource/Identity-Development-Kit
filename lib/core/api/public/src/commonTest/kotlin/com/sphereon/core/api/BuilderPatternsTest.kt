...
class IdkBuilderTest {
    ...
    private class TestBuilder(private val value: String = "test", private val errors: List<String> = emptyList()) : IdkBuilder<String> {
...
class ApplyConfigTest {
    ...
    data class ConfigObject(var value: String = "")
...
class ApplyConfigIfTest {
    ...
    data class ConfigObject(var value: String = "default")
