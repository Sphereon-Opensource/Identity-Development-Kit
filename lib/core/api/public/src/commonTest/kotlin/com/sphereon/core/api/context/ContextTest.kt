...
class ContextConfigImplTest {
    ...
    private class TestAppConfigService : AppConfigService {
        ...
        override fun <T : Any> getProperty(key: String, targetType: KClass<T>, defaultValue: T?): T? = defaultValue
        override fun getPropertyAsString(key: String, defaultValue: String?): String? = defaultValue
        override fun <T : Any> getRequiredProperty(key: String, targetType: KClass<T>, defaultValue: T?): T =
            defaultValue ?: throw IllegalStateException("No value for $key")
    ...
    private class TestTenantConfigService(override val parent: AppConfigService) : TenantConfigService {
    ...
    private class TestPrincipalConfigService(override val parent: TenantConfigService) : PrincipalConfigService {
...
class SessionExecutionTest {
    ...
    private object TestUserContext : com.sphereon.di.context.UserContext {
        ...
        override val tenant: com.sphereon.di.context.TenantContextData = object : com.sphereon.di.context.TenantContextData {
    ...
    fun isAnonymousReturnsFalseForNonAnonymousSession() {
        val sessionContext = TestSessionContext(
    ...
    fun isAnonymousReturnsTrueForAnonymousSession() {
        ...
        val anonymousSession = com.sphereon.di.context.createAnonymousSessionContext("<anonymous>")
...
class CoreApiContextExtensionComponentTest {

    // Test implementation that implements both interfaces to test asSureComponent()
    private class TestCoreApiContextComponent : CoreApiContextExtensionComponent, com.sphereon.di.context.UserContextComponent {
        // CoreApiContextExtensionComponent properties
        override val _sessionContextManager: com.sphereon.di.session.SessionContextManager
            get() = throw NotImplementedError("Not needed for this test")
        override val logManager: com.sphereon.core.api.log.UserContextLogManager
            get() = throw NotImplementedError("Not needed for this test")
        override val conf: ContextConfig
            get() = throw NotImplementedError("Not needed for this test")
        override val serviceExecutor: com.sphereon.core.api.session.ISessionCommandExecutor
            get() = throw NotImplementedError("Not needed for this test")

        // UserContextComponent properties
        override val sessionContextManager: com.sphereon.di.session.SessionContextManager
            get() = throw NotImplementedError("Not needed for this test")
    ...
    @Test
    fun asSureComponentReturnsSelfAsUserContextComponent() {
        val component = TestCoreApiContextComponent()

        val result = component.asSureComponent()

        // Should return the same instance cast to UserContextComponent
...
class CoreApiContextExtensionFunctionsTest {
    ...
    private class TestUserContextComponent : com.sphereon.di.context.UserContextComponent, CoreApiContextExtensionComponent {
        // CoreApiContextExtensionComponent properties
        override val _sessionContextManager: com.sphereon.di.session.SessionContextManager
            get() = throw NotImplementedError("Not needed for this test")
        override val logManager: com.sphereon.core.api.log.UserContextLogManager
    ...
    private class TestUserContextInstance(
        override val component: com.sphereon.di.context.UserContextComponent
        ...
        override fun addService(id: String, service: Any): software.amazon.app.platform.scope.Scope = throw NotImplementedError("Not needed for this test")
        override fun isCurrentlyActive(): Boolean = false
        override fun makeActive(): Boolean = false
        override fun destroy() {}
        override fun createSession(sessionId: String, makeActive: Boolean): com.sphereon.di.session.SessionInstance = throw NotImplementedError("Not needed for this test")
    ...
    @Test
    fun userContextComponentAsCoreApiContextComponentReturnsSelf() {
        val component = TestUserContextComponent()

        val result = component.asCoreApiContextComponent()

        assertSame(component, result)
    }

    @Test
    fun userContextInstanceAsCoreApiContextComponentReturnsComponentCast() {
        val component = TestUserContextComponent()
        val instance = TestUserContextInstance(component)

        val result = instance.asCoreApiContextComponent()
