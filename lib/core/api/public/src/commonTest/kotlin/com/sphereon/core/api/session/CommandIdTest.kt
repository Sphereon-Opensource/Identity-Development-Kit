...
class CommandIdValidationTest {
    ...
    fun commandIdWithSingleSegmentIsRejected() {
        ...
        assertTrue(result.error.message.defaultMessage.contains("Invalid command ID format"))
    }
...
class CommandIdPartsTest {

    @Test
    fun parseCommandIdReturnsNullForInvalidId() {
        // Given invalid command ID strings
        // When parsing
    ...
    @Test
    fun parseCommandIdReturnsPartsForThreeSegmentId() {
        // Given a valid 3-segment command ID
    ...
    @Test
    fun parseCommandIdReturnsPartsForVariousIds() {
    ...
    @Test
    fun parseCommandIdResultReturnsOkForValidId() {
        // Given a valid command ID
    ...
    @Test
    fun parseCommandIdResultReturnsErrForFourSegmentId() {
    ...
    @Test
    fun commandIdPartsToCommandIdStringReconstructs() {
        // Given CommandIdParts
        val parts = CommandIdParts("kms", "keys", "get")
    ...
    fun commandIdPartsToCommandIdCreatesValidCommandId() {
        // Given CommandIdParts
        val parts = CommandIdParts("did", "manager", "resolve")
    ...
    @Test
    fun commandIdPartsFieldsAreAccessible() {
        // Given CommandIdParts
        val parts = CommandIdParts("identity", "identities", "read")

        // Then all fields are accessible
        assertEquals("identity", parts.module)
        assertEquals("identities", parts.service)
        assertEquals("read", parts.command)
    }
}
