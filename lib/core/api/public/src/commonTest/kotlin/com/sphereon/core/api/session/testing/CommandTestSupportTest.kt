...
class CommandTestSupportTest {
    ...
    @Test
    fun testAuthorizerIsNotNull() {
        assertNotNull(CommandTestSupport.testAuthorizer)
    }

    @Test
    fun testExecuteWorksWithMockCommand() = runTest {
        val command = mockCommand<String, Int>("test.support.string.length") { args ->
            Ok(args.length)
        }
    ...
    @Test
    fun testSupportsWorksWithMockCommand() = runTest {
        val command = mockCommand<String, Int>(
    ...
    @Test
    fun testSupportsUsesContextFreePrimaryPath() = runTest {
        val command = mockCommand<String, String>(
    ...
    @Test
    fun testSupportsWithContextUsesStrictContextFreeForwardingByDefault() = runTest {
...
class MockCommandTest {
    ...
    @Test
    fun mockCommandExecutesSuccessfully() = runTest {
        val command = mockCommand<String, Int>("test.mock.string.length") { args ->
            Ok(args.length)
        }
    ...
    @Test
    fun mockCommandReturnsError() = runTest {
        val command = mockCommand<String, Int>("test.mock.string.parse") { args ->
            args.toIntOrNull()
                ?.let { Ok(it) }
    ...
    @Test
    fun mockCommandWithCustomSupports() = runTest {
        val command = mockCommand<String, String>(
    ...
    @Test
    fun mockCommandSupportsWithContextCanBridgeLegacyContextSensitivePredicate() = runTest {
        val command = mockCommand<String, String>(
    ...
    @Test
    fun mockCommandLegacyBridgeUsesUtilityOwnedContext() = runTest {
        val seenArgs = mutableListOf<Any>()
        val command = mockCommand<String, String>(
...
class SucceedingCommandTest {
    ...
    @Test
    fun succeedingCommandAlwaysReturnsOk() = runTest {
...
class FailingCommandTest {
    ...
    @Test
    fun failingCommandAlwaysReturnsErr() = runTest {
    ...
    @Test
    fun failingCommandUsesDefaultError() = runTest {
...
class TypedMockCommandTest {
    ...
    @Test
    fun typedMockCommandSupportsCorrectType() = runTest {
        val command = typedMockCommand<String, Int>("test.typed.string.length") { args ->
            Ok(args.length)
        }
    ...
    @Test
    fun typedMockCommandExecutes() = runTest {
        val command = typedMockCommand<String, Int> { args ->
            Ok(args.length)
        }
...
class ExpectOkTest {
    ...
    fun expectOkReturnsErrForFailure() {
        ...
        assertTrue(converted.error.message.defaultMessage.contains("Expected Ok"))
    }
    ...
    fun expectOkUsesCustomMessage() {
        ...
        assertTrue(converted.isErr)
        assertTrue(converted.error.message.defaultMessage.contains("Should have succeeded"))
    }
}
...
class ExpectErrTest {
    ...
    fun expectErrReturnsErrForSuccess() {
        ...
        val converted = original.expectErr()
        assertTrue(converted.isErr)
        assertTrue(converted.error.message.defaultMessage.contains("Expected Err"))
    }
    ...
    fun expectErrUsesCustomMessage() {
        ...
        assertTrue(converted.isErr)
        assertTrue(converted.error.message.defaultMessage.contains("Should have failed"))
    }
}
