...
class StreamingBodyByteStreamTest {
    ...
    @Test
    fun collectSingleChunk() = runTest {
    ...
    @Test
    fun collectMultipleChunks() = runTest {
    ...
    @Test
    fun collectToTextMultipleChunks() = runTest {
        val flow = flowOf(
    ...
    @Test
    fun toGenericHttpBodySuspendCollectsStream() = runTest {
        val data = byteArrayOf(1, 2, 3, 4, 5)
        val flow = flowOf(data)
        val body = StreamingBody.ByteStream(flow)
    ...
    @Test
    fun toGenericHttpBodySuspendHandlesEmptyStream() = runTest {
        val flow = emptyFlow<ByteArray>()
        val body = StreamingBody.ByteStream(flow)
    ...
    @Test
    fun toGenericHttpBodySuspendWorksForOtherTypes() = runTest {
