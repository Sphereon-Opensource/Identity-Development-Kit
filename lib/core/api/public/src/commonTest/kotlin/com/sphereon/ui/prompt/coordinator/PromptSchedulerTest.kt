...
class PromptSchedulerTest {
    ...
    private val testPresenter = object : PromptPresenter {
        ...
        override fun onForeground() { _foregroundState.value = ForegroundState.FOREGROUND }
        override fun onBackground() { _foregroundState.value = ForegroundState.BACKGROUND }
        override fun shouldDeferPrompt(request: PromptRequest): Boolean = false
    }

    @Test
    fun scheduleReturnsImmediateWhenNotDeferred() = runTest {
    ...
    @Test
    fun scheduleReturnsDeferredWhenShouldDefer() = runTest {
        val deferringPresenter = object : PromptPresenter {
            private val _foregroundState = MutableStateFlow(ForegroundState.FOREGROUND)
            override val foregroundState: StateFlow<ForegroundState> = _foregroundState
            override val canPresentPrompts: Boolean = true
    ...
    @Test
    fun secondPromptIsDeferredWhenFirstIsActive() = runTest {
        val scheduler = PromptSchedulerImpl(testPresenter)

        val lowPriorityRequest = NfcPromptRequest(
            title = "Low",
            initialMessage = "Testing",
            presentationHint = PromptPresentationHint(priority = PromptPriority.LOW)
        )

        val highPriorityRequest = NfcPromptRequest(
            title = "High",
            initialMessage = "Testing",
    ...
    @Test
    fun releaseRemovesFromCurrent() = runTest {
        val scheduler = PromptSchedulerImpl(testPresenter)
        val request = NfcPromptRequest(
            title = "Test",
            initialMessage = "Testing"
    ...
    @Test
    fun onReleaseCallbackIsInvoked() = runTest {
        val scheduler = PromptSchedulerImpl(testPresenter)
    ...
    @Test
    fun queueSizeTracksCorrectly() = runTest {
        val deferringPresenter = object : PromptPresenter {
            private val _foregroundState = MutableStateFlow(ForegroundState.FOREGROUND)
            override val foregroundState: StateFlow<ForegroundState> = _foregroundState
            override val canPresentPrompts: Boolean = true
    ...
    @Test
    fun releasePresentsNextDeferredPrompt() = runTest {
        val scheduler = PromptSchedulerImpl(testPresenter)
    ...
    @Test
    fun releaseDeferredPromptInvokesCallback() = runTest {
        val deferringPresenter = object : PromptPresenter {
            private val _foregroundState = MutableStateFlow(ForegroundState.FOREGROUND)
            override val foregroundState: StateFlow<ForegroundState> = _foregroundState
            override val canPresentPrompts: Boolean = true
    ...
    @Test
    fun tryPresentNextPresentsWhenNoCurrentPrompt() = runTest {
        // Create a presenter that initially defers, then allows
        var shouldDefer = true
        val toggleablePresenter = object : PromptPresenter {
            private val _foregroundState = MutableStateFlow(ForegroundState.FOREGROUND)
            override val foregroundState: StateFlow<ForegroundState> = _foregroundState
            override val canPresentPrompts: Boolean = true
            override fun onForeground() {}
    ...
    @Test
    fun tryPresentNextDoesNothingWhenPromptActive() = runTest {
        val scheduler = PromptSchedulerImpl(testPresenter)
    ...
    @Test
    fun deferredPromptsArePresentedInPriorityOrder() = runTest {
    ...
    @Test
    fun deferredPromptStaysInQueueIfStillShouldDefer() = runTest {
        // Always defer
        val alwaysDeferPresenter = object : PromptPresenter {
            private val _foregroundState = MutableStateFlow(ForegroundState.FOREGROUND)
            override val foregroundState: StateFlow<ForegroundState> = _foregroundState
            override val canPresentPrompts: Boolean = true
            override fun onForeground() {}
