...
/**
 * Contract Tests: CommandId properties after consolidation.
 */
class CommandIdConsolidatedPropertyTest {
    @Test
    fun commandIdHasCommandFieldViaOf() {
        // Given a CommandId created from parts
    ...
    @Test
    fun commandIdModuleAndServiceAccessible() {
        // Given a CommandId
        val id = CommandId("did.manager.resolve")
    ...
    @Test
    fun commandIdOfFormatsCorrectly() {
        // Given a CommandId created from parts
        val id = CommandId.of("kms", "keys", "get")
    ...
    @Test
    fun tryParseReturnsCommandIdWithCommandField() {
    ...
    @Test
    fun tryParseReturnsNullForInvalidIds() {
        // Given invalid command ID strings
        // When parsing
    ...
    @Test
    fun tryParseResultReturnsOkWithCommandField() {
        // Given a valid command ID
    ...
    @Test
    fun commandIdEquality() {
        // Given two identical CommandIds
