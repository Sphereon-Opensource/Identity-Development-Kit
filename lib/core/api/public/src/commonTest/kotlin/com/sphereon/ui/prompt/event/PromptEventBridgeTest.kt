...
class PromptEventBridgeTest {
    ...
    @Test
    fun emitSendsEventToSubscribers() = runTest {
    ...
    @Test
    fun multipleEventsAreEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
    ...
    @Test
    fun requestedEventCanBeEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
    ...
    @Test
    fun stateUpdatedEventCanBeEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
        val event = PromptEvent.StateUpdated(
            promptId = promptId,
            timestamp = timestamp,
    ...
    @Test
    fun completedEventCanBeEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
    ...
    @Test
    fun deferredEventCanBeEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
    ...
    @Test
    fun respondedEventCanBeEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
    ...
    @Test
    fun errorEventCanBeEmitted() = runTest {
        val bridge = DefaultPromptEventBridge()
        val promptId = PromptId.random()
        val timestamp = Clock.System.now()
    ...
    @Test
    fun singletonInstanceCanEmitEvents() = runTest {
