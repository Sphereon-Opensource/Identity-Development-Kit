    ...
    fun addAndRemovePropertySourceUseLocalPropertySourcesWhenParentsAreIncluded() {
        ...
        val env =
            object : ConfigEnvironment {
                ...
                override fun getPropertySources(includeParents: Boolean): PropertySources = if (includeParents) localSources.copy(parentSources) else localSources
                ...
                override fun <T : Any> getRequiredProperty(
                    ...
                    targetType: KClass<T>,
                    defaultValue: T?,
                ): T = getProperty(key, targetType, defaultValue) ?: throw IllegalStateException("Required property '$key' not found")
