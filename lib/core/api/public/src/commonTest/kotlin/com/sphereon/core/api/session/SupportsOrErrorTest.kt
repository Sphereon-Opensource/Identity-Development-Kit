...
class SupportsOrErrorTest {
    ...
    @Test
    fun supportsOrErrorReturnsOkWhenSupported() =
        runTest {
    ...
    @Test
    fun supportsOrErrorReturnsErrWhenNotSupported() =
        runTest {
    ...
    @Test
    fun supportsOrErrorWithCustomMapperUsesMapper() =
        runTest {
            val mapper =
                object : CommandErrorMapper<IdkError> {
                    override fun unsupportedArg(
                        command: Any,
                        arg: Any,
                    ) = IdkError.ILLEGAL_ARGUMENT_ERROR(message = "Custom unsupported: $arg")

                    override fun commandDisabled(commandId: String) = IdkError.ILLEGAL_ARGUMENT_ERROR(message = "disabled")
                    ...
                    override fun invalidCommandId(commandId: String) = IdkError.ILLEGAL_ARGUMENT_ERROR(message = "invalid id")
