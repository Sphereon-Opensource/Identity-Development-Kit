...
class HttpRoutesBuilderTest {
    ...
    @Test
    fun httpRoutesCreatesPostRoute() =
        runTest {
            val routes =
                httpRoutes {
                    post("/users") {
    ...
    @Test
    fun httpRoutesCreatesDeleteRoute() =
        runTest {
            val routes =
                httpRoutes {
                    delete("/users/{id}") {
    ...
    @Test
    fun httpRoutesCreatesPatchRoute() =
        runTest {
            val routes =
                httpRoutes {
                    patch("/users/{id}") {
    ...
    @Test
    fun httpRoutesCreatesMultipleRoutes() =
        runTest {
            val routes =
                httpRoutes {
