...
// ========== SessionGraph Provider Integration Tests ==========

class SessionGraphProviderTest {
    /**
     * Minimal stub implementation of SessionGraph for testing the interface's default methods.
     */
    private class StubSessionGraph : SessionGraph {
        ...
        private val _sessionScopeCoroutineScopeScoped =
    ...
    fun provideSessionCoroutineScopeUsesInterfaceDefault() {
        ...
        val graph = StubSessionGraph()
        val providers =
            object : SessionScopedProviders {
                override fun sessionScopedSet(): Set<software.amazon.app.platform.scope.Scoped> = emptySet()
            }

        val childScope = providers.provideSessionCoroutineScope(graph.sessionScopeCoroutineScopeScoped)
