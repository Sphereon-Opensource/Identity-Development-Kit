...
class EnhancedCommandExtensionTest {
    ...
    @Test
    fun defaultBeforeExecuteReturnsContinueWithOriginalArgs() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {}
        val command = testCommand<String, Int>("test.ext.default.before") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun defaultDuringExecuteReturnsOriginalArgs() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {}
        val command = testCommand<String, Int>("test.ext.default.during") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun defaultAfterExecuteReturnsOriginalResult() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {}
        val command = testCommand<String, Int>("test.ext.default.after") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun extensionCanModifyArgsInBeforeExecute() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                service: Command<String, Int, IdkError>,
                args: String,
            ): BeforeExecuteResult<String, Int, IdkError> {
                return BeforeExecuteResult.Continue(args.uppercase())
            }
        }

        val command = testCommand<String, Int>("test.ext.modify.before") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun extensionCanSkipInBeforeExecute() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                service: Command<String, Int, IdkError>,
                args: String,
            ): BeforeExecuteResult<String, Int, IdkError> {
                return BeforeExecuteResult.Skip
            }
        }

        val command = testCommand<String, Int>("test.ext.skip") { _ ->
            Ok(0)
        }
    ...
    @Test
    fun extensionCanShortCircuitInBeforeExecute() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                service: Command<String, Int, IdkError>,
                args: String,
            ): BeforeExecuteResult<String, Int, IdkError> {
                return BeforeExecuteResult.ShortCircuit(Ok(999))
            }
        }

        val command = testCommand<String, Int>("test.ext.shortcircuit") { _ ->
            Ok(0)
        }
    ...
    @Test
    fun extensionCanTransformArgsInDuringExecute() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
        ...
        val command = testCommand<String, Int>("test.ext.during.transform") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun extensionCanTransformResultInAfterExecute() = runTest {
        val extension = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
        ...
        val command = testCommand<String, Int>("test.ext.after.transform") { input ->
            Ok(input.length)
        }
    ...
    fun enhancedExtensionAdapterDuringExecutePassesThroughArgs() {
        ...
        val command = testCommand<String, Int>("test.adapter.during") { input ->
            Ok(input.length)
        }
    ...
    fun enhancedExtensionAdapterBeforeExecuteDoesNotThrow() {
        ...
        val command = testCommand<String, Int>("test.adapter.before") { input ->
            Ok(input.length)
        }
    ...
    fun enhancedExtensionAdapterAfterExecuteDoesNotThrow() {
        ...
        val command = testCommand<String, Int>("test.adapter.after") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionChainsBeforeExecuteContinue() = runTest {
        val ext1 = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                service: Command<String, Int, IdkError>,
                args: String,
            ): BeforeExecuteResult<String, Int, IdkError> {
                return BeforeExecuteResult.Continue("$args-ext1")
            }
        }

        val ext2 = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                service: Command<String, Int, IdkError>,
                args: String,
            ): BeforeExecuteResult<String, Int, IdkError> {
                return BeforeExecuteResult.Continue("$args-ext2")
            }
        }

        val composite = CompositeEnhancedExtension(listOf(ext1, ext2))
        val command = testCommand<String, Int>("test.composite.chain") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionStopsOnSkip() = runTest {
        ...
        val composite = CompositeEnhancedExtension(listOf(ext1, ext2))
        val command = testCommand<String, Int>("test.composite.skip") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionStopsOnShortCircuit() = runTest {
        var ext2Called = false
        ...
        val ext1 = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                ...
                return BeforeExecuteResult.ShortCircuit(Ok(42))
            }
        }
        ...
        val composite = CompositeEnhancedExtension(listOf(ext1, ext2))
        val command = testCommand<String, Int>("test.composite.shortcircuit") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionChainsDuringExecute() = runTest {
        val ext1 = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun duringExecute(
                service: Command<String, Int, IdkError>,
                args: String,
        ...
        val composite = CompositeEnhancedExtension(listOf(ext1, ext2))
        val command = testCommand<String, Int>("test.composite.during") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionChainsAfterExecuteInReverseOrder() = runTest {
        ...
        val composite = CompositeEnhancedExtension(listOf(ext1, ext2))
        val command = testCommand<String, Int>("test.composite.after") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionWithEmptyList() = runTest {
        val composite = CompositeEnhancedExtension<String, Int, IdkError>(emptyList())
        val command = testCommand<String, Int>("test.composite.empty") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionFunctionCreatesComposite() = runTest {
        val ext1 = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                service: Command<String, Int, IdkError>,
                args: String,
            ): BeforeExecuteResult<String, Int, IdkError> {
                return BeforeExecuteResult.Continue("$args-1")
            }
        }
        ...
        val ext2 = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun beforeExecute(
                ...
                return BeforeExecuteResult.Continue("$args-2")
            }
        }

        val composite = compositeExtension(ext1, ext2)
        val command = testCommand<String, Int>("test.composite.fn") { input ->
            Ok(input.length)
        }
    ...
    @Test
    fun compositeExtensionFunctionWithSingleExtension() = runTest {
        val ext = object : IEnhancedCommandExecutionExtension<String, Int, IdkError> {
            override suspend fun duringExecute(
                service: Command<String, Int, IdkError>,
                args: String,
        ...
        val command = testCommand<String, Int>("test.composite.single") { input ->
            Ok(input.length)
        }
