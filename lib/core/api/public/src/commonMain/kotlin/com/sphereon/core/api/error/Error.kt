...
open class IdkError(
    ...
    override fun toString(): String {
        return "IdkError(code='$code', severity=$severity, message=$message, causes=$causes, meta=$meta, exception=$exception)"
    }
    ...
    companion object {
        @JsStatic
        fun fromDTO(error: IdkErrorType) = IdkError(
            code = error.code,
        ...
        @JsStatic
        fun fromString(message: String, code: String = "UNKNOWN_ERROR", exception: Exception? = null, i18nKey: String = message, severity: Severity = Severity.ERROR) = IdkError(
            code = code,
...
interface ErrorDefinitionType {
    ...
    /**
     * Create an AppError instance using this definition.
     */
    fun asError(
        i18nParams: Map<String, Any?> = emptyMap(),
        exception: Throwable? = null,
        ...
        return IdkError.fromDefinition(
            definition = this,
            i18nParams = i18nParams,
            exception = exception,
            causes = causes,
    ...
    fun asResult(
        ...
        meta: Map<String, Any?> = emptyMap(),
        severity: Severity = this.severity
    ) = IdkErrorResult(asError(i18nParams, exception, causes, meta))
}
