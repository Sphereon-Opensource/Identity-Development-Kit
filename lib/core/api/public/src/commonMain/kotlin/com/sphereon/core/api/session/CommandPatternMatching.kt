...
private const val DEEP_WILDCARD_SUFFIX_LENGTH = 3
...
fun matchesSimplePattern(
    ...
    if (pattern.endsWith(".**")) {
        val prefix = pattern.dropLast(DEEP_WILDCARD_SUFFIX_LENGTH)
