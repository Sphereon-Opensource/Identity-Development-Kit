...
@ObjCName("SessionComponent", exact = true)
...
interface SessionScopedProviders {
    ...
    fun provideSessionScopeCoroutineScopeScoped(
        ...
        return CoroutineScopeScoped(dispatcher + SupervisorJob() + CoroutineName("SessionScope"))
    }
    ...
    fun provideSessionCoroutineScope(
        ...
        return sessionScopeCoroutineScopeScoped.createChild()
    }

    @Provides
    @IntoSet
    @ForScope(SessionScope::class)
    fun provideSessionScopeEmptyScoped(): Scoped = Scoped.NO_OP
}
