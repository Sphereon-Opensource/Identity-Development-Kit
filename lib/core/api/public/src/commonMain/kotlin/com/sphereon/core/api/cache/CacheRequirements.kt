...
data class CacheRequirements(
    ...
    companion object {
         ...
         */
        fun localOnly(namespace: String) = CacheRequirements(
            namespace = namespace,
         ...
         */
        fun distributedOnly(namespace: String) = CacheRequirements(
            namespace = namespace,
         ...
         */
        fun localWithFallback(namespace: String) = CacheRequirements(
            namespace = namespace,
         ...
         */
        fun hybridWriteThrough(namespace: String) = CacheRequirements(
            namespace = namespace,
            locality = CacheLocality.LOCAL_PREFERRED,
            distributedFallback = true,
            writeThrough = true
