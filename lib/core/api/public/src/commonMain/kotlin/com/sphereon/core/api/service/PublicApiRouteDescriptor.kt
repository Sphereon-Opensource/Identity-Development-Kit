 ...
 *
 * Session-scoped commands (registered via [RegistrableServiceCommandDescriptor]) cannot
...
interface PublicApiRouteDescriptor {
    ...
    companion object {
        fun of(commandId: String, httpMethod: String, httpPath: String): PublicApiRouteDescriptor =
