...
class DateTimeUtils(
    ...
    fun dateTime(
        ...
        .fromEpochSeconds(epochSeconds?.toLong() ?: epochSeconds().toLong())
        .toLocalDateTime(timeZone(timeZoneId))
        .toKMP()
...
fun Long.toLocalDateTimeKMP(dateTimeUtils: DateTimeUtils? = null): LocalDateTimeKMP = getDateTime(dateTimeUtils).dateTimeLocal(this.toInt())
