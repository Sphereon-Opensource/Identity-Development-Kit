...
object CacheSerializers {
     ...
     */
    val string: CacheSerializer<String> =
        object : CacheSerializer<String> {
     ...
     */
    val byteArray: CacheSerializer<ByteArray> =
        object : CacheSerializer<ByteArray> {
     ...
     * Int serializer.
     */
    val int: CacheSerializer<Int> =
        object : CacheSerializer<Int> {
     ...
     * Long serializer.
     */
    val long: CacheSerializer<Long> =
        object : CacheSerializer<Long> {
     ...
     * Boolean serializer.
     */
    val boolean: CacheSerializer<Boolean> =
        object : CacheSerializer<Boolean> {
            ...
            override fun serializeToString(value: Boolean): String =
                if (value) {
                    "1"
                } else {
                    "0"
     ...
     */
    fun <T : Any> json(serializer: KSerializer<T>): CacheSerializer<T> =
        object : CacheSerializer<T> {
