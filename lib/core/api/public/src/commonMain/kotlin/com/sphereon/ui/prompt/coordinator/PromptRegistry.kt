...
interface PromptRegistry {
     ...
     */
    fun validatePairing(request: PromptRequest, response: PromptResponse): String?
...
class DefaultPromptRegistry : PromptRegistry {
     ...
     */
    private val pairings: Map<String, Set<String>> = mapOf(
        NfcPromptRequest::class.simpleName!! to setOf(
        ...
        BiometricPromptRequest::class.simpleName!! to setOf(
        ...
        BiometricUnlockPromptRequest::class.simpleName!! to setOf(
        ...
        PassphrasePromptRequest::class.simpleName!! to setOf(
        ...
        ConfirmationPromptRequest::class.simpleName!! to setOf(
    ...
    override fun validatePairing(request: PromptRequest, response: PromptResponse): String? {
        ...
        val validResponses = pairings[requestTypeName]
