...
@JsExportCompat
interface UserContext : TenantAware, PrincipalAware {
    val id: String
...
object AnonymousPrincipal : PrincipalAware {
    ...
    override fun toString(): String {
        return "AnonymousPrincipal(principal='$principal')"
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is PrincipalAware) return false
...
object AnonymousContext : UserContext {
    ...
    override fun toString(): String {
        return "AnonymousUserContext(id='$id', tenant=$tenant, principal=$principal"
    }
}
...
fun createAnonymousSessionContext(sessionId: String): SessionContext =
    object : SessionContext {
        ...
        override fun toString(): String {
            return "AnonymousSessionContext(sessionId='$sessionId', userContext=$context)"
        }
...
fun UserContext.toSessionContext(sessionId: String = "_from_user_context"): SessionContext {
    return object : SessionContext {
        ...
        override fun toString(): String {
            return "UserToSessionContext(sessionId='$sessionId', userContext=$context)"
        }
...
object NoOpSessionContext : SessionContext by createAnonymousSessionContext(IdentityConstants.ANONYMOUS_SESSION_ID) {
    override fun toString(): String {
        return "AnonymousSessionContext(sessionId='$sessionId', context=$context)"
    }
}
