...
sealed class GenericHttpBody {
    ...
    companion object {
         ...
         */
        fun ofText(value: String?): GenericHttpBody = when {
         ...
         */
        fun ofBytes(value: ByteArray?): GenericHttpBody = when {
         ...
         */
        fun ofLazyText(supplier: () -> String?, charset: String = "utf-8"): GenericHttpBody =
            LazyText(supplier, charset)

        /**
         * Creates a lazily-evaluated binary body.
         */
        fun ofLazyBytes(supplier: () -> ByteArray?): GenericHttpBody =
            LazyBytes(supplier)
    }
}
