 ...
 * - Anonymous user/tenant component is always a singleton (cannot have more than one instance)
 * - Background user/tenant component is always a singleton (cannot have more than one instance)
...
@ObjCName("AnonymousUserComponentManager", exact = true)
interface AnonymousUserComponentManager {
    /**
     * Gets the singleton anonymous user context component.
     * Creates it on first access. The anonymous context is always a singleton with the ID UserContext.ANONYMOUS.
     * This method always returns a valid component.
     */
    fun getAnonymousComponent(): UserContextComponent

    /**
     * Gets the singleton background service user context component.
     ...
     * This method always returns a valid component.
     */
    fun getBackgroundComponent(): UserContextComponent
