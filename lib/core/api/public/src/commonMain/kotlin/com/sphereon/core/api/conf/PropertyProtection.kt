...
object ProtectionErrors {
     ...
     */
    fun overrideNotAllowed(key: String, definedAt: ConfigLevel, attemptedAt: ConfigLevel): IdkError =
     ...
     */
    fun interpolationNotAllowed(key: String, definedAt: ConfigLevel, requestedFrom: ConfigLevel): IdkError =
        IdkError.ILLEGAL_ARGUMENT_ERROR(
