...
/**
 * Annotation for denoting the scope of a plugin-specific component or session in the application.
 *
...
annotation class MultiService(val id: String, val plugin: String, val scope: KClass<*> = SessionScope::class)
