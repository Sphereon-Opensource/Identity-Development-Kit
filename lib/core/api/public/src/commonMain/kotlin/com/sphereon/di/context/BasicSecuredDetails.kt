...
private const val DEFAULT_VALIDITY_DURATION_MS = 3_600_000L
...
data class BasicSecuredDetails(
    ...
    override val validUntil: Long = Clock.System.now().toEpochMilliseconds() + DEFAULT_VALIDITY_DURATION_MS,
