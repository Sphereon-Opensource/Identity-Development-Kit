...
data class ServerSslConfig(val ca: CaOpts = CaOpts())

@OptIn(ExperimentalObjCName::class)
@ObjCName("CaOpts", exact = true)
data class CaOpts(val includePlatformDefaults: Boolean = true, val additionalCAs: Set<KeystoreCertificateOpts> = setOf())
