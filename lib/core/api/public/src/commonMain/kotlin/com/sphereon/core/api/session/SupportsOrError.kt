 ...
 */
suspend fun <Arg : Any, R : Any> BaseCommand<Arg, R, IdkError>.supportsOrError(args: Arg): IdkResult<Unit, IdkError> = supportsOrError(args = args, errorMapper = IdkErrorCommandErrorMapper)
 ...
 * @return Ok(Unit) if supported, Err with IdkError otherwise
 */
suspend fun <Arg : Any, R : Any> BaseCommand<Arg, R, IdkError>.supportsOrIdkError(args: Arg): IdkResult<Unit, IdkError> = supportsOrError(args = args)
