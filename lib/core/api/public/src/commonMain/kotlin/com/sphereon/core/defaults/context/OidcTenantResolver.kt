...
class OidcTenantResolver : TenantResolver {
    ...
    private val tenantClaimNames = listOf(
        "tenant_id",
        "tid",
        "tenantId",
        "org_id",
     ...
     */
    override fun supports(tenantInput: TenantInput): Boolean {
        return tenantInput is JwtClaimsInput
    }
    ...
    override fun resolveTenant(tenantInput: TenantInput): String {
        ...
        return tenantClaimNames.firstNotNullOfOrNull { claimName ->
