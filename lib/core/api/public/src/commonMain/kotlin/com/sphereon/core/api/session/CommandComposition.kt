...
fun <NewArg : Any, Arg : Any, Result : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.mapInput(transform: suspend (NewArg) -> IdkResult<Arg, E>): BaseCommand<NewArg, Result, E> =
    object : BaseCommand<NewArg, Result, E> {
 ...
 */
fun <Arg : Any, Result : Any, NewResult : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.mapOutput(transform: suspend (Result) -> IdkResult<NewResult, E>): BaseCommand<Arg, NewResult, E> =
    object : BaseCommand<Arg, NewResult, E> {
        override suspend fun supports(args: Any): Boolean = this@mapOutput.supports(args)
 ...
 */
fun <Arg : Any, Result : Any, E : IdkErrorType, NewE : IdkErrorType> BaseCommand<Arg, Result, E>.mapError(transform: suspend (E) -> NewE): BaseCommand<Arg, Result, NewE> =
    object : BaseCommand<Arg, Result, NewE> {
        override suspend fun supports(args: Any): Boolean = this@mapError.supports(args)
 ...
 * @return A new command that accepts the new argument type
 */
fun <NewArg : Any, Arg : Any, Result : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.mapInputSimple(transform: suspend (NewArg) -> Arg): BaseCommand<NewArg, Result, E> =
    mapInput { arg -> Ok(transform(arg)) }
 ...
 * @return A new command that produces the new result type
 */
fun <Arg : Any, Result : Any, NewResult : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.mapOutputSimple(transform: suspend (Result) -> NewResult): BaseCommand<Arg, NewResult, E> =
    mapOutput { result -> Ok(transform(result)) }
...
): BaseCommand<Arg, Result, E> =
    object : BaseCommand<Arg, Result, E> {
        override suspend fun supports(args: Any): Boolean = this@filterOutput.supports(args)
 ...
 */
fun <Arg : Any, Result : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.recover(recover: suspend (E) -> IdkResult<Result, E>): BaseCommand<Arg, Result, E> =
    object : BaseCommand<Arg, Result, E> {
        override suspend fun supports(args: Any): Boolean = this@recover.supports(args)
 ...
 */
fun <Arg : Any, Result : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.withFallback(fallback: Result): BaseCommand<Arg, Result, E> =
    object : BaseCommand<Arg, Result, E> {
        override suspend fun supports(args: Any): Boolean = this@withFallback.supports(args)
 ...
 */
fun <Arg : Any, Result : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.onSuccess(effect: suspend (Result) -> Unit): BaseCommand<Arg, Result, E> =
    object : BaseCommand<Arg, Result, E> {
        override suspend fun supports(args: Any): Boolean = this@onSuccess.supports(args)
 ...
 * @return The same command with added side effect
 */
fun <Arg : Any, Result : Any, E : IdkErrorType> BaseCommand<Arg, Result, E>.onFailure(effect: suspend (E) -> Unit): BaseCommand<Arg, Result, E> =
    object : BaseCommand<Arg, Result, E> {
        override suspend fun supports(args: Any): Boolean = this@onFailure.supports(args)
