...
data class SecretError(
    ...
    companion object {
        fun notFound(providerId: String, path: String, key: String? = null) = SecretError(
        ...
        fun providerUnavailable(providerId: String) = SecretError(
        ...
        fun accessDenied(providerId: String, path: String) = SecretError(
            code = "ACCESS_DENIED",
        ...
        fun timeout(providerId: String, path: String, timeout: Duration) = SecretError(
            code = "TIMEOUT",
        ...
        fun general(providerId: String, path: String, message: String, cause: String? = null) = SecretError(
            code = "SECRET_ERROR",
            message = message,
            providerId = providerId,
            path = path,
    ...
    fun toIdkError(): IdkError = IdkError.ILLEGAL_ARGUMENT_ERROR(
...
interface SecretRedactionPolicy {
     ...
     */
    fun shouldRedact(key: String, metadata: ResolutionMetadata): Boolean
 ...
 */
fun SecretProviderRegistry.toSecretResolver(): SecretResolver =
    ProviderBasedSecretResolver(this)

/**
 * Create a secret resolver with default providers.
 */
fun createDefaultSecretResolver(
    additionalSecrets: Map<String, Map<String, String>> = emptyMap()
): SecretResolver {
