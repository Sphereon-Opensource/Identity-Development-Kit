...
class UniversalHttpDefaultsBuilder {
    ...
    internal fun build(): UniversalHttpDefaults = UniversalHttpDefaults(
...
class UniversalHttpAdapterOverrideBuilder {
    ...
    internal fun build(): UniversalHttpAdapterOverride = UniversalHttpAdapterOverride(
        serverPrefix = serverPrefix,
...
class UniversalHttpConfigBuilder {
     ...
     * ```
     */
    fun adapter(adapterId: String, configure: UniversalHttpAdapterOverrideBuilder.() -> Unit) {
    ...
    internal fun build(): UniversalHttpConfig = UniversalHttpConfig(
 ...
 * ```
 */
fun universalHttpConfig(configure: UniversalHttpConfigBuilder.() -> Unit): UniversalHttpConfig {
    return UniversalHttpConfigBuilder().apply(configure).build()
}
