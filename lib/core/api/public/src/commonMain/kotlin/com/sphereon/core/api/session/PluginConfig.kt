...
interface PluginConfig {
     ...
     */
    fun isPluginAllowed(pluginId: String): Boolean =
        allowedPluginIds.isEmpty() || pluginId in allowedPluginIds
     ...
     * @return true if allowed, false if denied
     */
    fun isCommandAllowed(commandId: CommandId): Boolean =
        allowedCommandPatterns.isEmpty() || allowedCommandPatterns.any { commandId.matches(it) }
    ...
    companion object {
         ...
         */
        val Permissive: PluginConfig = object : PluginConfig {
         ...
         */
        fun allowPlugins(vararg pluginIds: String): PluginConfig = object : PluginConfig {
         ...
         */
        fun allowCommands(vararg patterns: String): PluginConfig = object : PluginConfig {
            override val allowedPluginIds: Set<String> = emptySet()
         ...
         */
        fun of(pluginIds: Set<String>, commandPatterns: Set<String>): PluginConfig = object : PluginConfig {
