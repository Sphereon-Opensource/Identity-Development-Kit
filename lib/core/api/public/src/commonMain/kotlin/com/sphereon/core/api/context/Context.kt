...
class ContextConfigImpl(override val app: AppConfigService, override val tenant: TenantConfigService, override val principal: PrincipalConfigService) : ContextConfig {
...
//interface ICoreApiContextComponent: ISureContextComponent, ICoreApiContextExtensionComponent
