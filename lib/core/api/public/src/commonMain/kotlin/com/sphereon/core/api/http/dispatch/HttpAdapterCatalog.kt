    ...
    companion object {
        fun from(descriptions: List<HttpAdapterDescription>): HttpAdapterCatalogDiagnostics {
            ...
            descriptions
                ...
                .forEach { (id, group) ->
                    collisions += HttpAdapterCatalogCollision(
                ...
                .forEach { (mountKey, group) ->
                    ...
                    group.forEach { desc ->
                        desc.endpoints.forEach { ep ->
                            endpointToAdapters.getOrPut(EndpointKey(ep.method.name, ep.pathPattern)) { mutableListOf() }
                                .add(desc.id)
                        }
                    }
...
private data class EndpointKey(val method: String, val pathPattern: String)
...
private fun HttpAdapterDescription.mountKey(): MountKey = MountKey(
