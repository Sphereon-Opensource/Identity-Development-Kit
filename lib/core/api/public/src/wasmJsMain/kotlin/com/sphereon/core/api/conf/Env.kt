 ...
 */
private fun getEnvVar(name: String): JsString? = js("(typeof process !== 'undefined' && process.env ? (process.env[name] !== undefined ? process.env[name] : null) : null)")

/**
 * Returns all Node.js process.env keys as a JsArray<JsString>.
 * Returns null in browser environments.
 */
private fun getEnvKeys(): JsArray<JsString>? = js("(typeof process !== 'undefined' && process.env ? Object.keys(process.env) : null)")
