...
class EventHubImplTest {
    ...
    fun testSubscribeWithFilter() =
        runTest {
            ...
            val job =
                hub.subscribe(this, filter) { event ->
    ...
    @Test
    fun testSubscribeWithDslBuilder() =
        runTest {
            val hub = EventHubImpl()
            val collectedEvents = mutableListOf<DefaultEvent>()

            val job =
                hub.subscribe(scope = this, builder = {
                    filter {
