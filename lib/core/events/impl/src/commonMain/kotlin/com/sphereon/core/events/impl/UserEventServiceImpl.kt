 ...
 * ## Note on UserContext
 *
 * UserContext is passed via factory to UserContextGraph but is not automatically injectable
...
class UserEventServiceImpl(
    ...
    override fun getEventContext(): EventContext = EventContext.fromUserContext(userContext)
}
