...
abstract class AbstractIOSMobileLogService(
    ...
    private val logLevelPrefixes = mapOf(
    ...
    private fun logToIOS(
        ...
        val logMessage = buildString(message.message.length + 200) {
...
object IOSMobileLogUtils {
     ...
     */
    fun getIOSLogPrefix(level: LogLevel): String = when (level) {
     ...
     */
    fun formatLogMessage(level: LogLevel, tag: String, message: String, context: String? = null): String {
        return buildString {
