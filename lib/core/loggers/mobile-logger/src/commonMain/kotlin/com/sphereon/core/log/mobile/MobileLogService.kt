 ...
 */
internal class CircularLogBuffer(private var maxSize: Int = 5000) {
    ...
    suspend fun add(entry: MobileLogEntry) = mutex.withLock {
    ...
    suspend fun getAll(): List<MobileLogEntry> = mutex.withLock {
        logs.toList()
    }
    ...
    suspend fun setMaxSize(size: Int) = mutex.withLock {
        maxSize = size
