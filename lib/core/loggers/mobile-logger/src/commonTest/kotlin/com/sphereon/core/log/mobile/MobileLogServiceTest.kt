...
class MobileLogServiceTest {
    ...
    @Test
    fun testMobileLogRepository() = runTest {
    ...
    @Test
    fun testMobileLogEntryFromLogMessage() = runTest {
    ...
    @Test
    fun testMobileLogManagerInterface() = runTest {
        val repository = MobileLogRepositoryImpl()
    ...
    fun testLogExport() = runTest {
        ...
        // Test JSON export
        val jsonExport = logManager.exportLogs(
        ...
        // Test CSV export
        val csvExport = logManager.exportLogs(
    ...
    @Test
    fun testCircularBuffer() = runTest {
        val repository = MobileLogRepositoryImpl()
    ...
    @Test
    fun testInterfaceBinding() = runTest {
