...
abstract class MinimalStaticWasmJsAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): MinimalStaticWasmJsAppComponent
    }
}

fun createMinimalStaticWasmJsAppComponent(
    application: Any, appId: String, profile: String, version: String,
): MinimalStaticWasmJsAppComponent {
    val component = createGraphFactory<MinimalStaticWasmJsAppComponent.Factory>().create(
