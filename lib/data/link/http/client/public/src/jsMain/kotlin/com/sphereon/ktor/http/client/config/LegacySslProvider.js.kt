...
class JsSslProviderImpl(private val opts: LegacySslConfig) : LegacySslProvider {

    override suspend fun getCertificates(): List<LegacyCertificateAndKeyJs> {
        // Only in-memory keystores (Bytes) on JS for now
/*  FIXME
...
*/
    ...
    override suspend fun getTrustManager(): dynamic {
        return null
    }
}

actual fun createLegacySslProvider(opts: LegacySslConfig): LegacySslProvider {
    return JsSslProviderImpl(opts)
}
