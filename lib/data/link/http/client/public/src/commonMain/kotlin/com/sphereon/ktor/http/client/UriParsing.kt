 ...
 */
fun Parameters.getOptional(name: String): String? = this[name]?.takeIf { it.isNotBlank() }
...
data class ParsedUri(
    ...
    val host: String?,
    /**
     * Path graph (e.g., "/auth/callback"), or empty if none
     */
    val path: String,
    /**
