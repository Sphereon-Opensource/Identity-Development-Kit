 ...
 *
 * Uses Application → User → Session graph hierarchy.
 */
class ParseUriQueryCommandImplTest {
    ...
    @Test
    fun testHttpsUriWithHostAndPath() =
        runTest {
    ...
    @Test
    fun testMultipleValuesForSameKey() =
        runTest {
    ...
    @Test
    fun testComplexRealWorldExample() =
        runTest {
            val uri =
    ...
    @Test
    fun testOid4vpMode1_DirectInlineParameters() =
        runTest {
    ...
    @Test
    fun testOid4vpMode2_RequestByReference() =
        runTest {
            // OID4VP Mode 2: Request by reference (cross-device flow)
            // Request object is fetched from request_uri
            val uri =
                "openid4vp://?client_id=https%3A%2F%2Fclient.example.org%2Fcb" +
    ...
    @Test
    fun testOid4vpMode3_RequestObject() =
        runTest {
    ...
    @Test
    fun testOid4vpWithResponseMode() =
        runTest {
    ...
    @Test
    fun testOid4vpWithClientIdScheme() =
        runTest {
    ...
    @Test
    fun testOid4vpComplexRealWorld() =
        runTest {
