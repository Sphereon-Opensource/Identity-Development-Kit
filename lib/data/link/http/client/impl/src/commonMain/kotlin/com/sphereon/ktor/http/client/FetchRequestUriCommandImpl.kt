...
class FetchRequestUriCommandImpl(
    ...
    execution = execution,
), FetchRequestUriCommand, FetchRequestUriCommandService {

    override suspend fun fetchRequestUri(args: FetchRequestUriArgs): IdkResult<FetchedRequestUri, IdkError> {
        return execute(args)
    }
    ...
    override suspend fun doExecute(
        ...
        return try {
            ...
            val response: HttpResponse = when (processedArgs.httpMethod) {
                RequestUriMethod.GET -> httpClient.get(processedArgs.requestUri)
            ...
            Err(IdkError.fromString(
                message = "Failed to fetch request URI: ${e.message} from ${processedArgs.requestUri}",
    ...
    private fun validateRequestUri(requestUri: String): IdkError? {
        ...
        val url = try {
            ...
            return IdkError.ILLEGAL_ARGUMENT_ERROR(
                message = "Invalid request URI: ${e.message}",
                throwable = e
            )
        }
