...
object TestCertificateGenerator {
    ...
    fun generateKeyPair(algorithm: String = "EC", curveNameOrKeySize: String = "secp256r1"): KeyPair {
    ...
    fun createSelfSignedCertificate(subjectDNStr: String, keyPair: KeyPair, daysValidity: Int = 365, sigAlgName: String = "SHA256withECDSA"): X509Certificate {
        val now = Date()
        ...
        certBuilder.addExtension(Extension.basicConstraints, true, org.bouncycastle.asn1.x509.BasicConstraints(true))
    ...
    fun createSignedCertificate(
        ...
        val bcUtils = JcaX509ExtensionUtils()
        certBuilder.addExtension(Extension.basicConstraints, isCA, org.bouncycastle.asn1.x509.BasicConstraints(isCA))
    ...
    fun X509Certificate.toSureCertificate(): Certificate {
        return certificateFromDer(this.encoded)
    }
}
