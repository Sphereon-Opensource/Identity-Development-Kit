...
class HttpClientFactoryP12Test {
    val trustStorePath: String = this::class.java.classLoader.getResource("truststore.p12").file.decodeURLPart() // Remove %20 etc from path
    val clientKeyStorePath: String = this::class.java.classLoader.getResource("client-keystore.p12").path.decodeURLPart()
    val serverKeyStorePath: String = this::class.java.classLoader.getResource("server-keystore.p12").path.decodeURLPart()
    val clientKeyStoreUntrustedPath: String = this::class.java.classLoader.getResource("client-keystore-untrusted.p12").path.decodeURLPart()
    val serverKeyStoreUntrustedPath: String = this::class.java.classLoader.getResource("server-keystore-untrusted.p12").path.decodeURLPart()
