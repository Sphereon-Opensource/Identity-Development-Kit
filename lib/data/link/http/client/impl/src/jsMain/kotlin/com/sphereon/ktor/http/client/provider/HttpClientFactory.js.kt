...
class HttpClientFactoryJsImpl(private val execution: SessionExecution, val kms: KeyManagerService, private val keyStoreManager: KeyStoreManager) : HttpClientFactory {
...
//                        loggingConfig?.invoke(this)
     ...
     */
    private fun createJsEngine(): HttpClientEngine {
        return Js.create {}
    }
}
