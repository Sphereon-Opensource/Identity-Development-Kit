 ...
 * and scanning will continue until programmatically dismissed by canceling the coroutine this is launched from.
 *
 ...
 * @throws kotlinx.coroutines.CancellationException if the user canceled the dialog
