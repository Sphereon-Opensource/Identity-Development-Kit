...
data class NdefRecord(
    val tnf: Tnf,
    val type: ByteString = kotlinx.io.bytestring.ByteString(),
    val id: ByteString = kotlinx.io.bytestring.ByteString(),
    val payload: ByteString = kotlinx.io.bytestring.ByteString()
) {
    /**
        ...
        return when (tnf) {
            Tnf.WELL_KNOWN -> {
                when (type) {
                    ...
                    NfcConst.RTD_URI -> return URI_PREFIX_MAP[payload[0].toInt()] + payload.toByteArray(1).decodeToString()
                    else -> return null
                }
            }
    ...
    companion object {
        ...
        internal fun fromEncoded(encoded: ByteArray): List<NdefRecord> {
            try {
                ...
                var type = kotlinx.io.bytestring.ByteString()
                var id = kotlinx.io.bytestring.ByteString()
        ...
        fun createUri(uri: String): NdefRecord {
            ...
            return NdefRecord(
                ...
                id = kotlinx.io.bytestring.ByteString(),
