...
object NfcConst {
     ...
     */
    val NDEF_APPLICATION_ID = ByteString("D2760000850101".decodeFromHex())
     ...
     */
    val ISO_MDOC_NFC_DATA_TRANSFER_APPLICATION_ID = ByteString("A0000002480400".decodeFromHex())

    /**
     * The File IdentifierAlias for the NDEF Capability Container file.
     */
