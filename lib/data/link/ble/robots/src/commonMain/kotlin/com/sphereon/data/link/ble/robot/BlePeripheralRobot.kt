 ...
 *     val robot = component.blePeripheralRobot
...
class BlePeripheralRobot(
     ...
     */
    fun assertReceivedWrite(charId: Uuid, expectedData: ByteArray) {
     ...
     */
    fun assertNotifiedData(charId: Uuid, expectedData: ByteArray) {
