...
private val knownGattDescriptors: Map<String, String> = mapOf(
...
fun gattDescriptorToName(descriptor: Uuid): String {
    return knownGattDescriptors[descriptor.toString()] ?: descriptor.toString()
}


private val knownGattAttributeNanes = mapOf(
...
fun gattAttributeToName(attribute: Uuid): String {
    return knownGattAttributeNanes[attribute.toString()] ?: attribute.toString()
}
...
val knownGattServiceNames = mapOf<String,String>(
...
fun gattServiceToName(attribute: Uuid): String {
    return knownGattServiceNames[attribute.toString()] ?: attribute.toString()
}
