...
interface BlePlatformClient : BleEvent.Handlers, AutoCloseable {

    //    val eventPublisher: IBleClientEventPublisher
    ...
    suspend fun readCharacteristic(service: HasUuidId, characteristic: HasUuidId): IdkResult<GattCharacteristic, CharacteristicReadError>
    ...
    suspend fun enableNotifications(service: HasUuidId, characteristic: HasUuidId): IdkResult<GattDescriptor, NotificationFailedError>
    suspend fun discoverServiceCharacteristics(service: HasUuidId, characteristics: List<HasUuidId>? = null): IdkResult<List<GattCharacteristic>, CharacteristicReadError>
}