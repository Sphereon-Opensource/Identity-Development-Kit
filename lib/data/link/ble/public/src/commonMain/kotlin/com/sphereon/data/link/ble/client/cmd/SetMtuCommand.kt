...
class SetMtuCommand(
    ...
    override suspend fun doExecute(args: Int): IdkResult<BleResponse.Success, BleError> {
        return client.setMtu(args).map { BleResponse.Success }
    }

    companion object {
        const val COMMAND_ID = "ble.connection.setmtu"
    }
}
