...
class AndroidBlePlatformPeripheral(
    ...
    private val sessionCleanupIntervalMs = 5 * 60 * 1000L
    ...
    init {
        ...
        scope.launch {
            while (true) {
                kotlinx.coroutines.delay(sessionCleanupIntervalMs)
            ...
            try {
                for (event in bleEventQueue) {
                    try {
                        ...
                        log.error("Error emitting BLE event: ${expected.message}", exception = expected)
                    }
                }
            } finally {
                synchronized(eventQueueLock) {
     ...
     */
    private fun getSessionId(deviceAddress: String): Uuid = deviceSessionIds[deviceAddress] ?: Uuid.NIL
    ...
    private fun cleanupStaleSessions() {
        ...
        val staleDevices =
            deviceLastActivityTime
                .filter { (_, lastActivity) ->
                    now - lastActivity > sessionTimeoutMs
                }.keys
                .toList()
        ...
        object : BluetoothGattServerCallback() {
                    ...
                    BluetoothProfile.STATE_CONNECTED -> {
                        ...
                        if (!isAdvertising) {
                            ...
                            try {
                                ...
                                log.warn("Failed to disconnect stale connection: ${expected.message}")
                            }
                            return
                        }
            ...
            override fun onCharacteristicReadRequest(
                ...
                try {
                    ...
                    log.warn("Error handling characteristic read request: ${expected.message}")
                }
            }
                ...
                try {
                    ...
                    if (responseNeeded) {
                        try {
                            ...
                            log.warn("Failed to send GATT response: ${expected.message}")
                        }
                    }
                    ...
                    try {
                        ...
                        log.warn("Error building characteristic changed event: ${expected.message}")
                    }
                } catch (expected: Exception) {
                    log.warn("Error handling characteristic write request: ${expected.message}")
                }
            }
            ...
            override fun onDescriptorWriteRequest(
                ...
                try {
                    ...
                    try {
                        ...
                        if (serviceUuid != null) {
                            val gattDescriptor =
                                com.sphereon.data.link.ble.model.GattDescriptor(
                        ...
                        log.warn("Error building descriptor write event: ${expected.message}")
                    }
                } catch (expected: Exception) {
                    log.warn("Error handling descriptor write request: ${expected.message}")
                }
            }
    ...
    override suspend fun startAdvertising(serviceUuid: Uuid): IdkResult<Unit, BleError> {
        ...
        return advertisingMutex.withLock {
            ...
            try {
                ...
                log.error("Failed to start advertising", exception = expected)
                isAdvertising = false
                BleErrors.connectionFailed("Failed to start advertising: ${expected.message}", expected).asErrorResult()
            } finally {
    ...
    private suspend fun startAdvertisingLegacy(
    ...
    private suspend fun startAdvertisingWithNonResolvableAddress(
        advertiser: BluetoothLeAdvertiser,
        data: AdvertiseData,
    ) {
    ...
    private fun trySetNonResolvableAddressType(builder: AdvertisingSetParameters.Builder): Boolean =
        try {
            ...
            val setOwnAddressTypeMethod =
                AdvertisingSetParameters.Builder::class.java.getMethod(
                    "setOwnAddressType",
            ...
            log.warn("Failed to set non-resolvable address type: ${expected.message}")
            false
        }
    ...
    override suspend fun stopAdvertising(): IdkResult<Unit, BleError> {
        ...
        return try {
                ...
                if (adapter != null && adapter.isEnabled) {
                    ...
                    currentAdvertisingSet?.let { advertisingSet ->
                        try {
                            ...
                            log.warn("Failed to stop AdvertisingSet: ${expected.message}")
                        }
                        currentAdvertisingSet = null
                    }
                    ...
                    if (currentAdvertisingSet == null) {
                        advertiser?.let { adv ->
                            try {
                                ...
                                log.warn("Failed to stop legacy advertising: ${expected.message}")
                            }
                        }
                    }
                } else {
            ...
            log.error("Failed to stop advertising", exception = expected)
            isAdvertising = false
            currentAdvertisingSet = null
            advertiser = null
            BleErrors.connectionFailed("Failed to stop advertising: ${expected.message}", expected).asErrorResult()
        }
    }
        ...
        return try {
            ...
            connectedDevice?.let { device ->
                ...
                try {
                    ...
                    log.error("Failed to force disconnect device: ${expected.message}")
                }
            }
            ...
            if (gattServer != null) {
                ...
                try {
                    ...
                    log.warn("Failed to close old GATT server: ${expected.message}")
                }
            ...
            log.error("Failed to add service", exception = expected)
            BleErrors.connectionFailed("Failed to add service: ${expected.message}", expected).asErrorResult()
        }
    }
    ...
    override suspend fun removeService(service: HasUuidId): IdkResult<Unit, BleError> {
        ...
        return try {
            ...
            log.error("Failed to remove service", exception = expected)
            BleErrors.connectionFailed("Failed to remove service: ${expected.message}", expected).asErrorResult()
        }
    }
    ...
    override suspend fun notifyCharacteristicChanged(
        ...
        return try {
            val androidService =
                gattServer?.services?.find { it.uuid == service.id.toJavaUuid() }
                    ?: return BleErrors.writeCharacteristicFailed("Service not found").asErrorResult()

            val androidChar =
                androidService.characteristics.find { it.uuid == characteristic.id.toJavaUuid() }
            ...
            log.error("Failed to notify characteristic", exception = expected)
            BleErrors.writeCharacteristicFailed("Failed to notify characteristic: ${expected.message}", expected).asErrorResult()
        }
    }
    ...
    override suspend fun awaitConnection(): IdkResult<Unit, BleError> {
        ...
        return try {
            ...
            log.error("Failed waiting for connection", exception = expected)
            BleErrors.connectionFailed("Failed waiting for connection: ${expected.message}", expected).asErrorResult()
        }
    }
    ...
    override suspend fun disconnect(): IdkResult<Unit, BleError> {
        ...
        return try {
            ...
            log.error("Failed to disconnect", exception = expected)
            BleErrors.connectionFailed("Failed to disconnect: ${expected.message}", expected).asErrorResult()
        }
    }
    ...
    override fun close() {
        ...
        if (isAdvertising) {
            try {
                ...
                if (adapter != null && adapter.isEnabled) {
                    ...
                    currentAdvertisingSet?.let {
                        try {
                            ...
                            log.warn("Failed to stop AdvertisingSet during close: ${expected.message}")
                        }
                    }
                    ...
                    advertiser?.let { adv ->
                        try {
                            ...
                            log.warn("Failed to stop legacy advertising during close: ${expected.message}")
                        }
                    }
                } else {
                ...
                log.error("Unexpected error stopping advertising during close: ${expected.message}", exception = expected)
            } finally {
                isAdvertising = false
                currentAdvertisingSet = null
            }
        ...
        try {
            ...
            log.error("Error closing GATT server: ${expected.message}", exception = expected)
        } finally {
            gattServer = null
        }
