...
class IosBlePlatformPeripheral(
    ...
    private fun getOrCreateSessionId(deviceIdentifier: String): Uuid {
        deviceLastActivityTime[deviceIdentifier] =
     ...
     */
    private fun getSessionId(deviceIdentifier: String): Uuid = deviceSessionIds[deviceIdentifier] ?: Uuid.NIL
    ...
    private val peripheralManagerDelegate =
        object : NSObject(), CBPeripheralManagerDelegateProtocol {
            ...
            override fun peripheralManager(
                ...
                didReceiveWriteRequests.forEach { request ->
                    ...
                    val serviceUuid =
                        characteristicsMap.entries.find { it.value.UUID().UUIDString == attRequest.characteristic.UUID().UUIDString }?.key
                            ?: Uuid.NIL
    ...
    override suspend fun notifyCharacteristicChanged(
        ...
        return try {
            val cbChar =
                characteristicsMap[characteristic.id]
