...
class HttpBlobStoreAdapter(
    ...
    private fun withTenant(info: BlobInfo): BlobInfo =
        if (info.tenantId != null) info else info.copy(tenantId = tenantId)
