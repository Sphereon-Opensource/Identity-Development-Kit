...
data class CorrelationIdentifierResult(
    ...
    // Extension data (populated based on FetchOptions)
    /**
    ...
    companion object {
         ...
         */
        fun fromX509(x509: IdentifierX509) = from(
            identifier = x509.correlationIdentifier,
            x509Extension = X509ExtensionData(
    ...
    fun toCorrelationIdentifier() = CorrelationIdentifier(
