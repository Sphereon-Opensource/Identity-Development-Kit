 ...
 * and blinded. The mode is purely descriptive metadata; the IDK lite model carries no
 * crypto and performs no protection itself.
 */
@JsExportCompat
@Serializable
enum class IdentifierProtectionMode {
    ...
    SEARCHABLE_BLIND_INDEX,

    /** The identifier value is salted and blinded. */
    @SerialName("saltedBlinded")
    SALTED_BLINDED,
}
