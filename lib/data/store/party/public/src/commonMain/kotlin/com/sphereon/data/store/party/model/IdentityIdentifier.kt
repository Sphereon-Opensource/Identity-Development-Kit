...
/**
 * An identity identifier that can be used to look up an identity.
 ...
 * The lookup flow is: identifier value → identity_identifier → identity → party
 */
@JsExportCompat
@Serializable
data class IdentityIdentifier
    @JvmOverloads
    constructor(
        ...
        override val id: String get() = identityIdentifierId.toString()
    }
