...
class CredentialTemplateDesignProvider : DesignLayerProvider {
    override val sourceType = DesignSourceType.CREDENTIAL_TEMPLATE
    ...
    override suspend fun resolveCredentialLayer(
        ...
        // Phase 1 stub: CredentialTemplate integration requires Party store dependency
        // Will be implemented when the design record's credentialTemplateId is resolved
        return null
    }
}
