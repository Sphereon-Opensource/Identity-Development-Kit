...
interface CredentialDesignConfigProvider {
    ...
    fun getPolicy(): DesignResolutionPolicy = getConfig().policy

    fun getValidationConfig(): CredentialDesignValidationConfig = getConfig().validation

    fun getRefreshConfig(): CredentialDesignRefreshConfig = getConfig().refresh
}
