...
interface DefaultResourceServerConfigModule {
    ...
    @SingleIn(SessionScope::class)
    @Named("resourceServer.identifier")
    fun provideDefaultResourceServerIdentifier(): String {
    ...
    @SingleIn(SessionScope::class)
    @Named("resourceServer.authorizationServers")
    fun provideDefaultAuthorizationServers(): List<String> {
    ...
    @SingleIn(SessionScope::class)
    @Named("resourceServer.clientAuthentication")
    fun provideDefaultClientAuthentication(): ClientAuthenticationConfig? {
        return null
    }
    ...
    fun provideDefaultTokenValidationStrategy(): TokenValidationStrategy {
        return TokenValidationStrategy.JWT_FIRST
    }
    ...
    fun provideDefaultAllowedAuthenticationSchemes(): List<AuthenticationScheme> {
        return listOf(AuthenticationScheme.BEARER, AuthenticationScheme.DPOP)
    }
    ...
    fun provideDefaultTokenCacheTtl(): Duration {
        return 1.hours
    }
    ...
    fun provideDefaultDpopReplayWindow(): Duration {
        return 1.minutes
    }
    ...
    fun provideDefaultDpopNonceTtl(): Duration {
        return 5.minutes
    }
    ...
    fun provideDefaultRequireAudienceValidation(): Boolean {
        return true
    }
    ...
    fun provideDefaultClockSkewTolerance(): Duration {
