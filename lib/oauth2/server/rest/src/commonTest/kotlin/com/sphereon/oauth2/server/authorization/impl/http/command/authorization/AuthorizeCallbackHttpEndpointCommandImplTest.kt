...
class AuthorizeCallbackHttpEndpointCommandImplTest {
    ...
    fun queryMode_returns302WithLocation() =
        runTest {
            var capturedArgs: HandleAuthorizeCallbackArgs? = null
            val command =
                ...
                GenericHttpRequest(
                    ...
                    queryParameters =
                        mapOf(
                            ...
                            "authentication_session_id" to "wallet-456",
                        ),
                )
            ...
            assertEquals("sess-123", capturedArgs?.sessionId)
            assertEquals("wallet-456", capturedArgs?.authenticationSessionId)
        }
