...
class RegisterPreAuthorizedCodeHttpEndpointCommandImplTest {
        ...
        runTest {
            ...
            val request =
                GenericHttpRequest.withTextBody(
                    ...
                    body =
                        """
                        {"code":"pre-auth-1","sessionId":"sess","credentialConfigurationIds":["cfg-1"],"expiresAtEpochSeconds":1900000042}
                        """.trimIndent(),
            ...
            assertEquals(1_900_000_042L, captured?.expiresAtEpochSeconds)
        }
    ...
    @Test
    fun missingExpiry_returns400WithoutCallingService() =
        runTest {
            val command =
                RegisterPreAuthorizedCodeHttpEndpointCommandImpl(
                    execution = TestSessionExecution(),
        ...
        runTest {
            ...
            val request =
                GenericHttpRequest.withTextBody(
                    method = "POST",
                    path = "/internal/preauth/register",
                    body = """{"code":"x","sessionId":"y","credentialConfigurationIds":[],"expiresAtEpochSeconds":1900000042}""",
