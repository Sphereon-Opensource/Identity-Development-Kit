...
class RevokeTokenCommandImpl(
    ...
    private suspend fun executeInternal(
        ...
        val tokenData = findToken(token, tokenTypeHint)
        ...
        when (tokenData) {
            is AccessTokenData -> {
                ...
                tokenStorage.revokeAccessToken(token)
            ...
            is RefreshTokenData -> {
                ...
                tokenStorage.revokeRefreshToken(token)
    ...
    private suspend fun findToken(token: String, tokenTypeHint: String?): Any? {
     ...
     */
    private suspend fun cascadeRevokeAccessTokens(clientId: String, refreshToken: String) {
        val accessTokens = tokenStorage.findAccessTokensByClient(clientId)
            .getOrElse { emptyList() }
