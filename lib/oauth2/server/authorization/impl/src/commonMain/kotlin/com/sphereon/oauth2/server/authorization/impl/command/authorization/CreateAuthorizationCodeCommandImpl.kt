...
class CreateAuthorizationCodeCommandImpl(
    ...
    private val codeLifetimeSeconds: Int = 600  // 10 minutes default
    ...
    override suspend fun doExecute(
        ...
        return executeInternal(applied.session, applied.userId, applied.consent, applied.userClaims).map { StringResult(it) }.mapError { IdkError.fromDTO(it) }
    }
    ...
    private suspend fun executeInternal(
        ...
        val pkceMethod = session.codeChallengeMethod?.let { method ->
        ...
        return authorizationCodeStorage.storeAuthorizationCode(code, codeData)
            .mapError { error ->
