...
@StringKey(GrantHandlerKeys.PRE_AUTHORIZED_CODE)
class PreAuthorizedCodeGrantHandlerImpl(
    private val verifyPreAuthorizedCodeGrant: VerifyPreAuthorizedCodeGrantCommand,
    private val createAccessToken: CreateAccessTokenCommand,
    private val createTokenResponse: CreateTokenResponseCommand,
) : GrantHandler {
    override val grantType: String = GrantHandlerKeys.PRE_AUTHORIZED_CODE
        ...
        val authorizationDetails =
            if (verified.useCredentialIdentifiers && verified.credentialConfigurationIds.isNotEmpty()) {
                buildAuthorizationCodeCredentialAuthorizationDetails(
                    ...
                    issuanceSessionId = verified.sessionId,
                )
            } else {
                null
            }
