...
data class OAuth2StoragePartitionKey(
    ...
    companion object {
         ...
         */
        fun forTenant(tenantId: String) =
            OAuth2StoragePartitionKey(tenantId = tenantId)

        /**
         * Principal + tenant level storage
         * Suitable when user-specific isolation is needed beyond tenant
         */
        fun forPrincipalTenant(tenantId: String, principalId: String) =
...
class InMemoryOAuth2BackingStorageImpl : InMemoryOAuth2BackingStorage {
    ...
    override fun getPartition(partitionKey: OAuth2StoragePartitionKey): OAuth2StoragePartition {
        return partitions.getOrPut(partitionKey) { OAuth2StoragePartition() }
    }
