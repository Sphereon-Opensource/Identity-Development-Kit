...
class InMemoryClientRegistryImpl(
    ...
    override suspend fun updateClient(
        ...
        return try {
            val existing = partition.clients[clientId]
    ...
    override suspend fun listClients(
        ...
        return try {
            val clients = partition.clients.values
                .drop(offset)
                .take(limit)
                .toList()
            Ok(clients)
    ...
    override suspend fun findClientsByName(
        ...
        return try {
            val clients = partition.clients.values.filter { client ->
    ...
    override suspend fun clientExists(
        clientId: String
    ...
    /**
     * Component interface for DI access to ClientRegistry in tests
     */
