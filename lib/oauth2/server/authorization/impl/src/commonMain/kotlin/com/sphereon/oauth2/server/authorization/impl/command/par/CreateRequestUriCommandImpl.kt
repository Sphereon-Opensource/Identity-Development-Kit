...
class CreateRequestUriCommandImpl(
    ...
    private val requestUriLifetimeSeconds: Int = 90  // 90 seconds default (RFC 9126 recommendation)
    ...
    private suspend fun executeInternal(
    ...
    ): IdkResult<RequestUriData, AuthorizationServerError> {
        ...
        val requestUriData = RequestUriData(
