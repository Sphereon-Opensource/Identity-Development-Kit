...
import com.sphereon.oauth2.server.authorization.impl.test.createJvmOAuth2ServerTestAppComponent
import com.sphereon.di.app.AppComponent

actual fun createOAuth2ServerTestAppComponent(testInstance: Any): AppComponent {
    return createJvmOAuth2ServerTestAppComponent(testInstance)
}
