...
import com.sphereon.oauth2.server.authorization.model.*
...
object TestFixtures {
    ...
    val confidentialClient = ClientRegistration(
    ...
    val publicClient = ClientRegistration(
    ...
    val parRequiredClient = ClientRegistration(
        clientId = "par-client",
    ...
    val tokenExchangeClient = ClientRegistration(
    ...
    // PKCE test values
    object Pkce {
        const val codeVerifier = "dBjftJeZ4CVP-mB92K27uhbUJU1p1r_wW1gFWFOEjXk"
        const val codeChallengeS256 = "E9Melhoa2OwvFrEMTJguCHaoeK1t8URWbuGJSstw-cM"
        const val codeChallengePlain = codeVerifier
    }
