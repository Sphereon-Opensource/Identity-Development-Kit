...
class OidcDiscoveryMetadataTest {
    ...
    @Test
    fun oidcEnabledIncludesOidcFields() = runTest {
    ...
    @Test
    fun oidcDisabledOmitsOidcFields() = runTest {
        val config = OAuth2ServerInstanceConfig(
            baseUrl = "https://auth.example.com",
    ...
    @Test
    fun oidcDefaultIsDisabled() = runTest {
        val config = OAuth2ServerInstanceConfig(
            baseUrl = "https://auth.example.com"
    ...
    @Test
    fun oidcEnabledWithBaseUrlOverride() = runTest {
        val config = OAuth2ServerInstanceConfig(
    ...
    @Test
    fun oidcEnabledWithCustomClaimsSupported() = runTest {
        val config = OAuth2ServerInstanceConfig(
            baseUrl = "https://auth.example.com",
            oidc = FeaturePolicy.SUPPORTED,
