...
class BuildServerMetadataCommandImplTest {
    ...
    @Test
    fun testMetadataReflectsConfig() = runTest {
    ...
    @Test
    fun testDisabledFeaturesOmitEndpoints() = runTest {
        val config = OAuth2ServerInstanceConfig(
            baseUrl = "https://auth.example.com",
    ...
    @Test
    fun testEnabledFeaturesIncludeEndpoints() = runTest {
        val config = OAuth2ServerInstanceConfig(
            baseUrl = "https://auth.example.com",
            introspection = FeaturePolicy.SUPPORTED,
            revocation = FeaturePolicy.SUPPORTED,
    ...
    @Test
    fun testParRequiredSetsFlag() = runTest {
        val config = OAuth2ServerInstanceConfig(
            baseUrl = "https://auth.example.com",
    ...
    @Test
    fun testExternalServerReturnsError() = runTest {
        val config = OAuth2ServerInstanceConfig(
    ...
    @Test
    fun testNamedServerLookup() = runTest {
        val primary = OAuth2ServerInstanceConfig(
            baseUrl = "https://primary.example.com",
            revocation = FeaturePolicy.SUPPORTED
        )
        val secondary = OAuth2ServerInstanceConfig(
    ...
    @Test
    fun testUnknownServerReturnsError() = runTest {
        val configProvider = TestOAuth2ServersConfigProvider()
        val command = BuildServerMetadataCommandImpl(ctx.execution, configProvider)
    ...
    @Test
    fun testBaseUrlOverride() = runTest {
        val config = OAuth2ServerInstanceConfig(
