...
class RevokeTokenCommandImplTest {
    ...
    private fun createConfigProvider(revocation: FeaturePolicy = FeaturePolicy.SUPPORTED) =
    ...
    fun testRevokeRefreshToken() =
        runTest {
            ...
            val refreshToken =
                TestFixtures.createRefreshToken(
    ...
    @Test
    fun testRevokeRefreshTokenCascadesToAccessTokens() =
        runTest {
            val storage = InMemoryOAuth2BackingStorageImpl()
            val tokenStorage = InMemoryTokenStorageImpl(storage)
            val configProvider = createConfigProvider()
    ...
    @Test
    fun testUnknownTokenReturnsSuccess() =
        runTest {
            val storage = InMemoryOAuth2BackingStorageImpl()
            val tokenStorage = InMemoryTokenStorageImpl(storage)
            val configProvider = createConfigProvider()
    ...
    @Test
    fun testClientMismatchReturnsSuccess() =
        runTest {
            val storage = InMemoryOAuth2BackingStorageImpl()
            val tokenStorage = InMemoryTokenStorageImpl(storage)
            val configProvider = createConfigProvider()
    ...
    @Test
    fun testRevocationDisabledReturnsError() =
        runTest {
            val storage = InMemoryOAuth2BackingStorageImpl()
            val tokenStorage = InMemoryTokenStorageImpl(storage)
    ...
    @Test
    fun testRevokeWithAccessTokenHintFindsRefreshToken() =
        runTest {
            val storage = InMemoryOAuth2BackingStorageImpl()
            val tokenStorage = InMemoryTokenStorageImpl(storage)
            val configProvider = createConfigProvider()
