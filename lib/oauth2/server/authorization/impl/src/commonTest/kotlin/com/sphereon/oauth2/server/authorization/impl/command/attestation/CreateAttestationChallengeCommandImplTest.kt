...
class CreateAttestationChallengeCommandImplTest {
    ...
    @Test
    fun testGenerateChallenge() = runTest {
    ...
    @Test
    fun testGenerateUniqueChallenges() = runTest {
    ...
    @Test
    fun testChallengeCanBeConsumed() = runTest {
        val result = command.execute(CreateAttestationChallengeArgs())
        assertTrue(result.isOk)
    ...
    @Test
    fun testChallengeCannotBeReused() = runTest {
        val result = command.execute(CreateAttestationChallengeArgs())
        assertTrue(result.isOk)
        val challenge = result.value.attestationChallenge
    ...
    @Test
    fun testUnknownChallengeFails() = runTest {
