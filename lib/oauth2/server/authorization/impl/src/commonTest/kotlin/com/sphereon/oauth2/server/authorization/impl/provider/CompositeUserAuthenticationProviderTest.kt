...
class CompositeUserAuthenticationProviderTest {
    ...
    @Test
    fun initiateAuthWithOid4vpLoginHintRoutesToWallet() = runTest {
    ...
    @Test
    fun initiateAuthWithoutLoginHintRoutesToFederation() = runTest {
    ...
    @Test
    fun initiateAuthWithNonOid4vpLoginHintRoutesToFederation() = runTest {
    ...
    @Test
    fun getAuthenticatedUserTriesWalletFirst() = runTest {
    ...
    @Test
    fun getAuthenticatedUserFallsToFederationWhenWalletReturnsNull() = runTest {
        val walletNoUser = StubAuthProvider(authenticatedUser = null)
        val comp = CompositeUserAuthenticationProvider(
            federationProvider = federationProvider,
    ...
    @Test
    fun getAuthenticatedUserWithNoWalletProviderUsesFederation() = runTest {
        val comp = CompositeUserAuthenticationProvider(
            federationProvider = federationProvider,
            walletProvider = null
        )
    ...
    @Test
    fun getAuthenticatedUserUsesKnownProviderAfterInitiate() = runTest {
    ...
    @Test
    fun getUserInfoTriesWalletFirstThenFederation() = runTest {
    ...
    @Test
    fun getUserInfoFallsToFederationWhenWalletErrors() = runTest {
    ...
    @Test
    fun customMethodDelegatesToWallet() = runTest {
    ...
    @Test
    fun oauthMethodDelegatesToFederation() = runTest {
    ...
    @Test
    fun customMethodReturnsFalseWithNoWalletProvider() = runTest {
        val comp = CompositeUserAuthenticationProvider(
            federationProvider = federationProvider,
            walletProvider = null
        )
    ...
    @Test
    fun logoutDelegatesToBothProviders() = runTest {
