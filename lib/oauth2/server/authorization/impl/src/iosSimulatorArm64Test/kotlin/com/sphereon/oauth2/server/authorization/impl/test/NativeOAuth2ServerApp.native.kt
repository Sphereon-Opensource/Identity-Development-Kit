...
abstract class NativeOAuth2ServerTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeOAuth2ServerTestAppComponent
    }
}

fun createNativeOAuth2ServerTestAppComponent(
    application: Any,
    appId: String = "oauth2-server-test",
    profile: String = "console-log-profile",
    version: String = "test-version",
): NativeOAuth2ServerTestAppComponent {
    val component = createGraphFactory<NativeOAuth2ServerTestAppComponent.Factory>().create(
