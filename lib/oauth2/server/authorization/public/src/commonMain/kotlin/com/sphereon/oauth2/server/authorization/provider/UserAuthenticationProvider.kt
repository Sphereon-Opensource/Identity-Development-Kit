...
interface UserAuthenticationProvider {
    ...
    suspend fun logout(
        userId: String
    ): IdkResult<Unit, AuthenticationError>
     ...
     */
    suspend fun isAuthenticationMethodAvailable(
...
data class AuthenticatedUser(
     ...
     */
    val authenticatedAt: kotlinx.datetime.Instant,
...
sealed interface AuthenticationError {
    ...
    data class AccountLocked(
        val userId: String,
        val unlockAt: kotlinx.datetime.Instant?,
