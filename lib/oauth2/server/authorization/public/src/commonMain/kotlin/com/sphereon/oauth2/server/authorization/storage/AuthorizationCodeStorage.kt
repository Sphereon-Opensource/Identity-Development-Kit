...
interface AuthorizationCodeStorage {
     ...
     */
    suspend fun revokeCodesForClient(clientId: String): IdkResult<Int, AuthorizationServerError.StorageError>
     ...
     */
    suspend fun findCodesBySubject(subject: String): IdkResult<List<AuthorizationCodeData>, AuthorizationServerError.StorageError>
}
