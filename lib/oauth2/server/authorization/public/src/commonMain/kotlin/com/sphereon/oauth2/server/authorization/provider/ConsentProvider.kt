...
interface ConsentProvider {
     ...
     */
    suspend fun storeConsent(decision: ConsentDecision): IdkResult<Unit, ConsentError>
     ...
     */
    suspend fun listUserConsents(userId: String): IdkResult<List<ConsentDecision>, ConsentError>
     ...
     */
    suspend fun getConsentExpirationPolicy(scopes: List<String>): IdkResult<Int?, ConsentError>
     ...
     */
    suspend fun validateConsentDecision(decision: ConsentDecision): IdkResult<Boolean, ConsentError>
}
