...
interface NonceStorage {
     ...
     */
    suspend fun generateNonce(expiresAt: Instant): IdkResult<String, AuthorizationServerError.StorageError>
     ...
     */
    suspend fun nonceExists(nonce: String): IdkResult<Boolean, AuthorizationServerError.StorageError>
     ...
     */
    suspend fun wasNonceUsed(nonce: String): IdkResult<Boolean, AuthorizationServerError.StorageError>
     ...
     */
    suspend fun markNonceAsUsed(nonce: String): IdkResult<Unit, AuthorizationServerError>
     ...
     */
    suspend fun verifyAndConsumeNonce(nonce: String): IdkResult<Unit, AuthorizationServerError>
     ...
     */
    suspend fun getNonceExpiration(nonce: String): IdkResult<Instant?, AuthorizationServerError.StorageError>
     ...
     * @return Success or storage error
     */
    suspend fun revokeNonce(nonce: String): IdkResult<Unit, AuthorizationServerError.StorageError>
}
