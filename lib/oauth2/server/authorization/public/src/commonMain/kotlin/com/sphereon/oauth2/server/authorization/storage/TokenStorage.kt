...
interface TokenStorage {
     ...
     */
    suspend fun findAccessTokensBySubject(
        subject: String
     ...
     * @return List of access tokens, or storage error
     */
    suspend fun findAccessTokensByClient(
        clientId: String
    ): IdkResult<List<AccessTokenData>, AuthorizationServerError.StorageError>
     ...
     */
    suspend fun findRefreshTokensBySubject(
        subject: String
     ...
     */
    suspend fun revokeAllTokensForSubject(
        subject: String
     ...
     * @return Number of tokens revoked, or storage error
     */
    suspend fun revokeAllTokensForClient(
        clientId: String
    ): IdkResult<Int, AuthorizationServerError.StorageError>
}
