...
data class JwtValidationError(
        ...
        IdkError(
            ...
            severity =
                when (type) {
                    ...
                    JwtValidationErrorType.TOKEN_NOT_YET_VALID,
                    -> IdkError.Severity.WARNING
    ...
    companion object {
        ...
        fun invalidFormat(details: String) =
            JwtValidationError(
        ...
        fun notYetValid(notBefore: Long) =
            JwtValidationError(
        ...
        fun idpConfigurationError(message: String) =
            JwtValidationError(
