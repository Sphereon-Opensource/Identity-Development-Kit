...
class JwtValidationErrorTest {
    ...
    fun testUntrustedIssuer() {
        val error = JwtValidationError.untrustedIssuer(
    ...
    fun testInvalidAudience() {
        val error = JwtValidationError.invalidAudience(
    ...
    fun testJwksUnavailable() {
        val error = JwtValidationError.jwksUnavailable(
    ...
    @Test
    fun testKeyNotFound() {
        val error = JwtValidationError.keyNotFound(
            kid = "key-123",
            issuer = "https://auth.example.com"
        )
    ...
    fun testAlgorithmNotAllowed() {
        val error = JwtValidationError.algorithmNotAllowed(
            algorithm = "none",
    ...
    fun testDiscoveryFailed() {
        val error = JwtValidationError.discoveryFailed(
            issuer = "https://auth.example.com",
            cause = "404 Not Found"
        )
    ...
    fun testValidationError() {
        val error = JwtValidationError.validationError(
