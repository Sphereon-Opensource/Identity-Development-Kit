...
abstract class WasmJsOauth2CommonTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): WasmJsOauth2CommonTestAppComponent
    }
}

fun createWasmJsOauth2CommonTestAppComponent(
    application: Any,
    appId: String = "oauth2-common-test",
    profile: String = "oauth2-common-test-profile",
    version: String = "test-version",
): WasmJsOauth2CommonTestAppComponent {
    val component = createGraphFactory<WasmJsOauth2CommonTestAppComponent.Factory>().create(
