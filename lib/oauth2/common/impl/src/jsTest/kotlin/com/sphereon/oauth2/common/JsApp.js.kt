...
abstract class JsOauth2CommonTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JsOauth2CommonTestAppComponent
    }
}

fun createJsOauth2CommonTestAppComponent(
    application: Any,
    appId: String = "oauth2-common-test",
    profile: String = "oauth2-common-test-profile",
    version: String = "test-version",
): JsOauth2CommonTestAppComponent {
    val component = createGraphFactory<JsOauth2CommonTestAppComponent.Factory>().create(
