...
expect fun createOauth2CommonTestAppComponent(testInstance: Any): AppComponent

class Oauth2CommonTestContext(sessionId: String, testInstance: Any) {
    val app: AppComponent = createOauth2CommonTestAppComponent(testInstance)
