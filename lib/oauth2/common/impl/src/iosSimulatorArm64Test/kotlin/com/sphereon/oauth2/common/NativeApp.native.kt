...
abstract class NativeOauth2CommonTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeOauth2CommonTestAppComponent
    }
}

fun createNativeOauth2CommonTestAppComponent(
    application: Any,
    appId: String = "oauth2-common-test",
    profile: String = "oauth2-common-test-profile",
    version: String = "test-version",
): NativeOauth2CommonTestAppComponent {
    val component = createGraphFactory<NativeOauth2CommonTestAppComponent.Factory>().create(
