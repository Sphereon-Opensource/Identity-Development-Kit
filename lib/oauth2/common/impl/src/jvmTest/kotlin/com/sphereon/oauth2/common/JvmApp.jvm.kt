...
/**
 * Test App Component for OAuth2 Common tests
 * Provides dependency injection for testing OAuth2 common functionality
 */
@DependencyGraph(AppScope::class)
abstract class JvmOauth2CommonTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JvmOauth2CommonTestAppComponent
    }
}

fun createJvmOauth2CommonTestAppComponent(
    application: Any,
    appId: String = application.javaClass.name ?: "<unknown>",
    profile: String = "oauth2-common-test-profile",
    version: String = "test-version",
): JvmOauth2CommonTestAppComponent {
    val component = createGraphFactory<JvmOauth2CommonTestAppComponent.Factory>().create(
