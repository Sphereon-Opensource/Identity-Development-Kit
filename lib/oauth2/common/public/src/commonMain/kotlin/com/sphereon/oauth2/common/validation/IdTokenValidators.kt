 ...
 */
val validateIdTokenPayload = Validation<IdTokenPayload> {
 ...
 */
fun isIdTokenExpired(exp: Long, clockSkewSeconds: Long = 60): Boolean {
 ...
 */
fun isIdTokenIssuedAtValid(iat: Long, clockSkewSeconds: Long = 60): Boolean {
    val now = Clock.System.now().epochSeconds
 ...
 */
fun isAuthenticationFresh(authTime: Long, maxAge: Long, clockSkewSeconds: Long = 60): Boolean {
    val now = Clock.System.now().epochSeconds
 ...
 */
fun validateAudience(aud: List<String>, expectedAudience: String): Boolean {
 ...
 */
fun validateAtHash(accessToken: String, atHash: String, algorithm: String): Boolean {
 ...
 */
fun validateCHash(code: String, cHash: String, algorithm: String): Boolean {
    // Implementation is in ValidateIdTokenCommand which has crypto library access
