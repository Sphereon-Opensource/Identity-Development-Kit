...
data class JarmConfig(
    ...
    companion object {
         ...
         */
        fun signed(algorithm: String = "ES256"): JarmConfig =
            JarmConfig(signingAlgorithm = algorithm, mode = JarmMode.SIGNED)
 ...
 */
val validateJarmConfig = Validation<JarmConfig> {
 ...
 */
val validateJarmResponsePayload = Validation<JarmResponsePayload> {
