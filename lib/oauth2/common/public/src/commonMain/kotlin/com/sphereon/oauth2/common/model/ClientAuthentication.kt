 ...
 */
@Serializable
enum class ClientAuthenticationMethod(val value: String) {
    ...
    companion object {
        fun fromValue(value: String): ClientAuthenticationMethod? {
...
data class ClientAssertion(
    val clientId: String,
    val assertionType: String,  // e.g., "urn:ietf:params:oauth:client-assertion-type:jwt-bearer"
    val assertion: String       // The JWT
)
...
sealed interface ClientAuthenticationConfig {
     ...
     */
    data class Basic(val credentials: ClientCredentials) : ClientAuthenticationConfig
     ...
     */
    data class Post(val credentials: ClientCredentials) : ClientAuthenticationConfig
     ...
     */
    data class SecretJwt(val assertion: ClientAssertion) : ClientAuthenticationConfig
     ...
     */
    data class PrivateKeyJwt(val assertion: ClientAssertion) : ClientAuthenticationConfig
     ...
     */
    data class None(val clientId: String) : ClientAuthenticationConfig
     ...
     */
    data class AttestationJwt(val attestation: ClientAttestation) : ClientAuthenticationConfig
