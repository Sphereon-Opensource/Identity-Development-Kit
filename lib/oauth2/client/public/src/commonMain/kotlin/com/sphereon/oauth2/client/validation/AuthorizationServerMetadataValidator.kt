 ...
 */
val validateAuthorizationServerMetadata =
    Validation<AuthorizationServerMetadata> {
        // Required fields
        ...
        constrain(
            "introspection_endpoint_auth_signing_alg_values_supported must be defined if introspection_endpoint_auth_methods_supported contains 'private_key_jwt' or 'client_secret_jwt'",
        ) { metadata ->
