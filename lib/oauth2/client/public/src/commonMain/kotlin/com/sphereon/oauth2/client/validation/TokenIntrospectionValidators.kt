 ...
 */
val validateJwtConfirmation = Validation<JwtConfirmation> {
 ...
 */
val validateTokenIntrospectionRequest = Validation<TokenIntrospectionRequest> {
 ...
 */
val validateTokenIntrospectionResponse = Validation<TokenIntrospectionResponse> {
