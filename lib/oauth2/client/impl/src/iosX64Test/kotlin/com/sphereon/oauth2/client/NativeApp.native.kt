...
abstract class NativeOauth2TestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeOauth2TestAppComponent
    }
}

fun createNativeOauth2TestAppComponent(
    application: Any,
    appId: String = "oauth2-client-test",
    profile: String = "console-log-profile",
    version: String = "test-version",
): NativeOauth2TestAppComponent {
    val component = createGraphFactory<NativeOauth2TestAppComponent.Factory>().create(
