...
abstract class NativeOauth2TestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): NativeOauth2TestAppGraph
    }
}

fun createNativeOauth2TestAppGraph(
    application: Any,
    ...
    val graph =
        createGraphFactory<NativeOauth2TestAppGraph.Factory>().create(
