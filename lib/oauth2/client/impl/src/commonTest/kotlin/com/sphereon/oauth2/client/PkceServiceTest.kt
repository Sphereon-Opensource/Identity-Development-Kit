...
class PkceServiceTest {
    ...
    @Test
    fun testCreatePkceWithS256Method() = runTest {
        val pkceService = createPkceService()

        // Generate PKCE data with S256 method
        val result = pkceService.createPkce(
    ...
    @Test
    fun testCreatePkceWithPlainMethod() = runTest {
        val pkceService = createPkceService()
    ...
    @Test
    fun testCreatePkceWithCustomVerifier() = runTest {
        val pkceService = createPkceService()
    ...
    @Test
    fun testVerifyPkceS256Success() = runTest {
        val pkceService = createPkceService()

        // First create PKCE data
        val createResult = pkceService.createPkce(
            CreatePkceArgs(codeVerifier = null, allowedMethods = listOf(PkceMethod.S256))
        )
    ...
    @Test
    fun testVerifyPkceS256Failure() = runTest {
        val pkceService = createPkceService()
    ...
    @Test
    fun testVerifyPkcePlainSuccess() = runTest {
        val pkceService = createPkceService()
    ...
    @Test
    fun testCreatePkceFailsWithNoAllowedMethods() = runTest {
        val pkceService = createPkceService()
    ...
    @Test
    fun testCreatePkcePreferS256OverPlain() = runTest {
        val pkceService = createPkceService()
    ...
    @Test
    fun testVerifyPkceWithShortVerifierFails() = runTest {
        val pkceService = createPkceService()
        ...
        val verifyResult = pkceService.verifyPkce(
            VerifyPkceArgs(
                ...
                codeChallenge = "any_challenge", method = PkceMethod.S256
            )
        )
    ...
    @Test
    fun testVerifyPkceWithLongVerifierFails() = runTest {
        val pkceService = createPkceService()
        ...
        val verifyResult = pkceService.verifyPkce(
            VerifyPkceArgs(
                codeVerifier = tooLongVerifier, codeChallenge = "any_challenge", method = PkceMethod.S256
            )
        )
    ...
    @Test
    fun testCommandAccessViaService() = runTest {
        val pkceService = createPkceService()
        ...
        val commandResult = pkceService.commands.createPkce.execute(
            CreatePkceArgs(codeVerifier = null, allowedMethods = listOf(PkceMethod.S256))
        )
