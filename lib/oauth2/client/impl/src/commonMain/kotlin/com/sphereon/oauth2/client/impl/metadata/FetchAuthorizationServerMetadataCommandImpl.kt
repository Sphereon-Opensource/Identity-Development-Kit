...
class FetchAuthorizationServerMetadataCommandImpl(
    ...
    private suspend fun fetchAuthorizationServerMetadataInternal(issuer: String): IdkResult<AuthorizationServerMetadata, MetadataError> {
        ...
        val issuerUrl = try {
            ...
            val protocolEnd = if (normalizedIssuer.startsWith("https://")) 8 else 7 // After "https://" or "http://"
        ...
        if (legacyOauthServerWellKnownUrl != oauthServerWellKnownUrl) {
            ...
            when {
                legacyResult is Ok -> return validateAndCheckIssuer(legacyResult.value, issuer, legacyOauthServerWellKnownUrl)
        ...
        when {
            openIdResult is Ok -> return validateAndCheckIssuer(openIdResult.value, issuer, openIdConfigurationUrl)
    ...
    private fun validateAndCheckIssuer(
        ...
        val validationResult = validateAuthorizationServerMetadata(metadata).toIdkResult { errors ->
