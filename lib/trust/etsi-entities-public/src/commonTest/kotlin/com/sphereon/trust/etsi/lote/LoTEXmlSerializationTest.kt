...
class LoTEXmlSerializationTest {
    ...
    fun testXmlRoundTrip() {
        ...
        assertEquals("BASE64CERTDATA", service.serviceInformation.serviceDigitalIdentity.x509Certificates[0].value)
    }
    ...
    fun testXmlDigitalIdentityMultipleFieldsRoundTrip() {
        ...
        val identity = parsed.trustedEntitiesList[0].trustedEntityServices[0].serviceInformation.serviceDigitalIdentity
    ...
    private fun createMinimalLoTE(): LoTE = LoTE(
    ...
    private fun createSampleLoTE(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 42,
            type = LoTEType.EU_PID_PROVIDERS,
            schemeOperatorName = listOf(
            ...
            TrustedEntity(
                ...
                trustedEntityServices = listOf(
                    TrustedEntityService(
                        serviceInformation = LoTEServiceInformation(
    ...
    private fun createLoTEWithAddress(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
    ...
    private fun createLoTEWithPointers(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            ...
            pointersToOtherLoTE = listOf(
                OtherLoTEPointer(
                    ...
                    serviceDigitalIdentities = listOf(
    ...
    private fun createLoTEWithPolicy(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
            policyOrLegalNotice = listOf(
    ...
    private fun createLoTEWithServiceHistory(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
    ...
    private fun createLoTEWithDistributionPoints(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
            distributionPoints = listOf(
    ...
    private fun createLoTEWithServiceSupplyPoints(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
    ...
    private fun createLoTEWithServiceDefinitionURIs(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
    ...
    private fun createLoTEWithFullDigitalIdentity(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
    ...
    private fun createLoTEWithFullEntityInfo(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
    ...
    private fun createLoTEWithHistoricalPeriod(): LoTE = LoTE(
        listAndSchemeInformation = ListAndSchemeInformation(
            versionIdentifier = 1,
            sequenceNumber = 1,
            schemeOperatorName = listOf(MultiLangString("en", "Test")),
