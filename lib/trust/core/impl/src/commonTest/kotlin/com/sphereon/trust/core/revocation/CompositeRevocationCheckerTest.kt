...
class CompositeRevocationCheckerTest {
    ...
    private val unavailableOcsp = object : OCSPChecker {
    ...
    private val unavailableCrl = object : CRLChecker {
    ...
    private fun createTestExecution(): SessionExecution = TestSessionExecution(
        createAnonymousSessionContext("revocation-test")
    )

    @Test
    fun returnsGoodWhenCheckersUnavailableAndNotFailOnUnknown() = runTest {
        val checker = CompositeRevocationChecker(
            ocspChecker = unavailableOcsp,
            crlChecker = unavailableCrl,
            execution = createTestExecution()
        )
        val result = checker.checkRevocation(
    ...
    @Test
    fun returnsUnavailableWhenCheckersUnavailableAndFailOnUnknown() = runTest {
        val checker = CompositeRevocationChecker(
            ocspChecker = unavailableOcsp,
            crlChecker = unavailableCrl,
            execution = createTestExecution()
    ...
    @Test
    fun delegatesToOcspCheckerWhenAvailable() = runTest {
        val mockOcsp = object : OCSPChecker {
            override suspend fun checkOCSP(
                certificate: ByteArray,
                issuerCertificate: ByteArray?,
                options: RevocationCheckOptions
    ...
    @Test
    fun fallsThroughToCrlWhenOcspUnavailable() = runTest {
        val mockCrl = object : CRLChecker {
            override suspend fun checkCRL(
                certificate: ByteArray,
                options: RevocationCheckOptions
            ) = RevocationCheckResult(
    ...
    @Test
    fun respectsPreferCrlOrder() = runTest {
        val mockCrl = object : CRLChecker {
            override suspend fun checkCRL(
                certificate: ByteArray,
                options: RevocationCheckOptions
    ...
    @Test
    fun reportsRevokedStatus() = runTest {
        val mockOcsp = object : OCSPChecker {
            override suspend fun checkOCSP(
                certificate: ByteArray,
                issuerCertificate: ByteArray?,
    ...
    @Test
    fun handlesOcspException() = runTest {
        val throwingOcsp = object : OCSPChecker {
            override suspend fun checkOCSP(
                certificate: ByteArray,
                issuerCertificate: ByteArray?,
                options: RevocationCheckOptions
