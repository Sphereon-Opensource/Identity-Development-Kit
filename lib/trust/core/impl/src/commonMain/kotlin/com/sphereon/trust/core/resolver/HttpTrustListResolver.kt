...
class HttpTrustListResolver(
    ...
    private val cache by lazy {
        cacheService.getCache(
            com.sphereon.core.api.cache.CacheRequirements(
                ...
                ttlConfig =
                    com.sphereon.core.api.cache
                        .CacheTtlConfig(app = 60.minutes),
            ),
        )
    }
    ...
    override suspend fun resolve(
        ...
        try {
            ...
            logger.error("Failed to resolve trust list from $uri", exception = expected)
            throw TrustListResolutionException("Failed to resolve trust list from $uri", expected)
        }
    }
