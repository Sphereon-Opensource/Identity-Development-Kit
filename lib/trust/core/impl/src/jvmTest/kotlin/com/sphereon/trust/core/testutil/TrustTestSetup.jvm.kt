...
abstract class JvmTrustTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JvmTrustTestAppComponent
    }
}

fun createJvmTrustTestAppComponent(
    application: Any,
    appId: String = application.javaClass.name ?: "<unknown>",
    profile: String = "console-log-profile",
    version: String = "version-example",
): JvmTrustTestAppComponent {
    val component = createGraphFactory<JvmTrustTestAppComponent.Factory>().create(
...
actual fun createTrustTestAppComponent(testInstance: Any): AppComponent {
    return createJvmTrustTestAppComponent(testInstance)
}
