        ...
        return try {
            ...
            Ok(
                TrustValidationResult(
                    ...
                    details = "X.509 validation failed: ${e.message}",
...
interface X509TrustCommandDescriptors {
    @Provides @IntoSet
    fun validateX509Trust(impl: Lazy<ValidateX509TrustCommandImpl>): RegistrableServiceCommandDescriptor =
        RegistrableServiceCommandDescriptor.of(ValidateX509TrustCommand.COMMAND_ID) { impl.value }
}
