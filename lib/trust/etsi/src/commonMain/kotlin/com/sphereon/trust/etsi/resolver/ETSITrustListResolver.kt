...
class ETSITrustListResolver(
    ...
    suspend fun resolve(
        ...
        val resolver =
            resolvers.firstOrNull { it.supports(uri) }
     ...
     */
    suspend fun resolveEULOTL(options: ResolutionOptions = ResolutionOptions()): TrustListData = resolve(getWellKnownTrustLists()["EU"]!!, options)
}
