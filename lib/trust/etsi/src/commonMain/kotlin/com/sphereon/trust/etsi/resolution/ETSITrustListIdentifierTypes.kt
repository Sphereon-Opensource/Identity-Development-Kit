...
data class ExternalIdentifierETSITslResult(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (identifierOpts != other.identifierOpts) return false
        if (trustList != other.trustList) return false
        if (trustAnchors != other.trustAnchors) return false
        if (!jwks.contentEquals(other.jwks)) return false
...
data class ExternalIdentifierETSITspResult(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (identifierOpts != other.identifierOpts) return false
        if (tspName != other.tspName) return false
        ...
        if (validationPath != other.validationPath) return false
        return true
    }
...
object ETSIIdentifierOptsGuards {
    ...
    fun asETSITspOpts(opts: ExternalIdentifierOpts): ExternalIdentifierETSITspOpts {
        return require(isETSITspOpts(opts)) {
...
object ETSIIdentifierResultGuards {
    ...
    fun asETSITslResult(result: ExternalIdentifierResult): ExternalIdentifierETSITslResult {
        return require(isETSITslResult(result)) {
    ...
    fun asETSITspResult(result: ExternalIdentifierResult): ExternalIdentifierETSITspResult {
        return require(isETSITspResult(result)) {
