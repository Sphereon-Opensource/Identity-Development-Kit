...
object ETSIValidationIdentifierMethod {
     ...
     */
    val X509_ETSI_VALIDATION = object : com.sphereon.crypto.resolution.IIdentifierMethod {
...
data class ExternalIdentifierX509ETSIValidationResult(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (trustListInfo != other.trustListInfo) return false
        if (matchedTSP != other.matchedTSP) return false
        if (!jwks.contentEquals(other.jwks)) return false
        if (keyInfo != other.keyInfo) return false
        if (validatedAt != other.validatedAt) return false
        return true
    }
...
object X509ETSIValidationOptsGuards {
    fun isX509ETSIValidationOpts(opts: ExternalIdentifierOpts): Boolean {
        return opts is ExternalIdentifierX509ETSIValidationOpts ||
    ...
    fun asX509ETSIValidationOpts(opts: ExternalIdentifierOpts): ExternalIdentifierX509ETSIValidationOpts {
        return require(isX509ETSIValidationOpts(opts)) {
...
object X509ETSIValidationResultGuards {
    fun isX509ETSIValidationResult(result: ExternalIdentifierResult): Boolean {
        return result is ExternalIdentifierX509ETSIValidationResult ||
    ...
    fun asX509ETSIValidationResult(result: ExternalIdentifierResult): ExternalIdentifierX509ETSIValidationResult {
        return require(isX509ETSIValidationResult(result)) {
