...
data class CertDigest(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (!digestValue.contentEquals(other.digestValue)) {
            return false
        }
        if (issuerSerialV2 != null) {
            if (other.issuerSerialV2 == null) {
                return false
            }
            if (!issuerSerialV2.contentEquals(other.issuerSerialV2)) {
                return false
            }
        } else if (other.issuerSerialV2 != null) {
            return false
        }
        return true
    }
