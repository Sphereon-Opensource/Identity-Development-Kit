...
abstract class JsEtsiTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JsEtsiTestAppComponent
    }
}

fun createJsEtsiTestAppComponent(
    application: Any,
    appId: String = "test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): JsEtsiTestAppComponent {
    val component = createGraphFactory<JsEtsiTestAppComponent.Factory>().create(
...
actual fun createEtsiTestAppComponent(testInstance: Any): AppComponent {
    return createJsEtsiTestAppComponent("test")
}
