...
abstract class NativeEtsiTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeEtsiTestAppComponent
    }
}

fun createNativeEtsiTestAppComponent(
    application: Any,
    appId: String = "test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): NativeEtsiTestAppComponent {
    val component = createGraphFactory<NativeEtsiTestAppComponent.Factory>().create(
