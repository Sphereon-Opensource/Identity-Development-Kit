...
abstract class JvmEtsiTestAppGraph : AbstractAppGraph() {
...
actual fun createEtsiTestAppGraph(testInstance: Any): AppGraph = createJvmEtsiTestAppGraph(testInstance)
