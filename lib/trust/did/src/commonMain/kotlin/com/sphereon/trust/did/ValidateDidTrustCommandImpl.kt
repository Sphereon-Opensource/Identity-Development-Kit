...
class ValidateDidTrustCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        return try {
            ...
            val identifier =
                if (applied.identifierJson != null) {
            ...
            val effectiveIdentifier =
                identifier
                    ?: com.sphereon.crypto.resolution.extern
                        .ExternalIdentifierDidOpts(identifier = applied.did)
            ...
            Ok(
                TrustValidationResult(
                    ...
                    details = "DID trust validation failed: ${expected.message}",
