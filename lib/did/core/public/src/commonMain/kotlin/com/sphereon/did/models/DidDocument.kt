...
data class DidDocument(
    ...
    fun getVerificationMethodsForPurpose(purpose: VerificationPurpose): List<VerificationMethod> {
        val relationships = when (purpose) {
    ...
    fun getVerificationMethodsByPurpose(): Map<VerificationPurpose, List<VerificationMethod>> {
        return VerificationPurpose.entries.associateWith { purpose ->
     ...
     */
    fun getServicesByType(type: String): List<DidService> {
        return service?.filter { it.type == type } ?: emptyList()
    }
