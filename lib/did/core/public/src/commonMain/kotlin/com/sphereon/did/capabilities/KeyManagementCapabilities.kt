...
data class KeyManagementCapabilities(
    ...
    companion object {
         ...
         */
        val ED25519: KeyTypeCapability = KeyTypeCapability(
         ...
         */
        val X25519: KeyTypeCapability = KeyTypeCapability(
            keyType = KeyTypeMapping.OKP,
            curve = Curve.X25519,
         ...
         */
        val SECP256K1: KeyTypeCapability = KeyTypeCapability(
         ...
         */
        val P256: KeyTypeCapability = KeyTypeCapability(
            keyType = KeyTypeMapping.EC,
            curve = Curve.P_256,
         ...
         */
        val P384: KeyTypeCapability = KeyTypeCapability(
            keyType = KeyTypeMapping.EC,
            curve = Curve.P_384,
         ...
         */
        val P521: KeyTypeCapability = KeyTypeCapability(
            keyType = KeyTypeMapping.EC,
            curve = Curve.P_521,
         ...
         */
        val RSA: KeyTypeCapability = KeyTypeCapability(
     ...
     */
    fun supportsKeyType(keyType: KeyTypeMapping, curve: Curve?): Boolean {
        return supportedKeyTypes.any { capability ->
