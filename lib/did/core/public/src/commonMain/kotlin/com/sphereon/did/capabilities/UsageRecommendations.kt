...
data class UsageRecommendations(
    ...
    companion object {
         ...
         */
        val EPHEMERAL_PERSONAL: UsageRecommendations = UsageRecommendations(
            naturalPersons = true,
            organizations = false,
            ephemeral = true,
            longLived = false
         ...
         */
        val ORGANIZATIONAL: UsageRecommendations = UsageRecommendations(
         ...
         */
        val GENERAL: UsageRecommendations = UsageRecommendations(
            naturalPersons = true,
            organizations = true,
            ephemeral = true,
            longLived = true
