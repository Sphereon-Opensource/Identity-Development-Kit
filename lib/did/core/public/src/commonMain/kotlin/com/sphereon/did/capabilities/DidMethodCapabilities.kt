...
data class DidMethodCapabilities(
    ...
    companion object {
         ...
         */
        val KEY: DidMethodCapabilities = DidMethodCapabilities(
            method = "key",
         ...
         */
        val JWK: DidMethodCapabilities = DidMethodCapabilities(
            method = "jwk",
            lifecycle = LifecycleCapabilities.IMMUTABLE,
            keyManagement = KeyManagementCapabilities(
                addition = false,
         ...
         */
        val WEB: DidMethodCapabilities = DidMethodCapabilities(
            method = "web",
         ...
         */
        val UNIVERSAL_RESOLVER: DidMethodCapabilities = DidMethodCapabilities(
            method = "*",
