...
class DidProviderRegistryImpl(
    ...
    override fun getProvider(method: String): DidProvider? {
        return providersByMethod[method]
    }

    override fun getCapabilities(method: String): DidMethodCapabilities? {
        return providersByMethod[method]?.capabilities
    }

    override fun getSupportedMethods(): List<String> {
        return providersByMethod.keys.toList()
    }
}
