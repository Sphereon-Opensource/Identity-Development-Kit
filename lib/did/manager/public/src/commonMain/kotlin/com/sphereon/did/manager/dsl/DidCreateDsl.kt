...
class AutoGenerateKeyBuilder {
    ...
    fun build(): KeyConfig.AutoGenerate = KeyConfig.AutoGenerate(
...
class ExistingKeyByAliasBuilder {
    ...
    fun build(): KeyConfig.ExistingKeyByAlias = KeyConfig.ExistingKeyByAlias(
 ...
 */
@DidCreationDsl
class VerificationMethodBuilder(private val id: String) {
 ...
 */
@DidCreationDsl
class ServiceBuilder(private val id: String) {
    ...
    fun build(): DidService = DidService(
        id = id,
...
class DidCreateBuilder {
     ...
     * Use this for simple DIDs with a single key.
     */
    fun useExistingKey(jwk: Jwk, block: (KeyConfig.ExistingJwk.() -> Unit)? = null) {
     ...
     */
    fun verificationMethod(id: String, block: VerificationMethodBuilder.() -> Unit) {
     ...
     */
    fun service(id: String, block: ServiceBuilder.() -> Unit) {
    ...
    fun build(): DidCreationDslResult {
        ...
        val verificationMethodId = when (primaryKeyConfig) {
 ...
 */
fun didCreateOptions(block: DidCreateBuilder.() -> Unit): DidCreationDslResult =
    DidCreateBuilder().apply(block).build()
