...
interface WebvhResolverCommandDescriptors {
    @Provides
    @IntoMap
    @StringKey(FetchWebvhLogServiceCommand.COMMAND_ID)
    fun fetchLog(impl: FetchWebvhLogServiceCommandImpl): ServiceCommand<*, *, *> = impl

    @Provides
    @IntoMap
    @StringKey(ReplayWebvhLogServiceCommand.COMMAND_ID)
    fun replayLog(impl: ReplayWebvhLogServiceCommandImpl): ServiceCommand<*, *, *> = impl

    @Provides
    @IntoMap
    @StringKey(ValidateWebvhTrustServiceCommand.COMMAND_ID)
    fun validateTrust(impl: ValidateWebvhTrustServiceCommandImpl): ServiceCommand<*, *, *> = impl
}
