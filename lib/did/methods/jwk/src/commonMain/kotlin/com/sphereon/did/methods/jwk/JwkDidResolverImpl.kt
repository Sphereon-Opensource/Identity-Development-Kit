...
class JwkDidResolverImpl : JwkDidResolver {
    ...
    override suspend fun resolve(
        ...
        val jwkJson = try {
            ...
            return Err(IdkError.ILLEGAL_ARGUMENT_ERROR(
                message = "Failed to decode base64url JWK: ${e.message}"
            ))
        }
        ...
        val jwk = try {
            ...
            return Err(IdkError.ILLEGAL_ARGUMENT_ERROR(
                message = "Failed to parse JWK JSON: ${e.message}"
            ))
        }
     ...
     * - "enc": keyAgreement
     */
    private fun buildDidDocument(did: String, jwk: Jwk): DidDocument {
     ...
     */
    private fun getJwkUse(jwk: Jwk): String? {
        return jwk.use
    }

    @ContributesTo(SessionScope::class)
    interface Component : JwkDidResolver.Component {
