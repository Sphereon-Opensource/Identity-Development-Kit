...
class WebDidProviderImpl : DidProvider {
    ...
    override suspend fun addKey(
        ...
        val newAuthentication =
            if (purposes.contains(VerificationPurpose.AUTHENTICATION)) {
                (currentDocument.authentication ?: emptyList()) + ref
            } else {
                currentDocument.authentication
            }

        val newAssertionMethod =
            if (purposes.contains(VerificationPurpose.ASSERTION_METHOD)) {
        ...
        val newKeyAgreement =
            if (purposes.contains(VerificationPurpose.KEY_AGREEMENT)) {
