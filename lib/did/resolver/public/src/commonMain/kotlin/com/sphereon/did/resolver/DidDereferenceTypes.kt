...
data class DidDereferencingMetadata(
    ...
    companion object {
         ...
         */
        fun success(contentType: String = "application/did+json"): DidDereferencingMetadata =
            DidDereferencingMetadata(contentType = contentType)

        /**
         * Creates metadata for a not-found error.
         */
        fun notFound(message: String? = null): DidDereferencingMetadata =
            DidDereferencingMetadata(error = "notFound", message = message)
    }
...
data class DidDereferenceResult(
    ...
    companion object {
         ...
         */
        fun verificationMethod(vm: VerificationMethod): DidDereferenceResult = DidDereferenceResult(
         ...
         */
        fun service(svc: DidService): DidDereferenceResult = DidDereferenceResult(
            contentType = "application/did+json",
            service = svc,
            dereferencingMetadata = DidDereferencingMetadata.success()
        )
         ...
         */
        fun document(doc: DidDocument): DidDereferenceResult = DidDereferenceResult(
            contentType = "application/did+json",
            didDocument = doc,
            dereferencingMetadata = DidDereferencingMetadata.success()
        )
         ...
         */
        fun notFound(message: String? = null): DidDereferenceResult = DidDereferenceResult(
            contentType = "application/did+json",
