...
/**
 * E2E integration tests for DID resolution through the full DI graph hierarchy.
 *
...
class DidResolverRegistryE2ETest {
    ...
    @Test
    fun testResolverRegistryDiscoversMethods() =
        runTest {
    ...
    @Test
    fun testResolveDidKeyViaRegistry() =
        runTest {
    ...
    @Test
    fun testResolveDidKeyViaSpecificInterface() =
        runTest {
    ...
    @Test
    fun testResolveDidJwkViaRegistry() =
        runTest {
    ...
    @Test
    fun testResolveDidJwkViaSpecificInterface() =
        runTest {
            val did = "did:jwk:eyJrdHkiOiJPS1AiLCJjcnYiOiJFZDI1NTE5IiwieCI6IlFfX0xNZXVFUjZNMjRUNFREYkdBSTZoTFlnbXFKSlB2Y1RfODdyNFlXcXMifQ"
    ...
    @Test
    fun testRegistryRejectsUnsupportedMethod() =
        runTest {
    ...
    @Test
    fun testDereferenceVerificationMethod() =
        runTest {
            val did = "did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK"
