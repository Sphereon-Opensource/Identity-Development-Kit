...
abstract class JsDidResolverTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JsDidResolverTestAppComponent
    }
}

fun createJsDidResolverTestAppComponent(
    application: Any,
    appId: String = "did-resolver-test",
    profile: String = "console-log-profile",
    version: String = "0.13.0-test",
): JsDidResolverTestAppComponent {
    val component = createGraphFactory<JsDidResolverTestAppComponent.Factory>().create(
