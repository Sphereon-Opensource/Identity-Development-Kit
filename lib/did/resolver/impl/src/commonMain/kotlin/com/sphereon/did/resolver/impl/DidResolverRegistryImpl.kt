...
class DidResolverRegistryImpl(
    ...
    override fun getResolver(method: String): DidResolver? = resolversByMethod[method]

    override fun getSupportedMethods(): List<String> = resolversByMethod.keys.toList()

    override fun getCapabilities(method: String): DidMethodCapabilities? = resolversByMethod[method]?.capabilities

    override fun hasResolver(method: String): Boolean = resolversByMethod.containsKey(method)
