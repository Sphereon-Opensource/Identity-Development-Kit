...
class ResolveVerificationMethodsByPurposeCommandImpl(
    ...
    ResolveVerificationMethodsByPurposeCommand,
    ResolveVerificationMethodsByPurposeCommandService {
    override val commandId: String get() = ResolveVerificationMethodsByPurposeCommand.COMMAND_ID

    override suspend fun resolveVerificationMethodsByPurpose(args: ResolveVerificationMethodsByPurposeArgs): IdkResult<List<VerificationMethod>, IdkError> = execute(args)
