...
class ResolveVerificationMethodCommandImpl(
...
), ResolveVerificationMethodCommand, ResolveVerificationMethodCommandService, VerificationMethodKeyResolver {

    override val commandId: String get() = ResolveVerificationMethodCommand.COMMAND_ID

    override suspend fun resolveVerificationMethod(
    ...
    override suspend fun doExecute(
        ...
        val vm = result.didDocument?.getVerificationMethodById(kid)
            ?: return Err(IdkError.NOT_FOUND_ERROR(
