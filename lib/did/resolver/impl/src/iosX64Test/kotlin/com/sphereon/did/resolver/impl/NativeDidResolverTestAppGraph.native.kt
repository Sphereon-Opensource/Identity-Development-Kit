...
abstract class NativeDidResolverTestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): NativeDidResolverTestAppGraph
    }
}

fun createNativeDidResolverTestAppGraph(
    application: Any,
    ...
    val graph =
        createGraphFactory<NativeDidResolverTestAppGraph.Factory>().create(
