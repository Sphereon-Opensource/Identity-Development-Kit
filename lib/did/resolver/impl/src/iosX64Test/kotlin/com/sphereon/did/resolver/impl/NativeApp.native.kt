...
abstract class NativeDidResolverTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeDidResolverTestAppComponent
    }
}

fun createNativeDidResolverTestAppComponent(
    application: Any,
    appId: String = "did-resolver-test",
    profile: String = "console-log-profile",
    version: String = "0.13.0-test",
): NativeDidResolverTestAppComponent {
    val component = createGraphFactory<NativeDidResolverTestAppComponent.Factory>().create(
