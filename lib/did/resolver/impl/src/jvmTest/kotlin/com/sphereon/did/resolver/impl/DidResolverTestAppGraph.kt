...
/**
 * Test app graph for DID resolver E2E testing.
 *
...
abstract class DidResolverTestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): DidResolverTestAppGraph
    }
}

fun createDidResolverTestAppGraph(
    application: Any,
    ...
    val graph =
        createGraphFactory<DidResolverTestAppGraph.Factory>().create(
