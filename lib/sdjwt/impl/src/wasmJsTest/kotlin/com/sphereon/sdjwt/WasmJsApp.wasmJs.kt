...
abstract class WasmJsSdJwtTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): WasmJsSdJwtTestAppComponent
    }
}

fun createWasmJsSdJwtTestAppComponent(
    application: Any,
    appId: String = "sdjwt-test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): WasmJsSdJwtTestAppComponent {
    val component = createGraphFactory<WasmJsSdJwtTestAppComponent.Factory>().create(
