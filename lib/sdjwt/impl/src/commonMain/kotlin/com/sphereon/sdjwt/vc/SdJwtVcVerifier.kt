...
internal class SdJwtVcVerifierImpl(
    ...
    override suspend fun verify(
        ...
        val issuerMetadata = if (issuer != null) {
        ...
        val typeMetadata = if (opts.validateTypeMetadata) {
            ...
            when (val result = resolveTypeMetadata(vct, opts)) {
                is TypeMetadataResolutionResult.Success -> result.metadata
        ...
        if (typeMetadata != null) {
            val claimErrors = validateClaimRequirements(
    ...
    private suspend fun resolveTypeMetadata(
        ...
        val resolver = opts.typeMetadataResolver
    ...
    private suspend fun resolveIssuerMetadata(
        ...
        val resolver = opts.issuerMetadataResolver
    ...
    private fun checkStatus(payload: JsonObject): SdJwtVcVerificationError? {
