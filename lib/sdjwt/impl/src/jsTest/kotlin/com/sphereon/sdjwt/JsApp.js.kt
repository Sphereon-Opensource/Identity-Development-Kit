...
abstract class JsSdJwtTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JsSdJwtTestAppComponent
    }
}

fun createJsSdJwtTestAppComponent(
    application: Any,
    appId: String = "sdjwt-test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): JsSdJwtTestAppComponent {
    val component = createGraphFactory<JsSdJwtTestAppComponent.Factory>().create(
