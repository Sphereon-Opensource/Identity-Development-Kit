...
abstract class NativeSdJwtTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): NativeSdJwtTestAppComponent
    }
}

fun createNativeSdJwtTestAppComponent(
    application: Any,
    appId: String = "sdjwt-test",
    profile: String = "console-log-profile",
    version: String = "version-example",
): NativeSdJwtTestAppComponent {
    val component = createGraphFactory<NativeSdJwtTestAppComponent.Factory>().create(
