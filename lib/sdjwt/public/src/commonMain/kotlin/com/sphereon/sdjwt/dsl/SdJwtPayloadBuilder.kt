...
class SdJwtPayloadBuilder {
     ...
     */
    @JsName("claimString")
    fun claim(name: String, value: String) = apply { jwtBuilder.claim(name, value) }
     ...
     */
    @JsName("claimNumber")
    fun claim(name: String, value: Number) = apply { jwtBuilder.claim(name, value) }
     ...
     */
    @JsName("claimBoolean")
    fun claim(name: String, value: Boolean) = apply { jwtBuilder.claim(name, value) }
    ...
    fun claim(name: String, value: JsonElement) = apply { jwtBuilder.claim(name, value) }
    ...
    fun claimSd(name: String, value: String) = apply {
    ...
    fun claimSd(name: String, value: Number) = apply {
        jwtBuilder.claim(name, value)
        sdClaims += name
    }
    ...
    fun claimSd(name: String, value: Boolean) = apply {
        jwtBuilder.claim(name, value)
        sdClaims += name
    }
    ...
    fun claimSd(name: String, value: JsonElement) = apply {
        jwtBuilder.claim(name, value)
        sdClaims += name
    }
     ...
     * @return This builder for chaining
     */
    fun objSd(name: String, builder: SdJwtPayloadBuilder.() -> Unit) = apply {
     ...
     */
    fun minimumDigests(count: Int) = apply {
     ...
     */
    fun build(): SdJwtPayload = SdJwtPayload(
