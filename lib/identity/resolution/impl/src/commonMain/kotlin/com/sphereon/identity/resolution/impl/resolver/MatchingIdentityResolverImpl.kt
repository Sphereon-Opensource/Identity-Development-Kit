...
class MatchingIdentityResolverImpl(
    ...
    ): Boolean = resolverConfig?.enabled == true && resolverConfig.properties["kms-key-id"] != null
    ...
    override suspend fun resolve(
        ...
        val keyId =
            resolverConfig?.properties?.get("kms-key-id")
                ?: return Ok(IdentityResolutionResult.NOT_FOUND)
        val identifierType =
            resolverConfig.properties["identifier-type"]
