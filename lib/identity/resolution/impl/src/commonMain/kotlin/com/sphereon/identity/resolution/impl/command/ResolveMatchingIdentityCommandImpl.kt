...
class ResolveMatchingIdentityCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        val mac = generateMacCommand.execute(
            GenerateMacArgs(
        ...
        val matchResult = lookupMatchCommand.execute(
        ...
        return when (matchResult) {
            ...
            is MatchResult.NotFound -> Ok(IdentityResolutionResult.NOT_FOUND)
        }
    }

    private fun resolveDigestAlg(macAlgorithm: String): DigestAlg = when (macAlgorithm) {
