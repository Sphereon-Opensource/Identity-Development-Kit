...
@Serializable
data class ContextAttribute(val attributePath: AttributePath) : AttributeSource

@Serializable
data class PriorNodeAttribute(val nodeId: IdvNodeId, val attributePath: AttributePath) : AttributeSource

@Serializable
data class UserInputAttribute(val fieldId: InputFieldId, val fieldLabel: String) : AttributeSource
