...
class ClaimMappingServiceTest {
    ...
    @Test
    fun configDrivenMappingApplication() = runTest {
        val rawClaims: Map<String, JsonElement> = mapOf(
    ...
    @Test
    fun ownershipRules_oidcWinsForInstitutionBound() = runTest {
        val walletClaims: Map<String, JsonElement> = mapOf(
            "studentNumber" to JsonPrimitive("WALLET-123"),
            "name" to JsonPrimitive("Wallet Name")
        )
        val oidcClaims: Map<String, JsonElement> = mapOf(
    ...
    @Test
    fun walletAndOidcClaimMerging() = runTest {
        val walletClaims: Map<String, JsonElement> = mapOf(
    ...
    @Test
    fun missingRequiredClaimError() = runTest {
    ...
    @Test
    fun emptyMappingConfig() = runTest {
        val rawClaims: Map<String, JsonElement> = mapOf(
            "sub" to JsonPrimitive("user-123"),
            "email" to JsonPrimitive("user@example.com")
        )
    ...
    @Test
    fun claimValueTransformation() = runTest {
        ...
        val transformed = rawClaims.mapValues { (key, value) ->
