...
class ReconciliationCryptoServiceTest {
    ...
    private class TestReconciliationCryptoService(
         ...
         */
        private fun deterministicHash(input: String, keyAlias: String): String {
    ...
    @Test
    fun domainSeparation_holderKeyVsExternalIdentifier() = runTest {
        ...
        assertNotEquals(holderHash.hash, externalHash.hash,
    ...
    @Test
    fun encryptDecryptRoundTrip_emptyPayload() = runTest {
    ...
    @Test
    fun encryptDecryptRoundTrip_largePayload() = runTest {
    ...
    @Test
    fun keyVersionTracking_hashedIdentifier() = runTest {
    ...
    @Test
    fun keyVersionTracking_encryptedPayload() = runTest {
    ...
    @Test
    fun previousKeyHash_rotationSupport() = runTest {
        ...
        val rotatedService = TestReconciliationCryptoService(
        ...
        assertEquals(originalHash.hash, previousHash.hash,
    ...
    @Test
    fun differentKeysProduceDifferentHashes() = runTest {
        ...
        assertNotEquals(hashA.hash, hashB.hash,
            "Same input with different keys must produce different hashes")
    }

    @Test
    fun differentKeysProduceDifferentCiphertext() = runTest {
        ...
        assertNotEquals(encA.ciphertext, encB.ciphertext,
