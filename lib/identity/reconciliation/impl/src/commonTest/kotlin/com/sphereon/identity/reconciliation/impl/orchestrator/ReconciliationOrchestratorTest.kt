...
class ReconciliationOrchestratorTest {
    ...
    private class InMemoryIdentityLinkBindingStore : IdentityLinkBindingStore {
        ...
        private fun idKey(tenantId: String, bindingId: String) = "$tenantId:$bindingId"
        private fun matchKey(tenantId: String, matchId: String) = "$tenantId:$matchId"
        private fun holderKey(tenantId: String, holderHash: String) = "$tenantId:$holderHash"
    ...
    @Test
    fun knownHolder_returnsMatchedWithDecryptedClaims() = runTest {
        val cryptoService = TestCryptoService()
        val bindingStore = InMemoryIdentityLinkBindingStore()
    ...
    @Test
    fun oidcCompletion_materializesBinding() = runTest {
        val cryptoService = TestCryptoService()
        val bindingStore = InMemoryIdentityLinkBindingStore()
        ...
        val result1 = processWalletPresentation(
            holderKey = holderKey,
            tenantId = "tenant-1",
            cryptoService = cryptoService,
            bindingStore = bindingStore,
    ...
    @Test
    fun dualReadRotation_findsMatchWithPreviousKey() = runTest {
        ...
        val rotatedCryptoService = TestCryptoService(
    ...
    @Test
    fun expiredBinding_treatedAsUnknown() = runTest {
        val cryptoService = TestCryptoService()
        val bindingStore = InMemoryIdentityLinkBindingStore()
    ...
    @Test
    fun oidcCompletion_updatesLastUsedAt() = runTest {
        val cryptoService = TestCryptoService()
        val bindingStore = InMemoryIdentityLinkBindingStore()
        ...
        assertTrue(updatedBinding.lastUsedAt!! > originalTime,
