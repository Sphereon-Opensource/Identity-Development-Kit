...
class InMemoryReconciliationProviderStoreTest {
    ...
    @Test
    fun findAllReturnsAllProviders() = runTest {
        val store = createStore()
    ...
    @Test
    fun findAllReturnsEmptyWhenNoProviders() = runTest {
        val store = createStore()
        assertTrue(store.findAll().isEmpty())
    }

    @Test
    fun saveOverwritesExistingProvider() = runTest {
        val store = createStore()
    ...
    @Test
    fun providerFieldsArePreserved() = runTest {
        val store = createStore()
        val provider = createProvider()
        store.save(provider)
