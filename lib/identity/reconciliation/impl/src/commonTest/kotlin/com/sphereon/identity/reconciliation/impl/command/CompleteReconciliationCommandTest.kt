...
class CompleteReconciliationCommandTest {
    ...
    @Test
    fun completeReconciliationHappyPath() = runTest {
    ...
    @Test
    fun completeReconciliationWithCustomIdentifierClaim() = runTest {
        val customProvider = testProvider.copy(
    ...
    @Test
    fun completeReconciliationWithClaimMappings() = runTest {
        val mappedProvider = testProvider.copy(
            id = "mapped-provider",
            attributeMappings = listOf(
