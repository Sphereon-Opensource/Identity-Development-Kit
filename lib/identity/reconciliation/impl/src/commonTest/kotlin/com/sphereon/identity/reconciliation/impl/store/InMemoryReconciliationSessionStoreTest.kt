...
class InMemoryReconciliationSessionStoreTest {
    ...
    private fun createStore() = InMemoryReconciliationSessionStore()
    ...
    @Test
    fun findByStateReturnsNullWhenNotFound() = runTest {
        val store = createStore()
    ...
    @Test
    fun updateRemovesOldStateMapping() = runTest {
        val store = createStore()
    ...
    @Test
    fun findExpiredSessions() = runTest {
        val store = createStore()
        val now = Clock.System.now()
