...
abstract class WasmJsReconciliationTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): WasmJsReconciliationTestAppComponent
    }
}

fun createWasmJsReconciliationTestAppComponent(
    application: Any,
    appId: String = "reconciliation-test",
    profile: String = "console-log-profile",
    version: String = "test-version",
): WasmJsReconciliationTestAppComponent {
    val component = createGraphFactory<WasmJsReconciliationTestAppComponent.Factory>().create(
