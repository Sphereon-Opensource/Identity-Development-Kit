...
class KottageReconciliationSessionStoreJvmTest {
    ...
    private fun createStore(kottage: Kottage = createKottage()): KottageReconciliationSessionStore {
        ...
        val kvStore =
            kvStoreFactory.create(
                KottageKvStoreConfig(id = "reconciliation-sessions", scopeBinding = com.sphereon.data.store.kv.KvStoreScopeBinding.APP),
            )
    ...
    private fun createSession(
        ...
        expiresAt: kotlin.time.Instant = Clock.System.now() + 30.minutes,
    ...
    fun persistenceAcrossRestart() =
        runTest {
            ...
            val kvStoreFactory = KottageKvStoreFactory(kottage)
            val store1 =
                KottageReconciliationSessionStore(
                    store =
                        kvStoreFactory.create(
                            KottageKvStoreConfig(
