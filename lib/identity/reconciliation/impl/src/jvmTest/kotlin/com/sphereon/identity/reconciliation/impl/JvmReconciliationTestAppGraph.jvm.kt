...
abstract class JvmReconciliationTestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): JvmReconciliationTestAppGraph
    }
}

fun createJvmReconciliationTestAppGraph(
    application: Any,
    ...
    val graph =
        createGraphFactory<JvmReconciliationTestAppGraph.Factory>().create(
