...
abstract class NativeReconciliationTestAppGraph : AbstractAppGraph() {
    ...
    fun interface Factory {
        ...
        ): NativeReconciliationTestAppGraph
    }
}

fun createNativeReconciliationTestAppGraph(
    application: Any,
    ...
    val graph =
        createGraphFactory<NativeReconciliationTestAppGraph.Factory>().create(
