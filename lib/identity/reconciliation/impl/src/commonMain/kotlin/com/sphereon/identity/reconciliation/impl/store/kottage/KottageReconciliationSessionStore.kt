...
class KottageReconciliationSessionStore(
    ...
    private fun sessionKey(tenantId: String, sessionId: String) = "$tenantId:$sessionId"
    ...
    override suspend fun findById(tenantId: String, sessionId: String): ReconciliationSession? {
        return store.get(sessionNs, sessionKey(tenantId, sessionId)).getOrNull()
    }
    ...
    override suspend fun findByState(tenantId: String, state: String): ReconciliationSession? {
        ...
        if (storedTenantId != tenantId) return null
    ...
    private suspend fun addToTenantIndex(tenantId: String, sessionId: String) {
    ...
    private suspend fun removeFromTenantIndex(tenantId: String, sessionId: String) {
        val ids = getTenantIndex(tenantId).toMutableList()
