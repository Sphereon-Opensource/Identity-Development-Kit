...
class KottageReconciliationProviderStore(
    ...
    override suspend fun findById(providerId: String): ReconciliationProvider? = store.get(providerNs, providerId).getOrNull()
    ...
    private suspend fun getIndex(): List<String> = store.get(indexNs, INDEX_KEY).getOrNull() ?: emptyList()
}
