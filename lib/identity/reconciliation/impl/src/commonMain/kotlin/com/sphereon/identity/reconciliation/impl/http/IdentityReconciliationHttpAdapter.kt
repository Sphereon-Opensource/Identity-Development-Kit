...
// @ContributesBinding removed — portal ReconciliationOrchestrator is the authoritative surface
class IdentityReconciliationHttpAdapter(
    ...
    private fun jsonResponse(statusCode: Int, body: String): GenericHttpResponse = GenericHttpResponse(
    ...
    private fun errorResponse(statusCode: Int, message: String): GenericHttpResponse = GenericHttpResponse(
        statusCode = statusCode,
        headers = mapOf("Content-Type" to "application/json"),
