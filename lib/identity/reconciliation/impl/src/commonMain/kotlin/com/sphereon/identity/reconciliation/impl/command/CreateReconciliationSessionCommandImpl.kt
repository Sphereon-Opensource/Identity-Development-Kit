...
class CreateReconciliationSessionCommandImpl(
    ...
    override suspend fun doExecute(
        ...
        val provider = providerStore.findById(applied.providerId)
        ...
        val pkceData = createPkceCommand.execute(CreatePkceArgs()).getOrElse { error ->
            return Err(IdkError.fromDTO(ReconciliationError.OidcFlowFailed(
        ...
        val authorizationEndpoint = oidcConnection.authorizationEndpointOverride
