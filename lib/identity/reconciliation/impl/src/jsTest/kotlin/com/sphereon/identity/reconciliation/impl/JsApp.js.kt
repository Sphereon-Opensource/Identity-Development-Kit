...
abstract class JsReconciliationTestAppComponent : AbstractAppComponent() {
    ...
    fun interface Factory {
        ...
        ): JsReconciliationTestAppComponent
    }
}

fun createJsReconciliationTestAppComponent(
    application: Any,
    appId: String = "reconciliation-test",
    profile: String = "console-log-profile",
    version: String = "test-version",
): JsReconciliationTestAppComponent {
    val component = createGraphFactory<JsReconciliationTestAppComponent.Factory>().create(
