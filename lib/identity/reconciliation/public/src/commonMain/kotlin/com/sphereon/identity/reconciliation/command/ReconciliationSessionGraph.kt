...
/**
 * Graph interface for accessing reconciliation services from the DI graph.
 *
 * Use [SessionInstance.asReconciliationGraph] or [SessionGraph.asReconciliationGraph]
 * to access these services from a session context.
 */
@ContributesTo(SessionScope::class)
interface ReconciliationSessionGraph {
...
fun SessionInstance.asReconciliationGraph(): ReconciliationSessionGraph = this.graph as ReconciliationSessionGraph

fun SessionGraph.asReconciliationGraph(): ReconciliationSessionGraph = this as ReconciliationSessionGraph
