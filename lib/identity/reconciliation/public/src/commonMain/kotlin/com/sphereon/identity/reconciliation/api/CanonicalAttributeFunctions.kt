    ...
    return rules
        ...
        .map { rule ->
            RequiredAttributeViolation(
                ...
                expectedSourceHint = when (rule.mergeMode) {
...
fun attributesToProject(canonical: CanonicalAttributeBag, rules: List<CanonicalAttributeRule>): Map<String, JsonElement> {
...
fun attributesToPersist(canonical: CanonicalAttributeBag, rules: List<CanonicalAttributeRule>): Map<String, JsonElement> {
