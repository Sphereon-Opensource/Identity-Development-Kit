...
class KottageIdentityMatchStoreTest {
    ...
    @Test
    fun lookupByTenantIdIdentifierHashAndType() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun hashKeyVersionFieldPersisted() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun hashKeyVersionFieldPersistedWithVersionedKey() =
        runTest {
    ...
    @Test
    fun hashKeyVersionNullIsPreserved() =
        runTest {
            val store = createStore()
