...
class InMemoryIdentityMatchStoreTest {
    ...
    @Test
    fun findByIdentifierHashReturnsNullForWrongType() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun findByIdentifierHashReturnsNullForWrongTenant() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun findByInternalIdentityIdReturnsEmptyForWrongTenant() =
        runTest {
            val store = createStore()
            store.create(createMatch(tenantId = "tenant-1"))
