...
class KottageIdentityMatchStore(
    ...
    override suspend fun findByIdentifierHash(
        ...
        val matchId =
            store.get(hashIndexNs, hashKey(tenantId, identifierHash, identifierType)).getOrNull()
                ?: return null
    ...
    override suspend fun findById(
        tenantId: String,
        matchId: String,
    ): IdentityMatch? = store.get(matchNs, matchKey(tenantId, matchId)).getOrNull()
    ...
    override suspend fun findByInternalIdentityId(
        ...
        val matchIds =
            store.get(identityIndexNs, identityIndexKey(tenantId, internalIdentityId)).getOrNull()
                ?: return emptyList()
