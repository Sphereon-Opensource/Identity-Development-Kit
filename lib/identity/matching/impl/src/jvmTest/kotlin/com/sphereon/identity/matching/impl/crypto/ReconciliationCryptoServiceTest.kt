...
class ReconciliationCryptoServiceTest {
    ...
    private fun createService(
        ...
        JvmReconciliationCryptoService(
            holderKey = holderKey,
    ...
    @Test
    fun hmacDeterminism_sameInputSameKey_sameHash() =
        runTest {
    ...
    @Test
    fun hmacDeterminism_externalIdentifier() =
        runTest {
            val service = createService()
    ...
    @Test
    fun hmacDifferentInputs_differentHashes() =
        runTest {
            val service = createService()
    ...
    @Test
    fun domainSeparation_differentKeysProduceDifferentHashes() =
        runTest {
            val service = createService()
    ...
    @Test
    fun domainSeparation_keyVersionsAreDifferent() =
        runTest {
            val service = createService()
            ...
            assertNotEquals(
                holderHash.keyVersion,
                institutionHash.keyVersion,
    ...
    @Test
    fun encryptDecryptRoundTrip_emptyString() =
        runTest {
            val service = createService()
    ...
    @Test
    fun encryptDecryptRoundTrip_unicodeContent() =
        runTest {
            val service = createService()
    ...
    @Test
    fun encryptProducesDifferentCiphertextsForSameInput() =
        runTest {
            val service = createService()
    ...
    @Test
    fun hashHolderKeyReturnsNonEmptyKeyVersion() =
        runTest {
    ...
    @Test
    fun hashExternalIdentifierReturnsNonEmptyKeyVersion() =
        runTest {
    ...
    @Test
    fun encryptReturnsNonEmptyKeyVersion() =
        runTest {
    ...
    @Test
    fun hashHolderKeyWithPrevious_returnsHashWithOldKey() =
        runTest {
    ...
    @Test
    fun hashHolderKeyWithPrevious_returnsNullWhenNoPreviousKey() =
        runTest {
            val service = createService()
    ...
    @Test
    fun hashExternalIdentifierWithPrevious_returnsHashWithOldKey() =
        runTest {
            val oldKey = generateKey()
            val newKey = generateKey()
            val service =
    ...
    @Test
    fun dualReadScenario_lookupByPreviousHashSucceeds() =
        runTest {
            val oldKey = generateKey()
            val newKey = generateKey()
