...
class KottageIdentityMatchStoreIndexRepairTest {
    ...
    @Test
    fun updateIdentifierHashRemovesOldHashIndex() =
        runTest {
    ...
    @Test
    fun updateInternalIdentityIdRepairsIdentityIndex() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun updateBothHashAndIdentityIdRepairsBothIndexes() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun updateWithUnchangedHashDoesNotBreakIndex() =
        runTest {
            val store = createStore()
    ...
    @Test
    fun updateIdentityIdWithMultipleMatchesOnlyMovesUpdatedMatch() =
        runTest {
            val store = createStore()
