...
class DualReadHashRotationTest {
    ...
    @Test
    fun dualReadMatchStoreFallbackViaPreviousHash() = runTest {
    ...
    @Test
    fun dualReadBindingStoreFallbackViaPreviousHolderHash() = runTest {
        val kottage = createKottage()
        val kvStoreFactory = KottageKvStoreFactory(kottage)
        val bindingStore = KottageIdentityLinkBindingStore(store = kvStoreFactory.create(KottageKvStoreConfig(id = "identity-link-bindings", scopeBinding = com.sphereon.data.store.kv.KvStoreScopeBinding.APP)))
    ...
    @Test
    fun afterReHashUpdateCurrentHashWorks() = runTest {
        val kottage = createKottage()
        val kvStoreFactory = KottageKvStoreFactory(kottage)
        val matchStore = KottageIdentityMatchStore(store = kvStoreFactory.create(KottageKvStoreConfig(id = "identity-matches", scopeBinding = com.sphereon.data.store.kv.KvStoreScopeBinding.APP)))
