...
interface IdentityLinkBindingStore {
    ...
    suspend fun findByMatchId(tenantId: String, matchId: String): IdentityLinkBinding?
    suspend fun findByHolderHash(tenantId: String, holderHash: String): IdentityLinkBinding?
    suspend fun update(binding: IdentityLinkBinding): IdentityLinkBinding
    suspend fun delete(tenantId: String, bindingId: String): Boolean
    suspend fun findExpired(tenantId: String, inactiveSince: Instant): List<IdentityLinkBinding>
}
