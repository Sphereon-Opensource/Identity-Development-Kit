...
/**
 * Maps raw resolved token map to typed graph token data classes.
 * Falls back to defaults when tokens are not present (e.g., IDK-only usage without EDK presets).
 */
object ComponentTokenMapper {
    fun toButtonTokens(tokens: Map<String, String>): ButtonTokens =
        ButtonTokens(
    ...
    fun toInputTokens(tokens: Map<String, String>): InputTokens =
        InputTokens(
    ...
    fun toCheckboxTokens(tokens: Map<String, String>): CheckboxTokens =
        CheckboxTokens(
    ...
    fun toRadioTokens(tokens: Map<String, String>): RadioTokens =
        RadioTokens(
    ...
    fun toCardTokens(tokens: Map<String, String>): CardTokens =
        CardTokens(
    ...
    fun toBadgeTokens(tokens: Map<String, String>): BadgeTokens =
        BadgeTokens(
    ...
    fun toModalTokens(tokens: Map<String, String>): ModalTokens =
        ModalTokens(
    ...
    fun toTabTokens(tokens: Map<String, String>): TabTokens =
        TabTokens(
    ...
    fun toSelectTokens(tokens: Map<String, String>): SelectTokens =
        SelectTokens(
    ...
    fun toToastTokens(tokens: Map<String, String>): ToastTokens =
        ToastTokens(
    ...
    fun toBlobExplorerTokens(tokens: Map<String, String>): BlobExplorerTokens =
        BlobExplorerTokens(
