...
class ComponentRenderTest {
     ...
     */
    @Test
    fun buttonRendersAndClicks() = runComposeUiTest {
        var clicked = false
        setContent {
            ComponentTheme {
                MaterialTheme {
    ...
    @Test
    fun buttonDisabledDoesNotClick() = runComposeUiTest {
        var clicked = false
        setContent {
            ComponentTheme {
                MaterialTheme {
    ...
    @Test
    fun buttonVariantsRender() = runComposeUiTest {
        setContent {
            ComponentTheme {
                MaterialTheme {
    ...
    @Test
    fun cardRendersContent() = runComposeUiTest {
        setContent {
            ComponentTheme {
                MaterialTheme {
                    Card {
    ...
    @Test
    fun badgeRendersText() = runComposeUiTest {
        setContent {
            ComponentTheme {
                MaterialTheme {
                    Badge(text = "New")
    ...
    @Test
    fun checkboxToggles() = runComposeUiTest {
        var checked = false
        setContent {
            ComponentTheme {
                MaterialTheme {
    ...
    @Test
    fun radioGroupRendersLabels() = runComposeUiTest {
        setContent {
            ComponentTheme {
                MaterialTheme {
                    RadioGroup {
    ...
    @Test
    fun componentsRenderWithCustomTokens() = runComposeUiTest {
    ...
    @Test
    fun componentsRenderWithEmptyTokens() = runComposeUiTest {
