 ...
 */
@Composable
fun FolderIcon(color: Color, size: Dp = 22.dp) {
 ...
 */
@Composable
fun FileIcon(color: Color = Color(0xFF49454F), size: Dp = 22.dp) {
    Canvas(modifier = Modifier.size(size)) {
        val w = this.size.width
        val h = this.size.height
 ...
 */
@Composable
fun ImageIcon(color: Color, size: Dp = 22.dp) {
    Canvas(modifier = Modifier.size(size)) {
        val w = this.size.width
        val h = this.size.height
        val stroke = Stroke(width = w * 0.065f, cap = StrokeCap.Round, join = StrokeJoin.Round)
 ...
 */
@Composable
fun SortArrow(ascending: Boolean, color: Color, size: Dp = 10.dp) {
    Canvas(modifier = Modifier.size(size)) {
        val w = this.size.width
        val h = this.size.height
        val path = Path().apply {
 ...
 */
@Composable
fun SidebarIcon(color: Color, size: Dp = 16.dp) {
    Canvas(modifier = Modifier.size(size)) {
        val w = this.size.width
        val h = this.size.height
        val stroke = Stroke(width = w * 0.065f, cap = StrokeCap.Round, join = StrokeJoin.Round)
 ...
 */
@Composable
fun ContentTypeIcon(contentType: String?, primaryColor: Color, size: Dp = 22.dp) {
    when {
